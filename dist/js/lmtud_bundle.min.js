...
!function i(n, r, s) {
    ...
    1: [ function(e, F, I) {
        var n, c = e("jquery"), j = e("jquery"), r = e("tabulator-tables");
        e("select2")();
        function B(e, t) {
            var i, o = this, t = (o.options = e, o.$element = n(t), o.$element.val());
            o.$element.removeAttr("multiple"), o.select2 = o.$element.select2({
                ...
                templateSelection: function() {
                    return o.options.templateSelection(o.$element.val() || [], n("option", o.$element).length);
                },
                templateResult: function(e) {
                    return void 0 !== e.loading ? e.text : n("<div>").text(e.text).addClass(o.options.wrapClass);
                },
                matcher: function(e, t) {
                    e = (0, n.fn.select2.defaults.defaults.matcher)(e, t);
                    return e && o.options.searchMatchOptGroups && t.children && e.children && t.children.length != e.children.length && (e.children = t.children), 
                    e;
                }
            }).data("select2"), o.select2.$results.off("mouseup").on("mouseup", ".select2-results__option[aria-selected]", (i = o.select2, 
            function(e) {
                var t = n(this), o = n.fn.select2.amd.require("select2/utils").GetData(this, "data");
                "true" === t.attr("aria-selected") ? i.trigger("unselect", {
                    originalEvent: e,
                    data: o
                }) : i.trigger("select", {
                    originalEvent: e,
 ...
 */
        ...
        var u = e("./lmt_tool.js"), V = e("slideout");
        window.loadlocJson = function() {
            t(), o(), c(".select-choice-ex").val(null).trigger("change");
            ...
            e ? e.type.includes("json") ? function(i) {
                ...
                try {
                    h = JSON.parse(e.content);
                } catch (e) {
                    alert("xxx", e.message);
                }
                if (h.DIMENSIONS.json_structure.includes("model")) {
                    var t = [];
                    for (x of Object.keys(h.DIMENSIONS.dimensions.model)) t.push(h.DIMENSIONS.dimensions.model[x].Source);
                    t = [ ...new Set(t) ];
                    for (x of Object.keys(h.DIMENSIONS.dimensions.model)) D[x] = t.indexOf(h.DIMENSIONS.dimensions.model[x].Source);
                }
                if (h.DIMENSIONS.json_structure.includes("metric")) {
                    t = [];
                    for (x of Object.keys(h.DIMENSIONS.dimensions.metric)) x.includes("::") || x.includes("!!") || t.push(x);
                    M = [ ...new Set(t) ];
                }
                w = {}, E = {};
                for (var [ o, i ] of Object.entries(h.DIMENSIONS.json_structure)) "statistic" == i && h.DIMENSIONS.dimensions[i].hasOwnProperty("indices") ? u.add_options(h.DIMENSIONS.dimensions[i].indices, "select-choice-mini-".concat(o.toString())) : u.add_options(Object.keys(h.DIMENSIONS.dimensions[i]), "select-choice-mini-".concat(o.toString())), 
                w[i] = "select-choice-mini-".concat(o.toString()), E["select-choice-mini-".concat(o.toString())] = i;
                var e = h.DIMENSIONS.json_structure[0], n = h.DIMENSIONS.json_structure[1], r = {};
                for (fxdim of h.DIMENSIONS.json_structure.slice(2, h.DIMENSIONS.json_structure.length)) "statistic" == fxdim && h.DIMENSIONS.dimensions.statistic.hasOwnProperty("indices") ? r[fxdim] = h.DIMENSIONS.dimensions.statistic.indices[0] : r[fxdim] = Object.keys(h.DIMENSIONS.dimensions[fxdim])[0];
                f = u.cmec2tab_json(h, e, n, r, 1), d = Object.keys(f[0]).includes("_children") ? (S.dataTreeCollapseElement = "", 
                S.dataTreeExpandElement = "", 1) : (S.dataTreeCollapseElement = "<span></span>", 
                S.dataTreeExpandElement = "<span></span>", 0), u.add_options(h.DIMENSIONS.json_structure, "select-choice-mini-x"), 
                u.add_options(h.DIMENSIONS.json_structure, "select-choice-mini-y"), 
                b = "row_name", c(".select-choice-x").val(e), c(".select-choice-y").val(n);
                for (fxdim of Object.keys(r)) c("#".concat(w[fxdim])).select2({
                    placeholder: "Select ".concat(fxdim)
                }), c("#".concat(w[fxdim])).val(r[fxdim]).trigger("change");
                u.add_options(Object.keys(f[0]).filter(e => "row_name" !== e && "_children" !== e && "metric" !== e), "hlist"), 
                S.data = f, bgcol = "#0063B2FF", ftwgt = 500, ftsty = "normal", 
                txdec = "", txcol = "black";
                var s = {
                    bgcol: bgcol,
                    ftsty: ftsty,
                ...
                R.length = 0, S.columns = P(f, addBottomTitle = !1, z, s, e, n, b), 
                h.hasOwnProperty("SETTINGS") && h.SETTINGS.hasOwnProperty("baseUrl") && (v = h.SETTINGS.baseUrl), 
                c(document).trigger("jsonReady");
            }).catch(e => alert(e)) : alert("please input json file like *.json") : (alert("please input file"), 
            g.setColumns([]), g.clearData());
        }, window.toggleTooltips = L, window.toggleCellValue = _, window.toggleBottomTitle = J, 
        window.toggleScreenHeight = K, window.toggleTopTitle = Q, window.tableColor = function() {
            l = document.getElementById("colorblind").checked ? $ : G;
            R.length = 0;
            var e = g.getData();
            g.clearData(), g.setData(e), g.redraw(!0), N();
            ...
            console.log("UDEB:", "maxlevs", t, O, e, i), "expand" == e && (O < t ? i += 1 : i -= 1, 
            e = g.getData(), g.clearData(), g.setData(e), g.redraw(!0), console.log("UDEB:", "tabredraw"), 
            0 == i ? O = 0 : O += 1);
        }, window.savetoHtml = function() {
            g.download("html", "test.html", {
                style: !0
            });
        ...
        let p = [ "#ECFFE6", "#E6F9FF", "#FFECE6", "#EDEDED", "#FFF2E5" ], m = [ "yellow", "#00FF00", "white" ], W = [ "black", "black", "black" ], $ = [ "#b35806", "#e08214", "#fdb863", "#fee0b6", "#f7f7f7", "#d8daeb", "#b2abd2", "#8073ac", "#542788" ], G = [ "#b2182b", "#d6604d", "#f4a582", "#fddbc7", "#f7f7f7", "#d9f0d3", "#a6dba0", "#5aae61", "#1b7837" ];
        var d, s, h, a, f, g, b, v = "./", q = "rubisco_logo.png", l = $, y = [], w = (jsonFileUrl.includes("http") && (jsonFileUrl = "https://cors-anywhere.herokuapp.com/" + jsonFileUrl), 
        {}), E = {}, C = {}, R = [], D = {}, M = [], T = {}, S = {
            dataTree: !0,
            ...
            cellClick: function(e, t) {
                var o = t.getRow(), t = t.getColumn(), t = (new Boolean(!0), t.getField().replace(/\s+/g, "")), i = function e(t) {
                    var o;
                    o = t.getCells()[0].getValue().replace(/\s+/g, "");
                    t.getTreeParent() && (o = e(t.getTreeParent()) + "::" + o);
                    return o;
                }(o), n = (xDimName = c("#select-choice-mini-x").val(), yDimName = c("#select-choice-mini-y").val(), 
                {});
                n[xDimName] = t, n[yDimName] = i;
                for (dim of h.DIMENSIONS.json_structure) dim != xDimName && dim != yDimName && (selectVal = c("#".concat(w[dim])).val(), 
                n[dim] = selectVal.replace(/\s+/g, ""));
                n.metric = n.metric.replace("!!", "::");
                var r = [];
                for (met of Object.keys(h.DIMENSIONS.dimensions.metric)) met.includes("Relationships") || r.push(met.replace(/\s+/g, "").replace(/::/g, "/").replace(/!!/g, "/"));
                metricArr = n.metric.split("::"), metricLen = metricArr.length, 
                i = n.metric.includes("Relationships") ? r.filter(e => e.includes(metricArr[1]))[0] + "/" + metricArr[1].split("/")[1] + ".html#Relationships" : n.metric.replace(/::/g, "/") + "/" + n.metric.split("::")[metricLen - 1] + ".html";
                "/" != v.slice(-1) && (v += "/");
                console.log("UDEB: mylink", metricArr, i, n.metric.split("::"), v + i.concat("?model=", n.model, "&region=", n.region)), 
                metricLen < 3 ? "row_name" == t ? o.treeToggle() : alert("Only the lowest level metric is clickable") : window.open(v + i.concat("?model=", n.model, "&region=", n.region));
            },
            columns: [],
            maxHeight: "100%",
            tableBuilt: function() {
                if (0 != T.udcScreenHeight) {
                    document.getElementsByClassName("tabulator-header")[0].offsetHeight, 
                    g.getRows().length;
                    try {
                        c("#dashboard-table")[0].style.height = 0 == d ? "min(82vh, 100%)" : "82vh";
                    } catch (e) {
                        console.log(e);
                    }
                    c(".screenheight").prop("checked", !0);
                }
            }
        };
        function U(e, t, o) {
            ...
            Object.keys(data).includes("_children") && (i = U(data._children, t, i), 
            n = Object.assign({}, n, i));
            return n;
        }
        function X(t, e, o, i) {
            try {
                for (data of t) {
                    var n;
                    n = "" != i ? i + "::" + data.row_name : data.row_name, data[e] = o[n], 
                    Object.keys(data).includes("_children") && X(data._children, e, o, n);
                }
            } catch (e) {
        ...
        function Y() {
            switch (c("#select-choice-mini-map").val()) {
              case "0":
                H = te;
                break;
            ...
            for (x of S.columns) "row_name" != x.field && (x.formatter = H, x.formatterParams.scaopt = c("#select-choice-mini-sca").val());
        }
        function L(e) {
            c("#tooltips[type=checkbox]").is(":checked") ? S.tooltips = function(e) {
                return "row_name" != e.getField() && Math.round(100 * (e.getValue() + Number.EPSILON)) / 100;
            } : S.tooltips = !1, e && (g.clearData(), g = new r("#dashboard-table", S));
        }
        function _(e) {
            if (c("#cellvalue[type=checkbox]").is(":checked")) for (x of S.columns) "row_name" != x.field && (x.formatterParams = {
                showCellValue: !0
            }); else for (x of S.columns) "row_name" != x.field && (x.formatterParams = {
                showCellValue: !1
            });
            e && (e = g.getData(), g.clearData(), S.data = e, S.maxHeight = !1, 
            g = new r("#dashboard-table", S));
        }
        function K() {
            var e;
            c("#screenheight[type=checkbox]").is(":checked") ? (document.getElementById("dashboard-table").style["max-height"] = "100%", 
            ...
            e = document.getElementsByClassName("tabulator-header")[0].offsetHeight + 30 * g.getRows().length + 20, 
            document.getElementById("dashboard-table").style.height = 0 == d ? e.toString() + "px" : "82vh") : (document.getElementById("dashboard-table").style.removeProperty("max-height"), 
            document.getElementById("dashboard-table").style.height = "100%"), g.setHeight(!1), 
            N();
        }
        function J(e) {
            if (c("#bottomtitle[type=checkbox]").is(":checked")) for (x of S.columns) "row_name" != x.field && (x.bottomCalc = ee); else for (x of S.columns) "row_name" != x.field && delete x.bottomCalc;
            e && (e = g.getData(), g.clearData(), S.data = e, g = new r("#dashboard-table", S));
        }
        function Q(e) {
            c("#toptitle[type=checkbox]").is(":checked") ? S.headerVisible = !0 : S.headerVisible = !1, 
            e && (e = g.getData(), g.clearData(), S.data = e, g = new r("#dashboard-table", S));
        }
        function Z(i, l = {}) {
            "" !== i && (document.getElementById("file").value = "", g.clearData(), 
            t(), o(), c.getJSON(i, {
                format: "json"
            }).done(function(e) {
                switch (e.SCHEMA.name) {
                  case "CMEC":
                    ...
                    {
                        var [ i, n = {} ] = [ h, l ];
                        if (i.DIMENSIONS.json_structure.includes("model")) {
                            var r = [];
                            for (x of Object.keys(i.DIMENSIONS.dimensions.model)) r.push(i.DIMENSIONS.dimensions.model[x].Source);
                            r = [ ...new Set(r) ];
                            for (x of Object.keys(i.DIMENSIONS.dimensions.model)) D[x] = r.indexOf(i.DIMENSIONS.dimensions.model[x].Source);
                        }
                        if (i.DIMENSIONS.json_structure.includes("metric")) {
                            r = [];
                            for (x of Object.keys(i.DIMENSIONS.dimensions.metric)) x.includes("::") || x.includes("!!") || r.push(x);
                            M = [ ...new Set(r) ];
                        }
                        for (var [ s, a ] of Object.entries(i.DIMENSIONS.json_structure)) "statistic" == a && i.DIMENSIONS.dimensions[a].hasOwnProperty("indices") ? u.add_options(i.DIMENSIONS.dimensions[a].indices, "select-choice-mini-".concat(s.toString())) : u.add_options(Object.keys(i.DIMENSIONS.dimensions[a]), "select-choice-mini-".concat(s.toString())), 
                        w[a] = "select-choice-mini-".concat(s.toString()), E["select-choice-mini-".concat(s.toString())] = a;
                        let e = "", t = "", o = {};
                        if (n.x_dim && i.DIMENSIONS.json_structure.includes(n.x_dim) && n.y_dim && i.DIMENSIONS.json_structure.includes(n.y_dim)) e = n.x_dim, 
                        t = n.y_dim, o = n.fxdim; else {
                            e = i.DIMENSIONS.json_structure[0], t = i.DIMENSIONS.json_structure[1], 
                            o = {};
                            for (fxdim of i.DIMENSIONS.json_structure.slice(2, i.DIMENSIONS.json_structure.length)) "statistic" == fxdim && i.DIMENSIONS.dimensions.statistic.hasOwnProperty("indices") ? o[fxdim] = i.DIMENSIONS.dimensions.statistic.indices[0] : o[fxdim] = Object.keys(i.DIMENSIONS.dimensions[fxdim])[0];
                        }
                        f = u.cmec2tab_json(i, e, t, o, 1), d = Object.keys(f[0]).includes("_children") ? (S.dataTreeCollapseElement = "", 
                        S.dataTreeExpandElement = "", 1) : (S.dataTreeCollapseElement = "<span></span>", 
                        S.dataTreeExpandElement = "<span></span>", 0);
                        u.add_options(i.DIMENSIONS.json_structure, "select-choice-mini-x"), 
                        u.add_options(i.DIMENSIONS.json_structure, "select-choice-mini-y"), 
                        b = "row_name", c(".select-choice-x").val(e), c(".select-choice-y").val(t);
                        //$('#'.concat(selectIDbyDims['region'])).select2({ placeholder: 'Select region',});
                        for (fxdim of Object.keys(o)) console.log("UDEB:", fxdim, w[fxdim], o[fxdim]), 
                        c("#".concat(w[fxdim])).select2({
                            placeholder: "Select ".concat(fxdim)
                        }), c("#".concat(w[fxdim])).val(o[fxdim]).trigger("change");
                        u.add_options(Object.keys(f[0]).filter(e => "row_name" !== e && "_children" !== e && "metric" !== e), "hlist"), 
                        S.data = f, bgcol = "#0063B2FF", ftwgt = 500, ftsty = "normal", 
                        txdec = "", txcol = "white";
                        n = {
                        ...
                        R.length = 0, S.columns = P(f, addBottomTitle = !1, z, n, e, t, b), 
                        1 == T.udcCellValue && (c("#cellvalue").prop("checked", !0), 
                        _(!1));
                    }
                    break;
                  ...
                  case "TABJSON":
                    0;
                    f = filterScoreboard(e.RESULTS, "Overall Score global"), u.add_options([ "model" ], "select-choice-mini-x"), 
                    u.add_options([ "metric" ], "select-choice-mini-y");
                    var t = [], o = [];
                    for (row of e.RESULTS) t.push(row.scoreboard.split(" ")[row.scoreboard.split(" ").length - 1]), 
                    o.push(row.scoreboard.split(" ").slice(0, -1).join(" "));
                    t = [ ...new Set(t) ], o = [ ...new Set(o) ], u.add_options(t, "select-choice-mini-0"), 
                    u.add_options(o, "select-choice-mini-3"), w.region = "select-choice-mini-0", 
                    w.statistic = "select-choice-mini-3", b = "metric", c(".select-choice-x").val("model"), 
                    c(".select-choice-y").val("metric"), c("#".concat(w.region)).select2({
                        placeholder: "Select region"
                    }), c("#".concat(w.region)).val("global").trigger("change"), 
                    c("#".concat(w.statistic)).select2({
                        placeholder: "Select region"
                    }), c("#".concat(w.statistic)).val("Overall Score").trigger("change"), 
                    u.add_options(Object.keys(f[0]).filter(e => "row_name" !== e && "_children" !== e && "metric" !== e), "hlist"), 
                    S.data = f, bgcol = "#0063B2FF", ftwgt = 500, ftsty = "normal", 
                    txdec = "", txcol = "black";
                    n = {
                    ...
                    R.length = 0, S.columns = P(f, addBottomTitle = !1, z, n, "model", "metric", b);
                }
                h.hasOwnProperty("SETTINGS") && h.SETTINGS.hasOwnProperty("baseUrl") && (v = h.SETTINGS.baseUrl), 
                c(document).trigger("jsonReady");
            }).fail(function(e, t, o) {
        ...
        function A(o, i, e) {
            ...
            y = [], C = {};
            for (dimn of Object.keys(w)) if (o == dimn || i == dimn) c("#".concat(w[dimn])).val(null).trigger("change"), 
            c("#".concat(w[dimn])).select2().next().hide(); else {
                if (C[dimn] = c("#".concat(w[dimn])).val(), 1 == e) {
                    C[dimn] = null, c("#".concat(w[dimn])).val(null).trigger("change"), 
                    c("#".concat(w[dimn])).select2().next().show(), c("#".concat(w[dimn])).select2({
                        placeholder: "Select ".concat(dimn)
                    });
                    for (var t = document.getElementById("hlist"), n = t.options.length - 1; 0 <= n; n--) t.remove(n);
                    "statistic" == o && h.DIMENSIONS.dimensions[o].hasOwnProperty("indices") ? u.add_options(h.DIMENSIONS.dimensions[o].indices, "hlist") : u.add_options(Object.keys(h.DIMENSIONS.dimensions[o]), "hlist"), 
                    c(".scarow").prop("checked", !0), c(".scacol").prop("checked", !1), 
                    c("#select-choice-mini-sca").val("0").trigger("change.select2"), 
                    c("#select-choice-mini-map").val("0").trigger("change.select2");
                }
                c("#".concat(w[dimn])).off("select2:select"), c("#".concat(w[dimn])).on("select2:select", function(e) {
                    var t;
                    //mxu $('#select-choice-mini-sca').val("0").trigger('change.select2');
                    //mxu $('#select-choice-mini-map').val("0").trigger('change.select2');
                    y = [], selId = c(this).attr("id"), C[E[selId]] = c(this).val(), 
                    Object.values(C).every(function(e) {
                        return null != e;
                    }) && (a = u.cmec2tab_json(h, o, i, C, 1), d = Object.keys(a[0]).includes("_children") ? (S.dataTreeCollapseElement = "", 
                    S.dataTreeExpandElement = "", 1) : (S.dataTreeCollapseElement = "<span></span>", 
                    S.dataTreeExpandElement = "<span></span>", 0), S.data = a, bgcol = "#0063B2FF", 
                    ftwgt = 500, ftsty = "normal", txdec = "", txcol = "black", 
                    t = {
                        bgcol: bgcol,
                        ftsty: ftsty,
                        ftwgt: ftwgt,
                        txdec: txdec,
                        color: txcol
                    }, R.length = 0, S.columns = P(a, addBottomTitle = !1, z, t, o, i, "row_name"), 
                    document.getElementById("mytab").style.width = (400 + 30 * (S.columns.length - 1)).toString() + "px", 
                    L(!1), _(!1), J(!1), Q(!1), g.setColumns(S.columns), g.clearData(), 
                    g = new r("#dashboard-table", S), xscaopt = c("#select-choice-mini-sca").val(), 
                    xmapopt = c("#select-choice-mini-map").val(), c("#select-choice-mini-sca").val(xscaopt).trigger("change"), 
                    c("#select-choice-mini-map").val(xmapopt).trigger("change"));
                });
            }
        }
        c(document).ready(function() {
            c("#file").val(""), c(".hide-list").select2MultiCheckboxes({
            ...
            }), c(".hide-list").val(null).trigger("change"), c(".select-choice-x").select2({
                placeholder: "Select X/Column"
            }), c(".select-choice-y").select2({
                placeholder: "Select Y/Row"
            }), c(".select-choice-sca").select2({
                placeholder: "Normalize methods"
            }), c(".select-choice-map").select2({
                placeholder: "Color mapping methods"
            }), 
            //    $('.select-choice-'.concat(i.toString())).select2({
            g = new r("#dashboard-table", option = {}), c(".hide-list").on("select2:select", function(e) {
                c(this).val();
                e = e.params.data.id;
                g.hideColumn(e);
            }), c(".hide-list").on("select2:unselect", function(e) {
                c(this).val();
                e = e.params.data.id;
                g.showColumn(e);
            });
            var e = window.document, t = new V({
                panel: e.getElementById("panel"),
                menu: e.getElementById("menu")
            }), e = (document.querySelector(".js-slideout-toggle").addEventListener("click", function() {
                t.toggle();
            }), c(".select-choice-ex").select2({
                placeholder: "Select examples"
            }), c(".select-choice-ex").val(null).trigger("change"), c(".select-choice-logo").select2({
                placeholder: "Select logos"
            }), c(".select-choice-logo").val(null).trigger("change"), c("#select-choice-mini-ex").on("select2:select", function() {
                var e = c(this).val();
                console.log(e), Z(jsonFileUrl + e);
            }), c("#select-choice-mini-logo").on("select2:select", function() {
                q = c(this).val();
                var e = g.getData();
                (g = new r("#dashboard-table", S)).clearData(), g.setData(e), g.redraw(!0);
            }), c('#checkboxsca[type="checkbox"]').on("change", function() {
                c('#checkboxsca[type="checkbox"]').not(this).prop("checked", !1), 
                c(".scarow").is(":checked") && (s = "row"), c(".scacol").is(":checked") && (s = "column"), 
                c("#select-choice-mini-sca").val("0").trigger("change"), c("#select-choice-mini-map").val("0").trigger("change"), 
                y = [];
            }), c("#select-choice-mini-sca").change(function() {
                0 < y.length ? e = he(y) : (e = g.getData("all"), y = he(e));
                var e, t = Object.assign([], e);
                if (c(".scarow").is(":checked") && (s = "row"), "row" == (s = c(".scacol").is(":checked") ? "column" : s)) {
                    var o = 0;
                    for (data of e) t[o] = de(c("#select-choice-mini-sca").val(), s, data), 
                    o += 1;
                } else {
                    var i, n = {};
                    for (col_name of Object.keys(e[0])) "row_name" != col_name && "_children" != col_name && (n = U(e, col_name, ""), 
                    i = de(c("#select-choice-mini-sca").val(), s, n), X(t, col_name, i, ""));
                }
                Y(), "0" != c("#select-choice-mini-sca").val() ? (g.setData(t), 
                g.redraw(!0)) : (g.clearData(), S.data = y, g = new r("#dashboard-table", S)), 
                N();
            }), document.getElementById("select-choice-mini-map").onchange = function() {
                Y(), S.data = g.getData(), g = new r("#dashboard-table", S);
            }, "./_lmtUDConfig.json");
            console.log("UDEB: UD config file ", e), c.getJSON(e, {
                format: "json"
            }).done(function(e) {
                var t;
                T = e, console.log("UDEB:", window.location.href + e.udcJsonLoc), 
                e.udcJsonLoc ? (t = "./" + e.udcJsonLoc, console.log("UDEB: ", t, e.udcJsonLoc), 
                Z(t, e.udcDimSets)) : console.log("UDEB: no JSON data file in the config file");
            }).fail(function(e, t, o) {
                T = {}, console.log("UDEB: Request config Failed: " + (t + ": " + o));
            });
        }), c(document).on("jsonReady", function() {
            document.getElementById("mytab").style.width = (400 + 30 * (S.columns.length - 1)).toString() + "px", 
            0 == T.udcScreenHeight && K();
            try {
                L(!1), g = new r("#dashboard-table", S), N();
            } catch (e) {
                alert("Error when rending the table:", e.message);
            }
            var o, i;
            if (i = Object.keys(T).includes("udcDimSets") && Object.keys(T.udcDimSets).includes("x_dim") && Object.keys(T.udcDimSets).includes("y_dim") ? (o = T.udcDimSets.x_dim, 
            T.udcDimSets.y_dim) : (o = h.DIMENSIONS.json_structure[0], h.DIMENSIONS.json_structure[1]), 
            A(o, i, 0), c("#select-choice-mini-x").on("select2:select", function(e) {
                var t = c(this).val();
                null != (o = t) && null != i && (o == i ? alert(" x and y must be different ") : A(o, i, 1));
            }), document.getElementById("select-choice-mini-y").onchange = function() {
                var e = this.options[this.selectedIndex].value;
                i = e, null != o && null != i && (o == i ? alert(" x and y must be different ") : A(o, i, 1));
            }, T.hasOwnProperty("udcNormAxis")) switch (T.udcNormAxis.toLowerCase()) {
              case "x":
              case "col":
                c(".scarow").prop("checked", !1), c(".scacol").prop("checked", !0);
                break;
            ...
            if (T.hasOwnProperty("udcNormType")) switch (T.udcNormType.toLowerCase()) {
              case "standarized":
                c("#select-choice-mini-sca").val("1").trigger("change");
                break;

              case "normalized[-1:1]":
                c("#select-choice-mini-sca").val("2").trigger("change");
                break;

              case "normalized[0:1]":
                c("#select-choice-mini-sca").val("3").trigger("change");
                break;

              default:
                console.log("UDEB: error setting in udcNormType");
            }
            if (T.hasOwnProperty("udcColorMapping")) switch (T.udcColorMapping.toLowerCase()) {
              case "ilamb":
                c("#select-choice-mini-map").val("0").trigger("change");
                //$('#select-choice-mini-map').trigger('change.select2');
                break;

              case "linear":
                c("#select-choice-mini-map").val("1").trigger("change");
                break;

              case "linear reverse":
                c("#select-choice-mini-map").val("2").trigger("change");
                break;

              default:
                console.log("UDEB: error setting in udcColorMapping");
            }
            T.hasOwnProperty("udcBaseUrl") && (v = T.udcBaseUrl);
        });
        var N = function() {
            l.length;
        ...
        function te(e, t, o) {
            ...
            i = Math.min(Math.max(i, 0), r - 1), n = l[i]), e.getElement().style.backgroundColor = n, 
        ...
        function oe(e, t, o) {
            ...
            var r, s = "#808080", a = l.length;
            if (-900 < normVal && (r = Math.round((normVal - i) * a / (n - i)), 
            r = Math.min(Math.max(r, 0), a - 1), s = l[r]), e.getElement().style.backgroundColor = s, 
            t.showCellValue && -900 < origVal) return e.getElement().style.color = "black", 
            normVal.toFixed(2);
        }
        function ie(e, t, o) {
            ...
            e.getValue()[1]) : (origVal = e.getValue(), e.getValue());
            var r, s = "#808080", a = l.length;
            if (-900 < normVal && (r = Math.round((n - normVal) * a / (n - i)), 
            r = Math.min(Math.max(r, 0), a - 1), s = l[r]), e.getElement().style.backgroundColor = s, 
            t.showCellValue && -900 < origVal) return e.getElement().style.color = "black", 
            normVal.toFixed(2);
        }
        ...
        var P = function(e, t, o, i, n, r, s) {
            ...
            }, c = (i.title = r.concat("/", n), i.title = "", i.field = s, a.push(i), 
            {});
            for (x of Object.keys(e[0])) if ("row_name" != x && "_children" != x && "metric" != x) {
                ...
                "model" == n) {
                    ...
                    ftwgt = 100, ftsty = "normal", txdec = "", txcol = W[u];
                } else if ("metric" == n) for (var [ d, h ] of M.entries()) x.includes(h) && (u = d % p.length, 
            ...
            if ("None" != T.logofile) return "<img class='infoImage' src='image/".concat(q, "'>");
        }, re = [ {
            label: "Hide Column",
            action: function(e, t) {
                t.hide();
                t = t.getField();
                if (selData = c("#hlist").select2("data"), hideItems = [], 1 <= selData.length) for (se of selData) hideItems.push(se.id);
                hideItems.push(t), c("#hlist").val(hideItems).trigger("change");
            }
        } ], ae = [ {
        ...
        function le(o, t, e) {
            ...
            return e(function() {
                ...
                R.includes(i) || R.push(i), e.forEach(function(e) {
                    var t = R.indexOf(i) % p.length;
                    ce(e, o, 0, p[t], fgFontColor);
                })) : "model" == t.yDim && (fgFontColor = "white", e = D[i] % m.length, 
                ce(o.getRow(), o, 0, m[e], W[e])));
            }), i;
        }
        ...
        function t() {
            c("#colorblind").prop("checked", !0), c(".scarow").prop("checked", !0), 
            c(".scacol").prop("checked", !1), c("#cellvalue").prop("checked", !0), 
            c("#bottomtitle").prop("checked", !1), c("#toptitle").prop("checked", !0), 
            c("#tooltips").prop("checked", !0), 0 == T.udcScreenHeight ? c(".screenheight").prop("checked", !1) : c(".screenheight").prop("checked", !0);
        }
        function o() {
            c(".hide-list").val(null).trigger("change"), c("#select-choice-mini-sca").val("0").trigger("change"), 
            c("#select-choice-mini-map").val("0").trigger("change"), c("#select-choice-mini-1").val(null).trigger("change"), 
            c("#select-choice-mini-2").val(null).trigger("change"), c("#select-choice-mini-3").val(null).trigger("change"), 
            c("#select-choice-mini-4").val(null).trigger("change"), c("#select-choice-mini-5").val(null).trigger("change"), 
            c("#select-choice-mini-6").val(null).trigger("change"), c("#select-choice-mini-7").val(null).trigger("change"), 
            c("#select-choice-mini-8").val(null).trigger("change"), c("#select-choice-mini-9").val(null).trigger("change"), 
            c("#select-choice-mini-1").select2().next().hide(), c("#select-choice-mini-2").select2().next().hide(), 
            c("#select-choice-mini-3").select2().next().hide(), c("#select-choice-mini-4").select2().next().hide(), 
            c("#select-choice-mini-5").select2().next().hide(), c("#select-choice-mini-6").select2().next().hide(), 
            c("#select-choice-mini-7").select2().next().hide(), c("#select-choice-mini-8").select2().next().hide(), 
            c("#select-choice-mini-9").select2().next().hide();
        }
        function ue(e, t, o, i) {
            for (k of Object.keys(e)) "row_name" != k && "_children" != k ? (t.push(e[k]), 
            o.push(k)) : "_children" == k && 1 == i && ue(e, t, o, i);
        }
        function de(e, t, o) {
            var i = Object.assign({}, o);
            if ("_children" in o && "row" == t && 0 < o._children.length) {
                var n = 0;
                for (cData of o._children) i._children[n] = de(e, t, cData), n += 1;
            }
            var r = [], s = [], a = (ue(o, r, s, "row" == t ? 0 : 1), []);
            switch (e) {
              case "1":
                let t = function(e) {
                ...
                for (val of r) newval = -999 < val ? (val - t(r)) / function(e) {
                    let o = t(e);
              ...
              case "3":
                ...
                for (val of r) newval = -999 < val ? c == l ? 1 : "3" == e ? (val - l) / (c - l) : (val - .5 * (l + c)) / (.5 * (c - l)) : -999, 
                a.push(newval);
            }
            n = 0;
        ...
        c(window).on("beforeunload", function() {
            t(), o(), c(".select-choice-ex").val(null).trigger("change"), c("#file").val(""), 
            0;
        });
        let he = e => {
            let t, o, i;
            if ("object" != typeof e || null === e) return e;
            for (i in t = Array.isArray(e) ? [] : {}, e) o = e[i], t[i] = he(o);
            return t;
        };
        var i = 1, O = 1;
    }, {
    ...
    2: [ function(e, t, o) {
        t.exports = {
            ...
            cmec2tab_json: function(i, n, r, s, a) {
                // convert cmec json (output.json) to tabulator json format 
                let l = 0;
                if (i.DIMENSIONS.json_structure.includes(n) && i.DIMENSIONS.json_structure.includes(r)) {
                    if ((fixedDims = Object.keys(s)).length + 2 === i.DIMENSIONS.json_structure.length) {
                        let e = Object.assign(i.RESULTS, {});
                        for (fixedDim of fixedDims) {
                            var c = {};
                            switch (fixedDim) {
                              case i.DIMENSIONS.json_structure[0]:
                                fxDimName = i.DIMENSIONS.json_structure[0], Object.keys(e).includes(s[fxDimName]) ? c[s[fxDimName]] = e[s[fxDimName]] : c[s[fxDimName]] = p(i, {
                                    [fxDimName]: s[fxDimName]
                                });
                                break;

                              case i.DIMENSIONS.json_structure[1]:
                                fxDimName = i.DIMENSIONS.json_structure[1];
                                for (reg of Object.keys(e)) c[reg] = {}, Object.keys(e[reg]).includes(s[fxDimName]) ? c[reg][s[fxDimName]] = e[reg][s[fxDimName]] : c[reg][s[fxDimName]] = p(i, {
                                    [fxDimName]: s[fxDimName]
                                });
                                break;
                              ...
                              case i.DIMENSIONS.json_structure[2]:
                                ...
                                for (reg of Object.keys(e)) {
                                    ...
                                    Object.keys(e[reg][mod]).includes(s[fxDimName]) ? c[reg][mod][s[fxDimName]] = e[reg][mod][s[fxDimName]] : c[reg][mod][s[fxDimName]] = p(i, {
                                        [fxDimName]: s[fxDimName]
                                    });
                                }
                                break;
                              ...
                              case i.DIMENSIONS.json_structure[3]:
                                ...
                                for (reg of Object.keys(e)) {
                                    ...
                                    for (mod of Object.keys(e[reg])) {
                                        ...
                                        Object.keys(e[reg][mod][met]).includes(s[fxDimName]) ? c[reg][mod][met][s[fxDimName]] = e[reg][mod][met][s[fxDimName]] : c[reg][mod][met][s[fxDimName]] = p(i, {
                                            [fxDimName]: s[fxDimName]
                                        });
                                    }
                                }
                                ...
                                for (reg of Object.keys(e)) {
                                    ...
                                    for (mod of Object.keys(e[reg])) {
                                        ...
                                        for (met of Object.keys(e[reg][mod])) {
                                            ...
                                            Object.keys(e[reg][mod][met][dm4]).includes(s[fxDimName]) ? c[reg][mod][met][dm4][s[fxDimName]] = e[reg][mod][met][dm4][s[fxDimName]] : c[reg][mod][met][dm4][s[fxDimName]] = p(i, {
                                                [fxDimName]: s[fxDimName]
                                            });
                                        }
                                    }
                                    ...
                                    for (mod of Object.keys(e[reg])) {
                                        ...
                                        for (met of Object.keys(e[reg][mod])) {
                                            ...
                                            for (dm4 of Object.keys(e[reg][mod][met])) {
                                                ...
                                                Object.keys(e[reg][mod][met][dm4][dm5]).includes(s[fxDimName]) ? c[reg][mod][met][dm4][dm5][s[fxDimName]] = e[reg][mod][met][dm4][dm5][s[fxDimName]] : c[reg][mod][met][dm4][dm5][s[fxDimName]] = p(i, {
                                                    [fxDimName]: s[fxDimName]
                                                });
                                            }
                                        }
                        ...
                        i.DIMENSIONS.json_structure.indexOf(n), i.DIMENSIONS.json_structure.indexOf(r);
                        var u = i.DIMENSIONS.json_structure, d = [];
                        for (dm of u) dm !== n && dm != r || d.push(dm), dm in s && d.push(s[dm]);
                        let t = e;
                        ...
                        ydimVal = "statistic" == r && i.DIMENSIONS.dimensions[r].hasOwnProperty("indices") ? i.DIMENSIONS.dimensions[r].indices : Object.keys(i.DIMENSIONS.dimensions[r]);
                        for (dm of d) n != dm && r != dm && (t = t[dm]), n === dm && (xKeys = Object.keys(t), 
                        t = t[xKeys[0]]), r === dm && (yKeys = Object.keys(t), t = t[yKeys[0]]);
                        ...
                        for (yk of yKeys) {
                            ...
                            for (xk of xKeys) {
                                t = e;
                                for (dm of d) t = n === dm ? xk in t ? t[xk] : {} : r === dm ? yk in t ? t[yk] : {} : null != t && dm in t ? t[dm] : null;
 ...
 */
        var i, n;
        i = "undefined" != typeof window ? window : this, n = function(E, z) {
            function v(e) {
            ...
            var t = [], F = Object.getPrototypeOf, a = t.slice, I = t.flat ? function(e) {
                return t.flat.call(e);
            } : function(e) {
                return t.concat.apply([], e);
            }, j = t.push, y = t.indexOf, B = {}, V = B.toString, W = B.hasOwnProperty, $ = W.toString, G = $.call(Object), f = {}, x = E.document, q = {
                type: !0,
                src: !0,
                nonce: !0,
                noModule: !0
            ...
            function U(e, t, o) {
                var i, n, r = (o = o || x).createElement("script");
                if (r.text = e, t) for (i in q) (n = t[i] || t.getAttribute && t.getAttribute(i)) && r.setAttribute(i, n);
                o.head.appendChild(r).parentNode.removeChild(r);
            }
            function X(e) {
                return null == e ? e + "" : "object" == typeof e || "function" == typeof e ? B[V.call(e)] || "object" : typeof e;
            }
            var Y = /HTML$/i, C = function(e, t) {
                return new C.fn.init(e, t);
            };
            function K(e) {
                var t = !!e && "length" in e && e.length, o = X(e);
                return !v(e) && !O(e) && ("array" === o || 0 === t || "number" == typeof t && 0 < t && t - 1 in e);
            }
            function w(e, t) {
            ...
            C.fn = C.prototype = {
                ...
                for ("boolean" == typeof r && (l = r, r = arguments[s] || {}, s++), 
                "object" == typeof r || v(r) || (r = {}), s === a && (r = this, 
                s--); s < a; s++) if (null != (e = arguments[s])) for (t in e) o = e[t], 
                "__proto__" !== t && r !== o && (l && o && (C.isPlainObject(o) || (i = Array.isArray(o))) ? (n = r[t], 
                n = i && !Array.isArray(n) ? [] : i || C.isPlainObject(n) ? n : {}, 
                i = !1, r[t] = C.extend(l, n, o)) : void 0 !== o && (r[t] = o));
                return r;
            }, C.extend({
                ...
                isPlainObject: function(e) {
                    return !(!e || "[object Object]" !== V.call(e) || (e = F(e)) && ("function" != typeof (e = W.call(e, "constructor") && e.constructor) || $.call(e) !== G));
                },
                ...
                each: function(e, t) {
                    var o, i = 0;
                    if (K(e)) for (o = e.length; i < o && !1 !== t.call(e[i], i, e[i]); i++); else for (i in e) if (!1 === t.call(e[i], i, e[i])) break;
                    return e;
                },
                text: function(e) {
                    var t, o = "", i = 0, n = e.nodeType;
                    if (!n) for (;t = e[i++]; ) o += C.text(t);
                    return 1 === n || 11 === n ? e.textContent : 9 === n ? e.documentElement.textContent : 3 === n || 4 === n ? e.nodeValue : o;
                },
                makeArray: function(e, t) {
                    t = t || [];
                    return null != e && (K(Object(e)) ? C.merge(t, "string" == typeof e ? [ e ] : e) : j.call(t, e)), 
                    t;
                },
                inArray: function(e, t, o) {
                    return null == t ? -1 : y.call(t, e, o);
                },
                isXMLDoc: function(e) {
                ...
                map: function(e, t, o) {
                    var i, n, r = 0, s = [];
                    if (K(e)) for (i = e.length; r < i; r++) null != (n = t(e[r], r, o)) && s.push(n); else for (r in e) null != (n = t(e[r], r, o)) && s.push(n);
                    return I(s);
                },
                guid: 1,
                support: f
            ...
            var J = t.pop, Q = t.sort, Z = t.splice, o = "[\\x20\\t\\r\\n\\f]", ee = new RegExp("^" + o + "+|((?:^|[^\\\\])(?:\\\\.)*)" + o + "+$", "g"), te = (C.contains = function(e, t) {
                t = t && t.parentNode;
            ...
            var ie, R, ne, re, se, D, i, M, h, ae, n = x, le = j, T = le, S = C.expando, L = 0, ce = 0, ue = Le(), de = Le(), he = Le(), pe = Le(), me = function(e, t) {
                return e === t && (se = !0), 0;
            }, fe = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", e = "(?:\\\\[\\da-fA-F]{1,6}" + o + "?|\\\\[^\\r\\n\\f]|[\\w-]|[^\0-\\x7f])+", r = "\\[" + o + "*(" + e + ")(?:" + o + "*([*^$|!~]?=)" + o + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + e + "))|)" + o + "*\\]", s = ":(" + e + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + r + ")*)|.*)\\)|)", ge = new RegExp(o + "+", "g"), be = new RegExp("^" + o + "*," + o + "*"), ve = new RegExp("^" + o + "*([>+~]|" + o + ")" + o + "*"), ye = new RegExp(o + "|>"), we = new RegExp(s), Ee = new RegExp("^" + e + "$"), xe = {
                ID: new RegExp("^#(" + e + ")"),
                CLASS: new RegExp("^\\.(" + e + ")"),
                TAG: new RegExp("^(" + e + "|[*])"),
                ATTR: new RegExp("^" + r),
            ...
            }, Ce = /^(?:input|select|textarea|button)$/i, Re = /^h\d$/i, De = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, Me = /[+~]/, d = new RegExp("\\\\[\\da-fA-F]{1,6}" + o + "?|\\\\([^\\r\\n\\f])", "g"), p = function(e, t) {
            ...
            try {
                T.apply(t = a.call(n.childNodes), n.childNodes), t[n.childNodes.length].nodeType;
            } catch (e) {
                T = {
                    apply: function(e, t) {
                        le.apply(e, a.call(t));
            ...
            function k(t, e, o, i) {
                var n, r, s, a, l, c, u = e && e.ownerDocument, d = e ? e.nodeType : 9;
                if (o = o || [], "string" != typeof t || !t || 1 !== d && 9 !== d && 11 !== d) return o;
                if (!i && (He(e), e = e || D, M)) {
                    if (11 !== d && (a = De.exec(t))) if (n = a[1]) {
                        if (9 === d) {
                            if (!(c = e.getElementById(n))) return o;
                            if (c.id === n) return T.call(o, c), o;
                        } else if (u && (c = u.getElementById(n)) && k.contains(e, c) && c.id === n) return T.call(o, c), 
                        o;
                    } else {
                        if (a[2]) return T.apply(o, e.getElementsByTagName(t)), 
                        o;
                        if ((n = a[3]) && e.getElementsByClassName) return T.apply(o, e.getElementsByClassName(n)), 
                        o;
                    }
                    if (!(pe[t + " "] || h && h.test(t))) {
                        if (c = t, u = e, 1 === d && (ye.test(t) || ve.test(t))) {
                            for ((u = Me.test(t) && Ne(e.parentNode) || e) == e && f.scope || ((s = e.getAttribute("id")) ? s = C.escapeSelector(s) : e.setAttribute("id", s = S)), 
                            r = (l = ze(t)).length; r--; ) l[r] = (s ? "#" + s : ":scope") + " " + Oe(l[r]);
                            c = l.join(",");
                        }
                        try {
                            return T.apply(o, u.querySelectorAll(c)), o;
                        } catch (e) {
                            pe(t, !0);
                        } finally {
                ...
                return $e(t.replace(ee, "$1"), e, o, i);
            }
            function Le() {
                var o = [];
                function i(e, t) {
                    return o.push(e + " ") > R.cacheLength && delete i[o.shift()], 
                    i[e + " "] = t;
                }
                return i;
            }
            ...
            function He(e) {
                ...
                return e != D && 9 === e.nodeType && e.documentElement && (i = (D = e).documentElement, 
                M = !C.isXMLDoc(D), ae = i.matches || i.webkitMatchesSelector || i.msMatchesSelector, 
                i.msMatchesSelector && n != D && (e = D.defaultView) && e.top !== e && e.addEventListener("unload", Te), 
                f.getById = ke(function(e) {
                    return i.appendChild(e).id = C.expando, !D.getElementsByName || !D.getElementsByName(C.expando).length;
                }), f.disconnectedMatch = ke(function(e) {
                    return ae.call(e, "*");
                }), f.scope = ke(function() {
                    return D.querySelectorAll(":scope");
                }), f.cssHas = ke(function() {
                    try {
                        D.querySelector(":has(*,:jqfake)");
                    } catch (e) {
                        return 1;
                    }
                    ...
                    var t;
                    i.appendChild(e).innerHTML = "<a id='" + S + "' href='' disabled='disabled'></a><select id='" + S + "-\r\\' disabled='disabled'><option selected=''></option></select>", 
                    e.querySelectorAll("[selected]").length || h.push("\\[" + o + "*(?:value|" + fe + ")"), 
                    e.querySelectorAll("[id~=" + S + "-]").length || h.push("~="), 
                    e.querySelectorAll("a#" + S + "+*").length || h.push(".#.+[+~]"), 
                    e.querySelectorAll(":checked").length || h.push(":checked"), 
                    (t = D.createElement("input")).setAttribute("type", "hidden"), 
                    e.appendChild(t).setAttribute("name", "D"), i.appendChild(e).disabled = !0, 
                    2 !== e.querySelectorAll(":disabled").length && h.push(":enabled", ":disabled"), 
                    (t = D.createElement("input")).setAttribute("name", ""), e.appendChild(t), 
                    e.querySelectorAll("[name='']").length || h.push("\\[" + o + "*name" + o + "*=" + o + "*(?:''|\"\")");
                }), f.cssHas || h.push(":has"), h = h.length && new RegExp(h.join("|")), 
                me = function(e, t) {
                    var o;
                    return e === t ? (se = !0, 0) : (o = !e.compareDocumentPosition - !t.compareDocumentPosition) || (1 & (o = (e.ownerDocument || e) == (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !f.sortDetached && t.compareDocumentPosition(e) === o ? e === D || e.ownerDocument == n && k.contains(n, e) ? -1 : t === D || t.ownerDocument == n && k.contains(n, t) ? 1 : re ? y.call(re, e) - y.call(re, t) : 0 : 4 & o ? -1 : 1);
                }), D;
            }
            for (ie in k.matches = function(e, t) {
                return k(e, null, null, t);
            }, k.matchesSelector = function(e, t) {
                if (He(e), M && !pe[t + " "] && (!h || !h.test(t))) try {
                    var o = ae.call(e, t);
                    if (o || f.disconnectedMatch || e.document && 11 !== e.document.nodeType) return o;
                } catch (e) {
                    pe(t, !0);
                }
                return 0 < k(t, D, null, [ e ]).length;
            }, k.contains = function(e, t) {
                return (e.ownerDocument || e) != D && He(e), C.contains(e, t);
            }, k.attr = function(e, t) {
                (e.ownerDocument || e) != D && He(e);
                var o = R.attrHandle[t.toLowerCase()], o = o && W.call(R.attrHandle, t.toLowerCase()) ? o(e, t, !M) : void 0;
                return void 0 !== o ? o : e.getAttribute(t);
            }, k.error = function(e) {
                throw new Error("Syntax error, unrecognized expression: " + e);
            }, C.uniqueSort = function(e) {
                var t, o = [], i = 0, n = 0;
                if (se = !f.sortStable, re = !f.sortStable && a.call(e, 0), Q.call(e, me), 
                se) {
                    for (;t = e[n++]; ) t === e[n] && (i = o.push(n));
                    for (;i--; ) Z.call(e, o[i], 1);
                }
                return re = null, e;
                ...
                preFilter: {
                    ATTR: function(e) {
                        return e[1] = e[1].replace(d, p), e[3] = (e[3] || e[4] || e[5] || "").replace(d, p), 
                        "~=" === e[2] && (e[3] = " " + e[3] + " "), e.slice(0, 4);
                    },
                    CHILD: function(e) {
                        return e[1] = e[1].toLowerCase(), "nth" === e[1].slice(0, 3) ? (e[3] || k.error(e[0]), 
                        e[4] = +(e[4] ? e[5] + (e[6] || 1) : 2 * ("even" === e[3] || "odd" === e[3])), 
                        e[5] = +(e[7] + e[8] || "odd" === e[3])) : e[3] && k.error(e[0]), 
                        e;
                    },
                    PSEUDO: function(e) {
                        var t, o = !e[6] && e[2];
                        return xe.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[4] || e[5] || "" : o && we.test(o) && (t = (t = ze(o, !0)) && o.indexOf(")", o.length - t) - o.length) && (e[0] = e[0].slice(0, t), 
                ...
                filter: {
                    ...
                    CLASS: function(e) {
                        var t = ue[e + " "];
                        return t || (t = new RegExp("(^|" + o + ")" + e + "(" + o + "|$)")) && ue(e, function(e) {
                    ...
                    ATTR: function(t, o, i) {
                        return function(e) {
                            e = k.attr(e, t);
                            return null == e ? "!=" === o : !o || (e += "", "=" === o ? e === i : "!=" === o ? e !== i : "^=" === o ? i && 0 === e.indexOf(i) : "*=" === o ? i && -1 < e.indexOf(i) : "$=" === o ? i && e.slice(-i.length) === i : "~=" === o ? -1 < (" " + e.replace(ge, " ") + " ").indexOf(i) : "|=" === o && (e === i || e.slice(0, i.length + 1) === i + "-"));
                        };
                    },
                    CHILD: function(p, e, t, m, f) {
                        var g = "nth" !== p.slice(0, 3), b = "last" !== p.slice(-4), v = "of-type" === e;
                        return 1 === m && 0 === f ? function(e) {
                            return !!e.parentNode;
                        } : function(e, t, o) {
                            var i, n, r, s, a, l = g != b ? "nextSibling" : "previousSibling", c = e.parentNode, u = v && e.nodeName.toLowerCase(), d = !o && !v, h = !1;
                            if (c) {
                                if (g) {
                                    for (;l; ) {
                                        for (r = e; r = r[l]; ) if (v ? w(r, u) : 1 === r.nodeType) return !1;
                                        a = l = "only" === p && !a && "nextSibling";
                                    }
                                    return !0;
                                }
                                if (a = [ b ? c.firstChild : c.lastChild ], b && d) {
                                    for (h = (s = (i = (n = c[S] || (c[S] = {}))[p] || [])[0] === L && i[1]) && i[2], 
                                    r = s && c.childNodes[s]; r = ++s && r && r[l] || (h = s = 0, 
                                    a.pop()); ) if (1 === r.nodeType && ++h && r === e) {
                                        n[p] = [ L, s, h ];
                                        break;
                                    }
                                } else if (!1 === (h = d ? s = (i = (n = e[S] || (e[S] = {}))[p] || [])[0] === L && i[1] : h)) for (;(r = ++s && r && r[l] || (h = s = 0, 
                                a.pop())) && ((v ? !w(r, u) : 1 !== r.nodeType) || !++h || (d && ((n = r[S] || (r[S] = {}))[p] = [ L, h ]), 
                                r !== e)); );
                                return (h -= f) === m || h % m == 0 && 0 <= h / m;
                            }
                        };
                    },
                    PSEUDO: function(e, r) {
                        var t, s = R.pseudos[e] || R.setFilters[e.toLowerCase()] || k.error("unsupported pseudo: " + e);
                        return s[S] ? s(r) : 1 < s.length ? (t = [ e, e, "", r ], 
                        R.setFilters.hasOwnProperty(e.toLowerCase()) ? l(function(e, t) {
                            for (var o, i = s(e, r), n = i.length; n--; ) e[o = y.call(e, i[n])] = !(t[o] = i[n]);
                        }) : function(e) {
                            return s(e, 0, t);
                        }) : s;
                    }
                ...
                pseudos: {
                    not: l(function(e) {
                        var i = [], n = [], a = We(e.replace(ee, "$1"));
                        return a[S] ? l(function(e, t, o, i) {
                    ...
                    lang: l(function(o) {
                        return Ee.test(o || "") || k.error("unsupported lang: " + o), 
                        o = o.replace(d, p).toLowerCase(), function(e) {
                            var t;
                            do {
                                if (t = M ? e.lang : e.getAttribute("xml:lang") || e.getAttribute("lang")) return (t = t.toLowerCase()) === o || 0 === t.indexOf(o + "-");
                    ...
                    focus: function(e) {
                        ...
                        }() && D.hasFocus() && !!(e.type || e.href || ~e.tabIndex);
                    },
                    enabled: _e(!1),
                    disabled: _e(!0),
                    checked: function(e) {
                    ...
                    lt: Ae(function(e, t, o) {
                        for (var i = o < 0 ? o + t : t < o ? t : o; 0 <= --i; ) e.push(i);
                        return e;
                    }),
                    gt: Ae(function(e, t, o) {
            ...
            function Pe() {}
            function ze(e, t) {
                var o, i, n, r, s, a, l, c = de[e + " "];
                if (c) return t ? 0 : c.slice(0);
                for (s = e, a = [], l = R.preFilter; s; ) {
                    for (r in o && !(i = be.exec(s)) || (i && (s = s.slice(i[0].length) || s), 
                    a.push(n = [])), o = !1, (i = ve.exec(s)) && (o = i.shift(), 
                    n.push({
                        value: o,
                        type: i[0].replace(ee, " ")
                    }), s = s.slice(o.length)), R.filter) !(i = xe[r].exec(s)) || l[r] && !(i = l[r](i)) || (o = i.shift(), 
                    n.push({
                        value: o,
                        type: r,
                        matches: i
                ...
                return t ? s.length : s ? k.error(e) : de(e, a).slice(0);
            }
            function Oe(e) {
            ...
            function Fe(s, e, t) {
                var a = e.dir, l = e.next, c = l || a, u = t && "parentNode" === c, d = ce++;
                return e.first ? function(e, t, o) {
                    ...
                    } else for (;e = e[a]; ) if (1 === e.nodeType || u) if (n = e[S] || (e[S] = {}), 
                    l && w(e, l)) e = e[a] || e; else {
                        if ((i = n[c]) && i[0] === L && i[1] === d) return r[2] = i[2];
                        if ((n[c] = r)[2] = s(e, t, o)) return !0;
                    }
                    return !1;
                };
            }
            ...
            function Be(p, m, f, g, b, e) {
                return g && !g[S] && (g = Be(g)), b && !b[S] && (b = Be(b, e)), 
                l(function(e, t, o, i) {
                    var n, r, s, a, l = [], c = [], u = t.length, d = e || function(e, t, o) {
                        for (var i = 0, n = t.length; i < n; i++) k(e, t[i], o);
                        return o;
                    }(m || "*", o.nodeType ? [ o ] : o, []), h = !p || !e && m ? d : je(d, l, p, o, i);
                    if (f ? f(h, a = b || (e ? p : u || g) ? [] : t, o, i) : a = h, 
                    g) for (n = je(a, c), g(n, [], o, i), r = n.length; r--; ) (s = n[r]) && (a[c[r]] = !(h[c[r]] = s));
                    if (e) {
                        if (b || p) {
                            if (b) {
                                for (n = [], r = a.length; r--; ) (s = a[r]) && n.push(h[r] = s);
                                b(null, a = [], n, i);
                            }
                            for (r = a.length; r--; ) (s = a[r]) && -1 < (n = b ? y.call(e, s) : l[r]) && (e[n] = !(t[n] = s));
                        }
                    } else a = je(a === t ? a.splice(u, a.length) : a), b ? b(null, t, a, i) : T.apply(t, a);
                });
            }
            function Ve(g, b) {
                function e(e, t, o, i, n) {
                    var r, s, a, l = 0, c = "0", u = e && [], d = [], h = ne, p = e || y && R.find.TAG("*", n), m = L += null == h ? 1 : Math.random() || .1, f = p.length;
                    for (n && (ne = t == D || t || n); c !== f && null != (r = p[c]); c++) {
                        if (y && r) {
                            for (s = 0, t || r.ownerDocument == D || (He(r), o = !M); a = g[s++]; ) if (a(r, t || D, o)) {
                                T.call(i, r);
                                break;
                            }
                            n && (L = m);
                    ...
                    if (l += c, v && c !== l) {
                        ...
                        T.apply(i, d), n && !e && 0 < d.length && 1 < l + b.length && C.uniqueSort(i);
                    }
                    return n && (L = m, ne = h), u;
                }
            ...
            function We(e, t) {
                var o, i = [], n = [], r = he[e + " "];
                if (!r) {
                    for (o = (t = t || ze(e)).length; o--; ) ((r = function e(t) {
                        for (var i, o, n, r = t.length, s = R.relative[t[0].type], a = s || R.relative[" "], l = s ? 1 : 0, c = Fe(function(e) {
                            return e === i;
                        }, a, !0), u = Fe(function(e) {
                            return -1 < y.call(i, e);
                        }, a, !0), d = [ function(e, t, o) {
                            return e = !s && (o || t != ne) || ((i = t).nodeType ? c : u)(e, t, o), 
                            i = null, e;
                        } ]; l < r; l++) if (o = R.relative[t[l].type]) d = [ Fe(Ie(d), o) ]; else {
                            if ((o = R.filter[t[l].type].apply(null, t[l].matches))[S]) {
                                for (n = ++l; n < r && !R.relative[t[n].type]; n++);
                                return Be(1 < l && Ie(d), 1 < l && Oe(t.slice(0, l - 1).concat({
                                    value: " " === t[l - 2].type ? "*" : ""
                                })).replace(ee, "$1"), o, l < n && e(t.slice(l, n)), n < r && e(t = t.slice(n)), n < r && Oe(t));
                            }
                            d.push(o);
                        }
                        return Ie(d);
                    }(t[o]))[S] ? i : n).push(r);
                    (r = he(e, Ve(n, i))).selector = e;
                }
                return r;
            }
            function $e(e, t, o, i) {
                var n, r, s, a, l, c = "function" == typeof e && e, u = !i && ze(e = c.selector || e);
                if (o = o || [], 1 === u.length) {
                    if (2 < (r = u[0] = u[0].slice(0)).length && "ID" === (s = r[0]).type && 9 === t.nodeType && M && R.relative[r[1].type]) {
                        if (!(t = (R.find.ID(s.matches[0].replace(d, p), t) || [])[0])) return o;
                        c && (t = t.parentNode), e = e.slice(r.shift().value.length);
                    }
                    for (n = xe.needsContext.test(e) ? 0 : r.length; n-- && (s = r[n], 
                    !R.relative[a = s.type]); ) if ((l = R.find[a]) && (i = l(s.matches[0].replace(d, p), Me.test(r[0].type) && Ne(t.parentNode) || t))) {
                        if (r.splice(n, 1), e = i.length && Oe(r)) break;
                        return T.apply(o, i), o;
                    }
                }
                return (c || We(e, u))(i, t, !M, o, !t || Me.test(e) && Ne(t.parentNode) || t), 
                o;
            }
            Pe.prototype = R.filters = R.pseudos, R.setFilters = new Pe(), f.sortStable = S.split("").sort(me).join("") === S, 
            He(), f.sortDetached = ke(function(e) {
                return 1 & e.compareDocumentPosition(D.createElement("fieldset"));
            }), C.find = k, C.expr[":"] = C.expr.pseudos, C.unique = C.uniqueSort, 
            k.compile = We, k.select = $e, k.setDocument = He, k.tokenize = ze, 
            k.escape = C.escapeSelector, k.getText = C.text, k.isXML = C.isXMLDoc, 
            k.selectors = C.expr, k.support = C.support, k.uniqueSort = C.uniqueSort;
            function Ge(e, t, o) {
            ...
            var Ue = C.expr.match.needsContext, Xe = /^<([a-z][^\/\0>:\x20\t\r\n\f]*)[\x20\t\r\n\f]*\/?>(?:<\/\1>|)$/i;
            function Ye(e, o, i) {
                return v(o) ? C.grep(e, function(e, t) {
                    return !!o.call(e, t, e) !== i;
                }) : o.nodeType ? C.grep(e, function(e) {
                    return e === o !== i;
                }) : "string" != typeof o ? C.grep(e, function(e) {
                    return -1 < y.call(o, e) !== i;
                }) : C.filter(o, e, i);
            }
            C.filter = function(e, t, o) {
                var i = t[0];
                return o && (e = ":not(" + e + ")"), 1 === t.length && 1 === i.nodeType ? C.find.matchesSelector(i, e) ? [ i ] : [] : C.find.matches(e, C.grep(t, function(e) {
                    return 1 === e.nodeType;
                }));
            }, C.fn.extend({
                find: function(e) {
                    ...
                    for (o = this.pushStack([]), t = 0; t < i; t++) C.find(e, n[t], o);
                    return 1 < i ? C.uniqueSort(o) : o;
                },
                filter: function(e) {
                ...
                is: function(e) {
                    return !!Ye(this, "string" == typeof e && Ue.test(e) ? C(e) : e || [], !1).length;
                }
            });
            var Ke, Je = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/, Qe = ((C.fn.init = function(e, t, o) {
                if (e) {
                    if (o = o || Ke, "string" != typeof e) return e.nodeType ? (this[0] = e, 
                    this.length = 1, this) : v(e) ? void 0 !== o.ready ? o.ready(e) : e(C) : C.makeArray(e, this);
                    if (!(i = "<" === e[0] && ">" === e[e.length - 1] && 3 <= e.length ? [ null, e, null ] : Je.exec(e)) || !i[1] && t) return (!t || t.jquery ? t || o : this.constructor(t)).find(e);
                    if (i[1]) {
                        if (t = t instanceof C ? t[0] : t, C.merge(this, C.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : x, !0)), 
                        Xe.test(i[1]) && C.isPlainObject(t)) for (var i in t) v(this[i]) ? this[i](t[i]) : this.attr(i, t[i]);
                    } else (o = x.getElementById(i[2])) && (this[0] = o, this.length = 1);
                }
                return this;
            }).prototype = C.fn, Ke = C(x), /^(?:parents|prev(?:Until|All))/), Ze = {
                children: !0,
                contents: !0,
                next: !0,
                prev: !0
            ...
            C.fn.extend({
                has: function(e) {
                    var t = C(e, this), o = t.length;
                    return this.filter(function() {
                        for (var e = 0; e < o; e++) if (C.contains(this, t[e])) return !0;
                    });
                },
                closest: function(e, t) {
                    var o, i = 0, n = this.length, r = [], s = "string" != typeof e && C(e);
                    if (!Ue.test(e)) for (;i < n; i++) for (o = this[i]; o && o !== t; o = o.parentNode) if (o.nodeType < 11 && (s ? -1 < s.index(o) : 1 === o.nodeType && C.find.matchesSelector(o, e))) {
                        r.push(o);
                        break;
                    }
                ...
                nextUntil: function(e, t, o) {
                    return Ge(e, "nextSibling", o);
                },
                prevUntil: function(e, t, o) {
                    return Ge(e, "previousSibling", o);
                },
                siblings: function(e) {
                ...
                contents: function(e) {
                    return null != e.contentDocument && F(e.contentDocument) ? e.contentDocument : (w(e, "template") && (e = e.content || e), 
                    C.merge([], e.childNodes));
                }
            }, function(i, n) {
                C.fn[i] = function(e, t) {
                    var o = C.map(this, n, e);
                    return (t = "Until" !== i.slice(-5) ? e : t) && "string" == typeof t && (o = C.filter(t, o)), 
                    1 < this.length && (Ze[i] || C.uniqueSort(o), Qe.test(i)) && o.reverse(), 
                    this.pushStack(o);
                };
            });
            var _ = /[^\x20\t\r\n\f]+/g;
            ...
            function it(e, t, o, i) {
                var n;
                try {
                    e && v(n = e.promise) ? n.call(e).done(t).fail(o) : e && v(n = e.then) ? n.call(e, t, o) : t.apply(void 0, [ e ].slice(i));
                } catch (e) {
                    o.apply(void 0, [ e ]);
                }
            }
            C.Callbacks = function(i) {
                var e, o;
                i = "string" == typeof i ? (e = i, o = {}, C.each(e.match(_) || [], function(e, t) {
                    o[t] = !0;
                }), o) : C.extend({}, i);
                function n() {
                    ...
                    add: function() {
                        return l && (t && !r && (u = l.length - 1, c.push(t)), function o(e) {
                            C.each(e, function(e, t) {
                                v(t) ? i.unique && d.has(t) || l.push(t) : t && t.length && "string" !== X(t) && o(t);
                            });
                        }(arguments), t) && !r && n(), this;
                    },
                    remove: function() {
                        return C.each(arguments, function(e, t) {
                            for (var o; -1 < (o = C.inArray(t, l, o)); ) l.splice(o, 1), 
                            o <= u && u--;
                        }), this;
                    },
                    has: function(e) {
                ...
                Deferred: function(e) {
                    var r = [ [ "notify", "progress", C.Callbacks("memory"), C.Callbacks("memory"), 2 ], [ "resolve", "done", C.Callbacks("once memory"), C.Callbacks("once memory"), 0, "resolved" ], [ "reject", "fail", C.Callbacks("once memory"), C.Callbacks("once memory"), 1, "rejected" ] ], n = "pending", s = {
                        state: function() {
                            return n;
                        },
                        always: function() {
                            ...
                            return C.Deferred(function(i) {
                                C.each(r, function(e, t) {
                                    ...
                                    a[t[1]](function() {
                                        ...
                                        e && v(e.promise) ? e.promise().progress(i.notify).done(i.resolve).fail(i.reject) : i[t[0] + "With"](this, o ? [ e ] : arguments);
                                    });
                                }), n = null;
                            }).promise();
                        },
                                ...
                                return function() {
                                    function e() {
                                        ...
                                        if (!(n < l)) {
                                            ...
                                            v(t) ? a ? t.call(e, c(l, r, tt, a), c(l, r, ot, a)) : (l++, 
                                            t.call(e, c(l, r, tt, a), c(l, r, ot, a), c(l, r, tt, r.notifyWith))) : (s !== tt && (o = void 0, 
                                    ...
                                    n ? t() : (C.Deferred.getErrorHook ? t.error = C.Deferred.getErrorHook() : C.Deferred.getStackHook && (t.error = C.Deferred.getStackHook()), 
                                    E.setTimeout(t));
                                };
                            }
                            return C.Deferred(function(e) {
                                r[0][3].add(c(0, e, v(i) ? i : tt, e.notifyWith)), 
                                r[1][3].add(c(0, e, v(t) ? t : tt)), r[2][3].add(c(0, e, v(o) ? o : ot));
                            }).promise();
                        },
                        promise: function(e) {
                ...
                when: function(e) {
                    function t(t) {
                        return function(e) {
                            n[t] = this, r[t] = 1 < arguments.length ? a.call(arguments) : e, 
                            --o || s.resolveWith(n, r);
                        };
                    }
                    var o = arguments.length, i = o, n = Array(i), r = a.call(arguments), s = C.Deferred();
                    if (o <= 1 && (it(e, s.done(t(i)).resolve, s.reject, !o), "pending" === s.state() || v(r[i] && r[i].then))) return s.then();
                    for (;i--; ) it(r[i], t(i), s.reject);
                    return s.promise();
                }
            });
            var nt = /^(Eval|Internal|Range|Reference|Syntax|Type|URI)Error$/, rt = (C.Deferred.exceptionHook = function(e, t) {
                E.console && E.console.warn && e && nt.test(e.name) && E.console.warn("jQuery.Deferred exception: " + e.message, e.stack, t);
            ...
            function st() {
                x.removeEventListener("DOMContentLoaded", st), E.removeEventListener("load", st), 
                C.ready();
            }
            C.fn.ready = function(e) {
                ...
                readyWait: 1,
                ready: function(e) {
                    (!0 === e ? --C.readyWait : C.isReady) || (C.isReady = !0) !== e && 0 < --C.readyWait || rt.resolveWith(x, [ C ]);
                }
            }), C.ready.then = rt.then, "complete" === x.readyState || "loading" !== x.readyState && !x.documentElement.doScroll ? E.setTimeout(C.ready) : (x.addEventListener("DOMContentLoaded", st), 
            E.addEventListener("load", st));
            function u(e, t, o, i, n, r, s) {
                var a = 0, l = e.length, c = null == o;
                if ("object" === X(o)) for (a in n = !0, o) u(e, t, a, o[a], !0, r, s); else if (void 0 !== i && (n = !0, 
                v(i) || (s = !0), t = c ? s ? (t.call(e, i), null) : (c = t, function(e, t, o) {
                    return c.call(C(e), o);
            ...
            dt.uid = 1, dt.prototype = {
                ...
                set: function(e, t, o) {
                    ...
                    if ("string" == typeof t) n[A(t)] = o; else for (i in t) n[A(i)] = t[i];
                    return n;
                },
                get: function(e, t) {
                ...
                remove: function(e, t) {
                    ...
                    if (void 0 !== i) {
                        if (void 0 !== t) {
                            o = (t = Array.isArray(t) ? t.map(A) : (t = A(t)) in i ? [ t ] : t.match(_) || []).length;
                            for (;o--; ) delete i[t[o]];
                        }
            ...
            var b = new dt(), c = new dt(), ht = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/, pt = /[A-Z]/g;
            function mt(e, t, o) {
                var i, n;
                if (void 0 === o && 1 === e.nodeType) if (i = "data-" + t.replace(pt, "-$&").toLowerCase(), 
                "string" == typeof (o = e.getAttribute(i))) {
                    try {
                        o = "true" === (n = o) || "false" !== n && ("null" === n ? null : n === +n + "" ? +n : ht.test(n) ? JSON.parse(n) : n);
                    } catch (e) {}
                    c.set(e, t, o);
                } else o = void 0;
                return o;
            ...
            C.extend({
                ...
                data: function(e, t, o) {
                    return c.access(e, t, o);
                },
                removeData: function(e, t) {
                    c.remove(e, t);
                },
                _data: function(e, t, o) {
                    return b.access(e, t, o);
                },
                ...
                data: function(o, e) {
                    ...
                    if (void 0 !== o) return "object" == typeof o ? this.each(function() {
                        ...
                        var t;
                        if (r && void 0 === e) return void 0 !== (t = c.get(r, o)) || void 0 !== (t = mt(r, o)) ? t : void 0;
                        this.each(function() {
                            c.set(this, o, e);
                        });
                    }, null, e, 1 < arguments.length, null, !0);
                    if (this.length && (n = c.get(r), 1 === r.nodeType) && !b.get(r, "hasDataAttrs")) {
                        for (t = s.length; t--; ) s[t] && 0 === (i = s[t].name).indexOf("data-") && (i = A(i.slice(5)), 
                        mt(r, i, n[i]));
                ...
                queue: function(e, t, o) {
                    var i;
                    if (e) return i = b.get(e, t = (t || "fx") + "queue"), o && (!i || Array.isArray(o) ? i = b.access(e, t, C.makeArray(o)) : i.push(o)), 
                    i || [];
                },
                dequeue: function(e, t) {
                    t = t || "fx";
                    var o = C.queue(e, t), i = o.length, n = o.shift(), r = C._queueHooks(e, t);
                ...
                _queueHooks: function(e, t) {
                    var o = t + "queueHooks";
                    return b.get(e, o) || b.access(e, o, {
                        empty: C.Callbacks("once memory").add(function() {
                            b.remove(e, [ t + "queue", o ]);
                        })
                    });
                }
            }), C.fn.extend({
                queue: function(t, o) {
                    var e = 2;
                    return "string" != typeof t && (o = t, t = "fx", e--), arguments.length < e ? C.queue(this[0], t) : void 0 === o ? this : this.each(function() {
                        var e = C.queue(this, t, o);
                ...
                promise: function(e, t) {
                    ...
                    var i, n = 1, r = C.Deferred(), s = this, a = this.length;
                    for ("string" != typeof e && (t = e, e = void 0), e = e || "fx"; a--; ) (i = b.get(s[a], e + "queueHooks")) && i.empty && (n++, 
                    i.empty.add(o));
                    return o(), r.promise(t);
                }
            });
            function ft(e, t) {
                return "none" === (e = t || e).style.display || "" === e.style.display && yt(e) && "none" === C.css(e, "display");
            }
            var e = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, gt = new RegExp("^(?:([+-])=|)(" + e + ")([a-z%]*)$", "i"), bt = [ "Top", "Right", "Bottom", "Left" ], vt = x.documentElement, yt = function(e) {
                return C.contains(e.ownerDocument, e);
            }, wt = {
                composed: !0
            };
            vt.getRootNode && (yt = function(e) {
                return C.contains(e.ownerDocument, e) || e.getRootNode(wt) === e.ownerDocument;
            });
            function Et(e, t, o, i) {
                var n, r, s = 20, a = i ? function() {
                    ...
                    return C.css(e, t, "");
                }, l = a(), c = o && o[3] || (C.cssNumber[t] ? "" : "px"), u = e.nodeType && (C.cssNumber[t] || "px" !== c && +l) && gt.exec(C.css(e, t));
                if (u && u[3] !== c) {
                    for (c = c || u[3], u = +(l /= 2) || 1; s--; ) C.style(e, t, u + c), 
                    (1 - r) * (1 - (r = a() / l || .5)) <= 0 && (s = 0), u /= r;
                    C.style(e, t, (u *= 2) + c), o = o || [];
                }
                return o && (u = +u || +l || 0, n = o[1] ? u + (o[1] + 1) * o[2] : +o[2], 
                i) && (i.unit = c, i.start = u, i.end = n), n;
            }
            var xt = {};
            function Ct(e, t) {
                for (var o, i, n, r, s, a = [], l = 0, c = e.length; l < c; l++) (i = e[l]).style && (o = i.style.display, 
                t ? ("none" === o && (a[l] = b.get(i, "display") || null, a[l] || (i.style.display = "")), 
                "" === i.style.display && ft(i) && (a[l] = (s = r = void 0, r = (n = i).ownerDocument, 
                n = n.nodeName, (s = xt[n]) || (r = r.body.appendChild(r.createElement(n)), 
                s = C.css(r, "display"), r.parentNode.removeChild(r), xt[n] = s = "none" === s ? "block" : s), 
                s))) : "none" !== o && (a[l] = "none", b.set(i, "display", o)));
            ...
            var Rt = /^(?:checkbox|radio)$/i, Dt = /<([a-z][^\/\0>\x20\t\r\n\f]*)/i, Mt = /^$|^module$|\/(?:java|ecma)script/i, m = (r = x.createDocumentFragment().appendChild(x.createElement("div")), 
            (s = x.createElement("input")).setAttribute("type", "radio"), s.setAttribute("checked", "checked"), 
            s.setAttribute("name", "t"), r.appendChild(s), f.checkClone = r.cloneNode(!0).cloneNode(!0).lastChild.checked, 
            r.innerHTML = "<textarea>x</textarea>", f.noCloneChecked = !!r.cloneNode(!0).lastChild.defaultValue, 
            r.innerHTML = "<option></option>", f.option = !!r.lastChild, {
                thead: [ 1, "<table>", "</table>" ],
            ...
            function g(e, t) {
                ...
                return void 0 === t || t && w(e, t) ? C.merge([ e ], o) : o;
            }
            function Tt(e, t) {
                for (var o = 0, i = e.length; o < i; o++) b.set(e[o], "globalEval", !t || b.get(t[o], "globalEval"));
            }
            m.tbody = m.tfoot = m.colgroup = m.caption = m.thead, m.th = m.td, f.option || (m.optgroup = m.option = [ 1, "<select multiple='multiple'>", "</select>" ]);
            var St = /<|&#?\w+;/;
            function Lt(e, t, o, i, n) {
                for (var r, s, a, l, c, u = t.createDocumentFragment(), d = [], h = 0, p = e.length; h < p; h++) if ((r = e[h]) || 0 === r) if ("object" === X(r)) C.merge(d, r.nodeType ? [ r ] : r); else if (St.test(r)) {
                    for (s = s || u.appendChild(t.createElement("div")), a = (Dt.exec(r) || [ "", "" ])[1].toLowerCase(), 
                    a = m[a] || m._default, s.innerHTML = a[1] + C.htmlPrefilter(r) + a[2], 
                    c = a[0]; c--; ) s = s.lastChild;
                    C.merge(d, s.childNodes), (s = u.firstChild).textContent = "";
                } else d.push(t.createTextNode(r));
                for (u.textContent = "", h = 0; r = d[h++]; ) if (i && -1 < C.inArray(r, i)) n && n.push(r); else if (l = yt(r), 
                s = g(u.appendChild(r), "script"), l && Tt(s), o) for (c = 0; r = s[c++]; ) Mt.test(r.type || "") && o.push(r);
                return u;
            }
            var kt = /^([^.]*)(?:\.(.+)|)/;
            function _t() {
            ...
            function Nt(e, t, o, i, n, r) {
                var s, a;
                if ("object" == typeof t) {
                    for (a in "string" != typeof o && (i = i || o, o = void 0), 
                    t) Nt(e, a, o, i, t[a], r);
                    return e;
                }
                if (null == i && null == n ? (n = o, i = o = void 0) : null == n && ("string" == typeof o ? (n = i, 
                i = void 0) : (n = i, i = o, o = void 0)), !1 === n) n = At; else if (!n) return e;
                return 1 === r && (s = n, (n = function(e) {
                    return C().off(e), s.apply(this, arguments);
                }).guid = s.guid || (s.guid = C.guid++)), e.each(function() {
                    C.event.add(this, t, n, i, o);
                });
            }
            function Ht(e, i, t) {
                t ? (b.set(e, i, !1), C.event.add(e, i, {
                    namespace: !1,
                    handler: function(e) {
                        var t, o = b.get(this, i);
                        if (1 & e.isTrigger && this[i]) {
                            if (o) (C.event.special[i] || {}).delegateType && e.stopPropagation(); else if (o = a.call(arguments), 
                            b.set(this, i, o), this[i](), t = b.get(this, i), b.set(this, i, !1), 
                            o !== t) return e.stopImmediatePropagation(), e.preventDefault(), 
                            t;
                        } else o && (b.set(this, i, C.event.trigger(o[0], o.slice(1), this)), 
                        e.stopPropagation(), e.isImmediatePropagationStopped = _t);
                    }
                })) : void 0 === b.get(e, i) && C.event.add(e, i, _t);
            }
            C.event = {
                global: {},
                add: function(t, e, o, i, n) {
                    var r, s, a, l, c, u, d, h, p, m = b.get(t);
                    if (ut(t)) for (o.handler && (o = (r = o).handler, n = r.selector), 
                    n && C.find.matchesSelector(vt, n), o.guid || (o.guid = C.guid++), 
                    a = (a = m.events) || (m.events = Object.create(null)), s = (s = m.handle) || (m.handle = function(e) {
                        return void 0 !== C && C.event.triggered !== e.type ? C.event.dispatch.apply(t, arguments) : void 0;
                    }), l = (e = (e || "").match(_) || [ "" ]).length; l--; ) d = p = (h = kt.exec(e[l]) || [])[1], 
                    h = (h[2] || "").split(".").sort(), d && (c = C.event.special[d] || {}, 
                    d = (n ? c.delegateType : c.bindType) || d, c = C.event.special[d] || {}, 
                    p = C.extend({
                        type: d,
                        origType: p,
                        data: i,
                        ...
                        namespace: h.join(".")
                    }, r), (u = a[d]) || ((u = a[d] = []).delegateCount = 0, c.setup && !1 !== c.setup.call(t, i, h, s)) || t.addEventListener && t.addEventListener(d, s), 
                    c.add && (c.add.call(t, p), p.handler.guid || (p.handler.guid = o.guid)), 
                    n ? u.splice(u.delegateCount++, 0, p) : u.push(p), C.event.global[d] = !0);
                },
                remove: function(e, t, o, i, n) {
                    var r, s, a, l, c, u, d, h, p, m, f, g = b.hasData(e) && b.get(e);
                    if (g && (l = g.events)) {
                        for (c = (t = (t || "").match(_) || [ "" ]).length; c--; ) if (p = f = (a = kt.exec(t[c]) || [])[1], 
                        m = (a[2] || "").split(".").sort(), p) {
                            for (d = C.event.special[p] || {}, h = l[p = (i ? d.delegateType : d.bindType) || p] || [], 
                            a = a[2] && new RegExp("(^|\\.)" + m.join("\\.(?:.*\\.|)") + "(\\.|$)"), 
                            s = r = h.length; r--; ) u = h[r], !n && f !== u.origType || o && o.guid !== u.guid || a && !a.test(u.namespace) || i && i !== u.selector && ("**" !== i || !u.selector) || (h.splice(r, 1), 
                            u.selector && h.delegateCount--, d.remove && d.remove.call(e, u));
                            s && !h.length && (d.teardown && !1 !== d.teardown.call(e, m, g.handle) || C.removeEvent(e, p, g.handle), 
                            delete l[p]);
                        } else for (p in l) C.event.remove(e, p + t[c], o, i, !0);
                        C.isEmptyObject(l) && b.remove(e, "handle events");
                    }
                },
                dispatch: function(e) {
                    var t, o, i, n, r, s = new Array(arguments.length), a = C.event.fix(e), e = (b.get(this, "events") || Object.create(null))[a.type] || [], l = C.event.special[a.type] || {};
                    for (s[0] = a, t = 1; t < arguments.length; t++) s[t] = arguments[t];
                    if (a.delegateTarget = this, !l.preDispatch || !1 !== l.preDispatch.call(this, a)) {
                        for (r = C.event.handlers.call(this, a, e), t = 0; (i = r[t++]) && !a.isPropagationStopped(); ) for (a.currentTarget = i.elem, 
                        ...
                        a.data = n.data, void 0 !== (n = ((C.event.special[n.origType] || {}).handle || n.handler).apply(i.elem, s)) && !1 === (a.result = n) && (a.preventDefault(), 
                        a.stopPropagation()));
                ...
                handlers: function(e, t) {
                    ...
                    if (l && c.nodeType && !("click" === e.type && 1 <= e.button)) for (;c !== this; c = c.parentNode || this) if (1 === c.nodeType && ("click" !== e.type || !0 !== c.disabled)) {
                        for (r = [], s = {}, o = 0; o < l; o++) void 0 === s[n = (i = t[o]).selector + " "] && (s[n] = i.needsContext ? -1 < C(n, this).index(c) : C.find(n, this, null, [ c ]).length), 
                        s[n] && r.push(i);
                        r.length && a.push({
                            elem: c,
                            handlers: r
                ...
                special: {
                    ...
                    click: {
                        setup: function(e) {
                            e = this || e;
                            return Rt.test(e.type) && e.click && w(e, "input") && Ht(e, "click", !0), 
                            !1;
                        },
                        trigger: function(e) {
                            e = this || e;
                            return Rt.test(e.type) && e.click && w(e, "input") && Ht(e, "click"), 
                            !0;
                        },
                        _default: function(e) {
                            e = e.target;
                            return Rt.test(e.type) && e.click && w(e, "input") && b.get(e, "click") || w(e, "a");
                        }
                    },
                    beforeunload: {
            ...
            }, C.removeEvent = function(e, t, o) {
                e.removeEventListener && e.removeEventListener(t, o);
            }, C.Event = function(e, t) {
                if (!(this instanceof C.Event)) return new C.Event(e, t);
                e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? _t : At, 
                ...
                stopImmediatePropagation: function() {
                    var e = this.originalEvent;
                    this.isImmediatePropagationStopped = _t, e && !this.isSimulated && e.stopImmediatePropagation(), 
                ...
                function r(e) {
                    var t, o;
                    x.documentMode ? (t = b.get(this, "handle"), (o = C.event.fix(e)).type = "focusin" === e.type ? "focus" : "blur", 
                    o.isSimulated = !0, t(e), o.target === o.currentTarget && t(o)) : C.event.simulate(n, e.target, C.event.fix(e));
                }
                C.event.special[i] = {
                    setup: function() {
                        var e;
                        if (Ht(this, i, !0), !x.documentMode) return !1;
                        (e = b.get(this, n)) || this.addEventListener(n, r), b.set(this, n, (e || 0) + 1);
                    },
                    trigger: function() {
                        return Ht(this, i), !0;
                    },
                    teardown: function() {
                        ...
                        (e = b.get(this, n) - 1) ? b.set(this, n, e) : (this.removeEventListener(n, r), 
                        b.remove(this, n));
                    },
                    _default: function(e) {
                        return b.get(e.target, i);
                    },
                    delegateType: n
                }, C.event.special[n] = {
                    setup: function() {
                        var e = this.ownerDocument || this.document || this, t = x.documentMode ? this : e, o = b.get(t, n);
                        o || (x.documentMode ? this.addEventListener(n, r) : e.addEventListener(i, r, !0)), 
                        b.set(t, n, (o || 0) + 1);
                    },
                    teardown: function() {
                        var e = this.ownerDocument || this.document || this, t = x.documentMode ? this : e, o = b.get(t, n) - 1;
                        o ? b.set(t, n, o) : (x.documentMode ? this.removeEventListener(n, r) : e.removeEventListener(i, r, !0), 
                        b.remove(t, n));
                    }
                };
            }), C.each({
                ...
                C.event.special[e] = {
                    ...
                    handle: function(e) {
                        ...
                        return o && (o === this || C.contains(this, o)) || (e.type = i.origType, 
                        t = i.handler.apply(this, arguments), e.type = n), t;
                    }
                };
            }), C.fn.extend({
                on: function(e, t, o, i) {
                    return Nt(this, e, t, o, i);
                },
                one: function(e, t, o, i) {
                    return Nt(this, e, t, o, i, 1);
                },
                off: function(e, t, o) {
                    var i, n;
                    if (e && e.preventDefault && e.handleObj) i = e.handleObj, C(e.delegateTarget).off(i.namespace ? i.origType + "." + i.namespace : i.origType, i.selector, i.handler); else {
                        if ("object" != typeof e) return !1 !== t && "function" != typeof t || (o = t, 
                        t = void 0), !1 === o && (o = At), this.each(function() {
                            C.event.remove(this, e, o, t);
                        });
            ...
            var Pt = /<script|<style|<link/i, zt = /checked\s*(?:[^=]|=\s*.checked.)/i, Ot = /^\s*<!\[CDATA\[|\]\]>\s*$/g;
            function Ft(e, t) {
            ...
            function Bt(e, t) {
                var o, i, n, r;
                if (1 === t.nodeType) {
                    if (b.hasData(e) && (r = b.get(e).events)) for (n in b.remove(t, "handle events"), 
                    r) for (o = 0, i = r[n].length; o < i; o++) C.event.add(t, n, r[n][o]);
                    c.hasData(e) && (e = c.access(e), e = C.extend({}, e), c.set(t, e));
                }
            }
            function Vt(o, i, n, r) {
                i = I(i);
                var e, t, s, a, l, c, u = 0, d = o.length, h = d - 1, p = i[0], m = v(p);
                if (m || 1 < d && "string" == typeof p && !f.checkClone && zt.test(p)) return o.each(function(e) {
                    var t = o.eq(e);
                    m && (i[0] = p.call(this, e, t.html())), Vt(t, i, n, r);
                });
                if (d && (t = (e = Lt(i, o[0].ownerDocument, !1, o, r)).firstChild, 
                1 === e.childNodes.length && (e = t), t || r)) {
                    for (a = (s = C.map(g(e, "script"), It)).length; u < d; u++) l = e, 
                    u !== h && (l = C.clone(l, !0, !0), a) && C.merge(s, g(l, "script")), 
                    n.call(o[u], l, u);
                    if (a) for (c = s[s.length - 1].ownerDocument, C.map(s, jt), 
                    u = 0; u < a; u++) l = s[u], Mt.test(l.type || "") && !b.access(l, "globalEval") && C.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? C._evalUrl && !l.noModule && C._evalUrl(l.src, {
                        nonce: l.nonce || l.getAttribute("nonce")
                    }, c) : U(l.textContent.replace(Ot, ""), l, c));
                }
                return o;
            }
            function Wt(e, t, o) {
                for (var i, n = t ? C.filter(t, e) : e, r = 0; null != (i = n[r]); r++) o || 1 !== i.nodeType || C.cleanData(g(i)), 
                i.parentNode && (o && yt(i) && Tt(g(i, "script")), i.parentNode.removeChild(i));
                return e;
            }
            C.extend({
                ...
                clone: function(e, t, o) {
                    var i, n, r, s, a, l, c, u = e.cloneNode(!0), d = yt(e);
                    if (!(f.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || C.isXMLDoc(e))) for (s = g(u), 
                    i = 0, n = (r = g(e)).length; i < n; i++) a = r[i], l = s[i], 
                    c = void 0, "input" === (c = l.nodeName.toLowerCase()) && Rt.test(a.type) ? l.checked = a.checked : "input" !== c && "textarea" !== c || (l.defaultValue = a.defaultValue);
                    if (t) if (o) for (r = r || g(e), s = s || g(u), i = 0, n = r.length; i < n; i++) Bt(r[i], s[i]); else Bt(e, u);
                    return 0 < (s = g(u, "script")).length && Tt(s, !d && g(e, "script")), 
                    u;
                },
                cleanData: function(e) {
                    for (var t, o, i, n = C.event.special, r = 0; void 0 !== (o = e[r]); r++) if (ut(o)) {
                        if (t = o[b.expando]) {
                            if (t.events) for (i in t.events) n[i] ? C.event.remove(o, i) : C.removeEvent(o, i, t.handle);
                            o[b.expando] = void 0;
                        }
                        o[c.expando] && (o[c.expando] = void 0);
                    }
                }
            }), C.fn.extend({
                detach: function(e) {
                ...
                append: function() {
                    return Vt(this, arguments, function(e) {
                        1 !== this.nodeType && 11 !== this.nodeType && 9 !== this.nodeType || Ft(this, e).appendChild(e);
                    });
                },
                prepend: function() {
                    return Vt(this, arguments, function(e) {
                        var t;
                        1 !== this.nodeType && 11 !== this.nodeType && 9 !== this.nodeType || (t = Ft(this, e)).insertBefore(e, t.firstChild);
                    });
                },
                before: function() {
                    return Vt(this, arguments, function(e) {
                ...
                empty: function() {
                    for (var e, t = 0; null != (e = this[t]); t++) 1 === e.nodeType && (C.cleanData(g(e, !1)), 
                    e.textContent = "");
                    return this;
                },
                clone: function(e, t) {
                ...
                html: function(e) {
                    return u(this, function(e) {
                        ...
                        if ("string" == typeof e && !Pt.test(e) && !m[(Dt.exec(e) || [ "", "" ])[1].toLowerCase()]) {
                            e = C.htmlPrefilter(e);
                            try {
                                for (;o < i; o++) 1 === (t = this[o] || {}).nodeType && (C.cleanData(g(t, !1)), 
                                t.innerHTML = e);
                                t = 0;
                            } catch (e) {}
                        }
                ...
                replaceWith: function() {
                    ...
                    return Vt(this, arguments, function(e) {
                        ...
                        C.inArray(this, o) < 0 && (C.cleanData(g(this)), t) && t.replaceChild(e, this);
                    }, o);
                }
            }), C.each({
                appendTo: "append",
                ...
                C.fn[e] = function(e) {
                    for (var t, o = [], i = C(e), n = i.length - 1, r = 0; r <= n; r++) t = r === n ? this : this.clone(!0), 
                    C(i[r])[s](t), j.apply(o, t.get());
            ...
            var qt, Ut, Xt, Yt, Kt, Jt, Qt, N, Zt = new RegExp("^(" + e + ")(?!px)[a-z%]+$", "i"), eo = /^--/, to = new RegExp(bt.join("|"), "i");
            function oo() {
                var e;
                N && (Qt.style.cssText = "position:absolute;left:-11111px;width:60px;margin-top:1px;padding:0;border:0", 
                ...
                vt.appendChild(Qt).appendChild(N), e = E.getComputedStyle(N), qt = "1%" !== e.top, 
                Jt = 12 === io(e.marginLeft), N.style.right = "60%", Yt = 36 === io(e.right), 
                Ut = 36 === io(e.width), N.style.position = "absolute", Xt = 12 === io(N.offsetWidth / 3), 
                vt.removeChild(Qt), N = null);
            }
            function io(e) {
                return Math.round(parseFloat(e));
            }
            function no(e, t, o) {
                var i, n = eo.test(t), r = e.style;
                return (o = o || $t(e)) && (i = o.getPropertyValue(t) || o[t], "" !== (i = n ? i && (i.replace(ee, "$1") || void 0) : i) || yt(e) || (i = C.style(e, t)), 
                !f.pixelBoxStyles()) && Zt.test(i) && to.test(t) && (n = r.width, 
                e = r.minWidth, t = r.maxWidth, r.minWidth = r.maxWidth = r.width = i, 
                i = o.width, r.width = n, r.minWidth = e, r.maxWidth = t), void 0 !== i ? i + "" : i;
            }
            function ro(e, t) {
                return {
                    get: function() {
            ...
            Qt = x.createElement("div"), (N = x.createElement("div")).style && (N.style.backgroundClip = "content-box", 
            N.cloneNode(!0).style.backgroundClip = "", f.clearCloneStyle = "content-box" === N.style.backgroundClip, 
            C.extend(f, {
                ...
                reliableTrDimensions: function() {
                    var e, t, o;
                    return null == Kt && (e = x.createElement("table"), t = x.createElement("tr"), 
                    o = x.createElement("div"), e.style.cssText = "position:absolute;left:-11111px;border-collapse:separate", 
                    t.style.cssText = "box-sizing:content-box;border:1px solid", 
                    t.style.height = "1px", o.style.height = "9px", o.style.display = "block", 
                    vt.appendChild(e).appendChild(t).appendChild(o), o = E.getComputedStyle(t), 
                    Kt = parseInt(o.height, 10) + parseInt(o.borderTopWidth, 10) + parseInt(o.borderBottomWidth, 10) === t.offsetHeight, 
                    vt.removeChild(e)), Kt;
                }
            }));
            var so = [ "Webkit", "Moz", "ms" ], ao = x.createElement("div").style, lo = {};
            function co(e) {
                var t = C.cssProps[e] || lo[e];
                return t || (e in ao ? e : lo[e] = function(e) {
                    for (var t = e[0].toUpperCase() + e.slice(1), o = so.length; o--; ) if ((e = so[o] + t) in ao) return e;
                }(e) || e);
            }
            var uo = /^(none|table(?!-c[ea]).+)/, ho = {
                position: "absolute",
                visibility: "hidden",
                display: "block"
            }, po = {
            ...
            function fo(e, t, o, i, n, r) {
                var s = "width" === t ? 1 : 0, a = 0, l = 0, c = 0;
                if (o === (i ? "border" : "content")) return 0;
                for (;s < 4; s += 2) "margin" === o && (c += C.css(e, o + bt[s], !0, n)), 
                i ? ("content" === o && (l -= C.css(e, "padding" + bt[s], !0, n)), 
                "margin" !== o && (l -= C.css(e, "border" + bt[s] + "Width", !0, n))) : (l += C.css(e, "padding" + bt[s], !0, n), 
                "padding" !== o ? l += C.css(e, "border" + bt[s] + "Width", !0, n) : a += C.css(e, "border" + bt[s] + "Width", !0, n));
                return !i && 0 <= r && (l += Math.max(0, Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - r - l - a - .5)) || 0), 
                l + c;
            }
            function go(e, t, o) {
                var i = $t(e), n = (!f.boxSizingReliable() || o) && "border-box" === C.css(e, "boxSizing", !1, i), r = n, s = no(e, t, i), a = "offset" + t[0].toUpperCase() + t.slice(1);
                if (Zt.test(s)) {
                    if (!o) return s;
                    s = "auto";
                }
                return (!f.boxSizingReliable() && n || !f.reliableTrDimensions() && w(e, "tr") || "auto" === s || !parseFloat(s) && "inline" === C.css(e, "display", !1, i)) && e.getClientRects().length && (n = "border-box" === C.css(e, "boxSizing", !1, i), 
                r = a in e) && (s = e[a]), (s = parseFloat(s) || 0) + fo(e, t, o || (n ? "border" : "content"), r, i, s) + "px";
            }
            function H(e, t, o, i, n) {
                return new H.prototype.init(e, t, o, i, n);
            }
            C.extend({
                cssHooks: {
                    opacity: {
                        get: function(e, t) {
                            if (t) return "" === (t = no(e, "opacity")) ? "1" : t;
                        }
                    }
                },
                cssNumber: {
                ...
                style: function(e, t, o, i) {
                    if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                        var n, r, s, a = A(t), l = eo.test(t), c = e.style;
                        if (l || (t = co(a)), s = C.cssHooks[t] || C.cssHooks[a], 
                        void 0 === o) return s && "get" in s && void 0 !== (n = s.get(e, !1, i)) ? n : c[t];
                        "string" === (r = typeof o) && (n = gt.exec(o)) && n[1] && (o = Et(e, t, n), 
                        r = "number"), null == o || o != o || ("number" !== r || l || (o += n && n[3] || (C.cssNumber[a] ? "" : "px")), 
                        f.clearCloneStyle || "" !== o || 0 !== t.indexOf("background") || (c[t] = "inherit"), 
                        s && "set" in s && void 0 === (o = s.set(e, o, i))) || (l ? c.setProperty(t, o) : c[t] = o);
                    }
                },
                css: function(e, t, o, i) {
                    var n, r = A(t);
                    return eo.test(t) || (t = co(r)), "normal" === (n = void 0 === (n = (r = C.cssHooks[t] || C.cssHooks[r]) && "get" in r ? r.get(e, !0, o) : n) ? no(e, t, i) : n) && t in po && (n = po[t]), 
                    ("" === o || o) && (r = parseFloat(n), !0 === o || isFinite(r)) ? r || 0 : n;
                }
            }), C.each([ "height", "width" ], function(e, s) {
                C.cssHooks[s] = {
                    get: function(e, t, o) {
                        if (t) return !uo.test(C.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? go(e, s, o) : Gt(e, ho, function() {
                            return go(e, s, o);
                        });
                    },
                    set: function(e, t, o) {
                        var i = $t(e), n = !f.scrollboxSize() && "absolute" === i.position, r = (n || o) && "border-box" === C.css(e, "boxSizing", !1, i), o = o ? fo(e, s, o, r, i) : 0;
                        return r && n && (o -= Math.ceil(e["offset" + s[0].toUpperCase() + s.slice(1)] - parseFloat(i[s]) - fo(e, s, "border", !1, i) - .5)), 
                        o && (r = gt.exec(t)) && "px" !== (r[3] || "px") && (e.style[s] = t, 
                        t = C.css(e, s)), mo(0, t, o);
                    }
                };
            }), C.cssHooks.marginLeft = ro(f.reliableMarginLeft, function(e, t) {
                if (t) return (parseFloat(no(e, "marginLeft")) || e.getBoundingClientRect().left - Gt(e, {
                    marginLeft: 0
                }, function() {
                ...
                C.cssHooks[n + r] = {
                    expand: function(e) {
                        for (var t = 0, o = {}, i = "string" == typeof e ? e.split(" ") : [ e ]; t < 4; t++) o[n + bt[t] + r] = i[t] || i[t - 2] || i[0];
                        return o;
                    }
                }, "margin" !== n && (C.cssHooks[n + r].set = mo);
            }), C.fn.extend({
                css: function(e, t) {
                    return u(this, function(e, t, o) {
                        var i, n, r = {}, s = 0;
                        if (Array.isArray(t)) {
                            for (i = $t(e), n = t.length; s < n; s++) r[t[s]] = C.css(e, t[s], !1, i);
                            return r;
                        }
                        return void 0 !== o ? C.style(e, t, o) : C.css(e, t);
                    }, e, t, 1 < arguments.length);
                }
            }), ((C.Tween = H).prototype = {
                constructor: H,
                init: function(e, t, o, i, n, r) {
                    this.elem = e, this.prop = o, this.easing = n || C.easing._default, 
                    this.options = t, this.start = this.now = this.cur(), this.end = i, 
                    this.unit = r || (C.cssNumber[o] ? "" : "px");
                },
                cur: function() {
                ...
                run: function(e) {
                    var t, o = H.propHooks[this.prop];
                    return this.options.duration ? this.pos = t = C.easing[this.easing](e, this.options.duration * e, 0, 1, this.options.duration) : this.pos = t = e, 
                    this.now = (this.end - this.start) * t + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), 
                    (o && o.set ? o : H.propHooks._default).set(this), this;
                }
                ...
                _default: {
                    ...
                    set: function(e) {
                        C.fx.step[e.prop] ? C.fx.step[e.prop](e) : 1 !== e.elem.nodeType || !C.cssHooks[e.prop] && null == e.elem.style[co(e.prop)] ? e.elem[e.prop] = e.now : C.style(e.elem, e.prop, e.now + e.unit);
                    }
                }
            ...
            var bo, vo, yo = /^(?:toggle|show|hide)$/, wo = /queueHooks$/;
            function Eo() {
                vo && (!1 === x.hidden && E.requestAnimationFrame ? E.requestAnimationFrame(Eo) : E.setTimeout(Eo, C.fx.interval), 
                C.fx.tick());
            }
            function xo() {
            ...
            function Co(e, t) {
                ...
                for (t = t ? 1 : 0; i < 4; i += 2 - t) n["margin" + (o = bt[i])] = n["padding" + o] = e;
                return t && (n.opacity = n.width = e), n;
            }
            function Ro(e, t, o) {
                for (var i, n = (P.tweeners[t] || []).concat(P.tweeners["*"]), r = 0, s = n.length; r < s; r++) if (i = n[r].call(o, t, e)) return i;
            }
            function P(n, e, t) {
                var o, r, i, s, a, l, c, u = 0, d = P.prefilters.length, h = C.Deferred().always(function() {
                    delete p.elem;
                }), p = function() {
                    if (!r) {
                        for (var e = bo || xo(), e = Math.max(0, m.startTime + m.duration - e), t = 1 - (e / m.duration || 0), o = 0, i = m.tweens.length; o < i; o++) m.tweens[o].run(t);
                        if (h.notifyWith(n, [ m, t, e ]), t < 1 && i) return e;
                        i || h.notifyWith(n, [ m, 1, 0 ]), h.resolveWith(n, [ m ]);
                    }
                    return !1;
                }, m = h.promise({
                    elem: n,
                    ...
                    createTween: function(e, t) {
                        t = C.Tween(n, m.opts, e, t, m.opts.specialEasing[e] || m.opts.easing);
                        return m.tweens.push(t), t;
                    },
                    stop: function(e) {
                        var t = 0, o = e ? m.tweens.length : 0;
                        if (!r) {
                            for (r = !0; t < o; t++) m.tweens[t].run(1);
                            e ? (h.notifyWith(n, [ m, 1, 0 ]), h.resolveWith(n, [ m, e ])) : h.rejectWith(n, [ m, e ]);
                        }
                        return this;
                    }
                }), f = m.props, g = f, b = m.opts.specialEasing;
                for (i in g) if (a = b[s = A(i)], l = g[i], Array.isArray(l) && (a = l[1], 
                l = g[i] = l[0]), i !== s && (g[s] = l, delete g[i]), (c = C.cssHooks[s]) && "expand" in c) for (i in l = c.expand(l), 
                delete g[s], l) i in g || (g[i] = l[i], b[i] = a); else b[s] = a;
                for (;u < d; u++) if (o = P.prefilters[u].call(m, n, f, m.opts)) return v(o.stop) && (C._queueHooks(m.elem, m.opts.queue).stop = o.stop.bind(o)), 
                o;
                return C.map(f, Ro, m), v(m.opts.start) && m.opts.start.call(n, m), 
            ...
            C.Animation = C.extend(P, {
                tweeners: {
                    "*": [ function(e, t) {
                        ...
                        return Et(o.elem, e, gt.exec(t), o), o;
                    } ]
                },
                tweener: function(e, t) {
                    for (var o, i = 0, n = (e = v(e) ? (t = e, [ "*" ]) : e.match(_)).length; i < n; i++) o = e[i], 
                    P.tweeners[o] = P.tweeners[o] || [], P.tweeners[o].unshift(t);
                },
                prefilters: [ function(e, t, o) {
                    var i, n, r, s, a, l, c, u = "width" in t || "height" in t, d = this, h = {}, p = e.style, m = e.nodeType && ft(e), f = b.get(e, "fxshow");
                    for (i in o.queue || (null == (s = C._queueHooks(e, "fx")).unqueued && (s.unqueued = 0, 
                    ...
                    if ((l = !C.isEmptyObject(t)) || !C.isEmptyObject(h)) for (i in u && 1 === e.nodeType && (o.overflow = [ p.overflow, p.overflowX, p.overflowY ], 
                    null == (c = f && f.display) && (c = b.get(e, "display")), "none" === (u = C.css(e, "display")) && (c ? u = c : (Ct([ e ], !0), 
                    c = e.style.display || c, u = C.css(e, "display"), Ct([ e ]))), 
                    "inline" === u || "inline-block" === u && null != c) && "none" === C.css(e, "float") && (l || (d.done(function() {
                        p.display = c;
                    }), null == c && (u = p.display, c = "none" === u ? "" : u)), 
                    p.display = "inline-block"), o.overflow && (p.overflow = "hidden", 
                    d.always(function() {
                        p.overflow = o.overflow[0], p.overflowX = o.overflow[1], 
                        p.overflowY = o.overflow[2];
                    })), l = !1, h) l || (f ? "hidden" in f && (m = f.hidden) : f = b.access(e, "fxshow", {
                        display: c
                    }), r && (f.hidden = !m), m && Ct([ e ], !0), d.done(function() {
                        for (i in m || Ct([ e ]), b.remove(e, "fxshow"), h) C.style(e, i, h[i]);
                    })), l = Ro(m ? f[i] : 0, i, d), i in f || (f[i] = l.start, 
                    m && (l.end = l.start, l.start = 0));
                } ],
                prefilter: function(e, t) {
                    t ? P.prefilters.unshift(e) : P.prefilters.push(e);
                }
            }), C.speed = function(e, t, o) {
                ...
                animate: function(t, e, o, i) {
                    ...
                    var r = C.isEmptyObject(t), s = C.speed(e, o, i);
                    return n.finish = n, r || !1 === s.queue ? this.each(n) : this.queue(s.queue, n);
                },
                stop: function(n, e, r) {
                    function s(e) {
                        var t = e.stop;
                    ...
                    this.each(function() {
                        var e = !0, t = null != n && n + "queueHooks", o = C.timers, i = b.get(this);
                        if (t) i[t] && i[t].stop && s(i[t]); else for (t in i) i[t] && i[t].stop && wo.test(t) && s(i[t]);
                        for (t = o.length; t--; ) o[t].elem !== this || null != n && o[t].queue !== n || (o[t].anim.stop(r), 
                        e = !1, o.splice(t, 1));
                        !e && r || C.dequeue(this, n);
                    });
                },
                finish: function(s) {
                    return !1 !== s && (s = s || "fx"), this.each(function() {
                        var e, t = b.get(this), o = t[s + "queue"], i = t[s + "queueHooks"], n = C.timers, r = o ? o.length : 0;
                ...
                var n = C.fn[i];
                C.fn[i] = function(e, t, o) {
                    return null == e || "boolean" == typeof e ? n.apply(this, arguments) : this.animate(Co(i, !0), e, t, o);
                };
            }), C.each({
                slideDown: Co("show"),
                slideUp: Co("hide"),
                ...
                C.fn[e] = function(e, t, o) {
                    return this.animate(i, e, t, o);
                };
            }), C.timers = [], C.fx.tick = function() {
                var e, t = 0, o = C.timers;
                for (bo = Date.now(); t < o.length; t++) (e = o[t])() || o[t] !== e || o.splice(t--, 1);
                o.length || C.fx.stop(), bo = void 0;
                ...
                return i = C.fx && C.fx.speeds[i] || i, this.queue(e = e || "fx", function(e, t) {
                    var o = E.setTimeout(e, i);
                    t.stop = function() {
                        E.clearTimeout(o);
                    };
                });
            }, s = x.createElement("input"), r = x.createElement("select").appendChild(x.createElement("option")), 
            s.type = "checkbox", f.checkOn = "" !== s.value, f.optSelected = r.selected, 
            (s = x.createElement("input")).value = "t", s.type = "radio", f.radioValue = "t" === s.value;
            var Do, Mo = C.expr.attrHandle, To = (C.fn.extend({
                attr: function(e, t) {
                ...
                attr: function(e, t, o) {
                    ...
                    if (3 !== r && 8 !== r && 2 !== r) return void 0 === e.getAttribute ? C.prop(e, t, o) : (1 === r && C.isXMLDoc(e) || (n = C.attrHooks[t.toLowerCase()] || (C.expr.match.bool.test(t) ? Do : void 0)), 
                    void 0 !== o ? null === o ? void C.removeAttr(e, t) : n && "set" in n && void 0 !== (i = n.set(e, o, t)) ? i : (e.setAttribute(t, o + ""), 
                    o) : !(n && "get" in n && null !== (i = n.get(e, t))) && null == (i = C.find.attr(e, t)) ? void 0 : i);
                },
                attrHooks: {
                    type: {
                        set: function(e, t) {
                            var o;
                            if (!f.radioValue && "radio" === t && w(e, "input")) return o = e.value, 
                            e.setAttribute("type", t), o && (e.value = o), t;
                        }
                    }
                },
                removeAttr: function(e, t) {
                    var o, i = 0, n = t && t.match(_);
                    if (n && 1 === e.nodeType) for (;o = n[i++]; ) e.removeAttribute(o);
                }
            }), Do = {
                set: function(e, t, o) {
                    return !1 === t ? C.removeAttr(e, o) : e.setAttribute(o, o), 
                    o;
                }
            }, C.each(C.expr.match.bool.source.match(/\w+/g), function(e, t) {
                var s = Mo[t] || C.find.attr;
                Mo[t] = function(e, t, o) {
                    var i, n, r = t.toLowerCase();
                    return o || (n = Mo[r], Mo[r] = i, i = null != s(e, t, o) ? r : null, 
                    Mo[r] = n), i;
                };
            }), /^(?:input|select|textarea|button)$/i), So = /^(?:a|area)$/i;
            function Lo(e) {
            ...
            C.fn.extend({
                ...
                prop: function(e, t, o) {
                    ...
                    n = C.propHooks[t]), void 0 !== o ? n && "set" in n && void 0 !== (i = n.set(e, o, t)) ? i : e[t] = o : n && "get" in n && null !== (i = n.get(e, t)) ? i : e[t];
                },
                propHooks: {
                    tabIndex: {
                        get: function(e) {
                            var t = C.find.attr(e, "tabindex");
                            return t ? parseInt(t, 10) : To.test(e.nodeName) || So.test(e.nodeName) && e.href ? 0 : -1;
                        }
                    }
                },
                propFix: {
                ...
                addClass: function(t) {
                    ...
                    return v(t) ? this.each(function(e) {
                        C(this).addClass(t.call(this, e, ko(this)));
                    }) : (e = _o(t)).length ? this.each(function() {
                        if (i = ko(this), o = 1 === this.nodeType && " " + Lo(i) + " ") {
                            for (r = 0; r < e.length; r++) n = e[r], o.indexOf(" " + n + " ") < 0 && (o += n + " ");
                            s = Lo(o), i !== s && this.setAttribute("class", s);
                        }
                    }) : this;
                },
                removeClass: function(t) {
                    var e, o, i, n, r, s;
                    return v(t) ? this.each(function(e) {
                        C(this).removeClass(t.call(this, e, ko(this)));
                    }) : arguments.length ? (e = _o(t)).length ? this.each(function() {
                        if (i = ko(this), o = 1 === this.nodeType && " " + Lo(i) + " ") {
                            for (r = 0; r < e.length; r++) for (n = e[r]; -1 < o.indexOf(" " + n + " "); ) o = o.replace(" " + n + " ", " ");
                            s = Lo(o), i !== s && this.setAttribute("class", s);
                        }
                    }) : this : this.attr("class", "");
                },
                toggleClass: function(t, o) {
                    var e, i, n, r, s = typeof t, a = "string" == s || Array.isArray(t);
                    return v(t) ? this.each(function(e) {
                        C(this).toggleClass(t.call(this, e, ko(this), o), o);
                    }) : "boolean" == typeof o && a ? o ? this.addClass(t) : this.removeClass(t) : (e = _o(t), 
                    this.each(function() {
                        if (a) for (r = C(this), n = 0; n < e.length; n++) i = e[n], 
                        r.hasClass(i) ? r.removeClass(i) : r.addClass(i); else void 0 !== t && "boolean" != s || ((i = ko(this)) && b.set(this, "__className__", i), 
                        this.setAttribute && this.setAttribute("class", !i && !1 !== t && b.get(this, "__className__") || ""));
                    }));
                },
                hasClass: function(e) {
                    for (var t, o = 0, i = " " + e + " "; t = this[o++]; ) if (1 === t.nodeType && -1 < (" " + Lo(ko(t)) + " ").indexOf(i)) return !0;
                    return !1;
                }
            });
            function Ao(e) {
            ...
            var No = /\r/g, Ho = (C.fn.extend({
                val: function(t) {
                    ...
                    return arguments.length ? (i = v(t), this.each(function(e) {
                        1 !== this.nodeType || (null == (e = i ? t.call(this, e, C(this).val()) : t) ? e = "" : "number" == typeof e ? e += "" : Array.isArray(e) && (e = C.map(e, function(e) {
                            return null == e ? "" : e + "";
                        })), (o = C.valHooks[this.type] || C.valHooks[this.nodeName.toLowerCase()]) && "set" in o && void 0 !== o.set(this, e, "value")) || (this.value = e);
                    })) : n ? (o = C.valHooks[n.type] || C.valHooks[n.nodeName.toLowerCase()]) && "get" in o && void 0 !== (e = o.get(n, "value")) ? e : "string" == typeof (e = n.value) ? e.replace(No, "") : null == e ? "" : e : void 0;
                }
            }), C.extend({
                valHooks: {
                    option: {
                        get: function(e) {
                            ...
                            return null != t ? t : Lo(C.text(e));
                        }
                    },
                    select: {
                        get: function(e) {
                            for (var t, o = e.options, i = e.selectedIndex, n = "select-one" === e.type, r = n ? null : [], s = n ? i + 1 : o.length, a = i < 0 ? s : n ? i : 0; a < s; a++) if (((t = o[a]).selected || a === i) && !t.disabled && (!t.parentNode.disabled || !w(t.parentNode, "optgroup"))) {
                                if (t = C(t).val(), n) return t;
                                r.push(t);
                            }
                            return r;
                        },
                        set: function(e, t) {
                            for (var o, i, n = e.options, r = C.makeArray(t), s = n.length; s--; ) ((i = n[s]).selected = -1 < C.inArray(C.valHooks.option.get(i), r)) && (o = !0);
                ...
                guid: Date.now()
            }, zo = /\?/, Oo = (C.parseXML = function(e) {
                var t, o;
                if (!e || "string" != typeof e) return null;
                try {
                    t = new E.DOMParser().parseFromString(e, "text/xml");
                } catch (e) {}
                return o = t && t.getElementsByTagName("parsererror")[0], t && !o || C.error("Invalid XML: " + (o ? C.map(o.childNodes, function(e) {
                    return e.textContent;
                }).join("\n") : e)), t;
            }, /^(?:focusinfocus|focusoutblur)$/), Fo = (C.extend(C.event, {
                trigger: function(e, t, o, i) {
                    var n, r, s, a, l, c, u, d = [ o || x ], h = W.call(e, "type") ? e.type : e, p = W.call(e, "namespace") ? e.namespace.split(".") : [], m = u = r = o = o || x;
                    if (3 !== o.nodeType && 8 !== o.nodeType && !Oo.test(h + C.event.triggered) && (-1 < h.indexOf(".") && (h = (p = h.split(".")).shift(), 
                    p.sort()), a = h.indexOf(":") < 0 && "on" + h, (e = e[C.expando] ? e : new C.Event(h, "object" == typeof e && e)).isTrigger = i ? 2 : 3, 
                    e.namespace = p.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, 
                    e.result = void 0, e.target || (e.target = o), t = null == t ? [ e ] : C.makeArray(t, [ e ]), 
                    c = C.event.special[h] || {}, i || !c.trigger || !1 !== c.trigger.apply(o, t))) {
                        if (!i && !c.noBubble && !O(o)) {
                            for (s = c.delegateType || h, Oo.test(s + h) || (m = m.parentNode); m; m = m.parentNode) d.push(m), 
                            r = m;
                            r === (o.ownerDocument || x) && d.push(r.defaultView || r.parentWindow || E);
                        }
                        for (n = 0; (m = d[n++]) && !e.isPropagationStopped(); ) u = m, 
                        e.type = 1 < n ? s : c.bindType || h, (l = (b.get(m, "events") || Object.create(null))[e.type] && b.get(m, "handle")) && l.apply(m, t), 
                        (l = a && m[a]) && l.apply && ut(m) && (e.result = l.apply(m, t), 
                        !1 === e.result) && e.preventDefault();
                        return e.type = h, i || e.isDefaultPrevented() || c._default && !1 !== c._default.apply(d.pop(), t) || !ut(o) || a && v(o[h]) && !O(o) && ((r = o[a]) && (o[a] = null), 
                        C.event.triggered = h, e.isPropagationStopped() && u.addEventListener(h, Ao), 
                        o[h](), e.isPropagationStopped() && u.removeEventListener(h, Ao), 
                        C.event.triggered = void 0, r) && (o[a] = r), e.result;
                    }
                },
                simulate: function(e, t, o) {
                    o = C.extend(new C.Event(), o, {
                        type: e,
                        isSimulated: !0
                    });
                ...
                triggerHandler: function(e, t) {
                    var o = this[0];
                    if (o) return C.event.trigger(e, t, o, !0);
                }
            }), /\[\]$/), Io = /\r?\n/g, jo = /^(?:submit|button|image|reset|file)$/i, Bo = /^(?:input|select|textarea|keygen)/i;
            C.param = function(e, t) {
                function o(e, t) {
                    t = v(t) ? t() : t, n[n.length] = encodeURIComponent(e) + "=" + encodeURIComponent(null == t ? "" : t);
                }
                var i, n = [];
                if (null == e) return "";
                if (Array.isArray(e) || e.jquery && !C.isPlainObject(e)) C.each(e, function() {
                    ...
                    if (Array.isArray(e)) C.each(e, function(e, t) {
                        n || Fo.test(i) ? r(i, t) : o(i + "[" + ("object" == typeof t && null != t ? e : "") + "]", t, n, r);
                    }); else if (n || "object" !== X(e)) r(i, e); else for (var t in e) o(i + "[" + t + "]", e[t], n, r);
                }(i, e[i], t, o);
                return n.join("&");
            }, C.fn.extend({
                serialize: function() {
                ...
                serializeArray: function() {
                    return this.map(function() {
                        ...
                        var e = this.type;
                        return this.name && !C(this).is(":disabled") && Bo.test(this.nodeName) && !jo.test(e) && (this.checked || !Rt.test(e));
                    }).map(function(e, t) {
                        var o = C(this).val();
                        return null == o ? null : Array.isArray(o) ? C.map(o, function(e) {
                            return {
                                name: t.name,
                                value: e.replace(Io, "\r\n")
                            };
            ...
            var Vo = /%20/g, Wo = /#.*$/, $o = /([?&])_=[^&]*/, Go = /^(.*?):[ \t]*([^\r\n]*)$/gm, qo = /^(?:GET|HEAD)$/, Uo = /^\/\//, Xo = {}, Yo = {}, Ko = "*/".concat("*"), Jo = x.createElement("a");
            function Qo(r) {
                return function(e, t) {
                    "string" != typeof e && (t = e, e = "*");
                    var o, i = 0, n = e.toLowerCase().match(_) || [];
                    if (v(t)) for (;o = n[i++]; ) "+" === o[0] ? (o = o.slice(1) || "*", 
                    (r[o] = r[o] || []).unshift(t)) : (r[o] = r[o] || []).push(t);
                };
            }
            function Zo(t, i, n, r) {
                var s = {}, a = t === Yo;
            ...
            Jo.href = Ho.href, C.extend({
                ...
                ajaxSettings: {
                    url: Ho.href,
                    type: "GET",
                    isLocal: /^(?:about|app|app-storage|.+-extension|file|res|widget):$/.test(Ho.protocol),
                    global: !0,
                    processData: !0,
                    async: !0,
                ...
                ajaxSetup: function(e, t) {
                    return t ? ei(ei(e, C.ajaxSettings), t) : ei(C.ajaxSettings, e);
                },
                ajaxPrefilter: Qo(Xo),
                ajaxTransport: Qo(Yo),
                ajax: function(e, t) {
                    "object" == typeof e && (t = e, e = void 0);
                    var l, c, u, o, d, h, p, i, m = C.ajaxSetup({}, t = t || {}), f = m.context || m, g = m.context && (f.nodeType || f.jquery) ? C(f) : C.event, b = C.Deferred(), v = C.Callbacks("once memory"), y = m.statusCode || {}, n = {}, r = {}, s = "canceled", w = {
                        readyState: 0,
                        getResponseHeader: function(e) {
                            var t;
                            if (h) {
                                if (!o) for (o = {}; t = Go.exec(u); ) o[t[1].toLowerCase() + " "] = (o[t[1].toLowerCase() + " "] || []).concat(t[2]);
                                t = o[e.toLowerCase() + " "];
                            }
                        ...
                        setRequestHeader: function(e, t) {
                            return null == h && (e = r[e.toLowerCase()] = r[e.toLowerCase()] || e, 
                            n[e] = t), this;
                        },
                    ...
                    if (b.promise(w), m.url = ((e || m.url || Ho.href) + "").replace(Uo, Ho.protocol + "//"), 
                    m.type = t.method || t.type || m.method || m.type, m.dataTypes = (m.dataType || "*").toLowerCase().match(_) || [ "" ], 
                    null == m.crossDomain) {
                        e = x.createElement("a");
                        try {
                            e.href = m.url, e.href = e.href, m.crossDomain = Jo.protocol + "//" + Jo.host != e.protocol + "//" + e.host;
                        } catch (e) {
                            m.crossDomain = !0;
                        }
                    }
                    ...
                    Zo(Xo, m, t, w), !h) {
                        for (i in (p = C.event && m.global) && 0 == C.active++ && C.event.trigger("ajaxStart"), 
                        m.type = m.type.toUpperCase(), m.hasContent = !qo.test(m.type), 
                        c = m.url.replace(Wo, ""), m.hasContent ? m.data && m.processData && 0 === (m.contentType || "").indexOf("application/x-www-form-urlencoded") && (m.data = m.data.replace(Vo, "+")) : (e = m.url.slice(c.length), 
                        m.data && (m.processData || "string" == typeof m.data) && (c += (zo.test(c) ? "&" : "?") + m.data, 
                        delete m.data), !1 === m.cache && (c = c.replace($o, "$1"), 
                        e = (zo.test(c) ? "&" : "?") + "_=" + Po.guid++ + e), m.url = c + e), 
                        m.ifModified && (C.lastModified[c] && w.setRequestHeader("If-Modified-Since", C.lastModified[c]), 
                        C.etag[c]) && w.setRequestHeader("If-None-Match", C.etag[c]), 
                        (m.data && m.hasContent && !1 !== m.contentType || t.contentType) && w.setRequestHeader("Content-Type", m.contentType), 
                        w.setRequestHeader("Accept", m.dataTypes[0] && m.accepts[m.dataTypes[0]] ? m.accepts[m.dataTypes[0]] + ("*" !== m.dataTypes[0] ? ", " + Ko + "; q=0.01" : "") : m.accepts["*"]), 
                        m.headers) w.setRequestHeader(i, m.headers[i]);
                        if (m.beforeSend && (!1 === m.beforeSend.call(f, w, m) || h)) return w.abort();
                        if (s = "abort", v.add(m.complete), w.done(m.success), w.fail(m.error), 
                        l = Zo(Yo, m, t, w)) {
                            if (w.readyState = 1, p && g.trigger("ajaxSend", [ w, m ]), 
                            h) return w;
                    ...
                    function a(e, t, o, i) {
                        var n, r, s, a = t;
                        h || (h = !0, d && E.clearTimeout(d), l = void 0, u = i || "", 
                        w.readyState = 0 < e ? 4 : 0, i = 200 <= e && e < 300 || 304 === e, 
                        o && (s = function(e, t, o) {
                        ...
                        }(m, w, o)), !i && -1 < C.inArray("script", m.dataTypes) && C.inArray("json", m.dataTypes) < 0 && (m.converters["text script"] = function() {}), 
                        s = function(e, t, o, i) {
                            ...
                            l = r, r = u.shift()) if ("*" === r) r = l; else if ("*" !== l && l !== r) {
                                if (!(s = c[l + " " + r] || c["* " + r])) for (n in c) if ((a = n.split(" "))[1] === r && (s = c[l + " " + a[0]] || c["* " + a[0]])) {
                                    !0 === s ? s = c[n] : !0 !== c[n] && (r = a[0], 
                                    u.unshift(a[1]));
                                    break;
                                }
                        ...
                        }(m, s, w, i), i ? (m.ifModified && ((o = w.getResponseHeader("Last-Modified")) && (C.lastModified[c] = o), 
                        o = w.getResponseHeader("etag")) && (C.etag[c] = o), 204 === e || "HEAD" === m.type ? a = "nocontent" : 304 === e ? a = "notmodified" : (a = s.state, 
                        n = s.data, i = !(r = s.error))) : (r = a, !e && a || (a = "error", 
                        e < 0 && (e = 0))), w.status = e, w.statusText = (t || a) + "", 
                        i ? b.resolveWith(f, [ n, a, w ]) : b.rejectWith(f, [ w, a, r ]), 
                        w.statusCode(y), y = void 0, p && g.trigger(i ? "ajaxSuccess" : "ajaxError", [ w, m, i ? n : r ]), 
                        v.fireWith(f, [ w, a ]), p && (g.trigger("ajaxComplete", [ w, m ]), 
                        --C.active || C.event.trigger("ajaxStop")));
                    }
                },
                getJSON: function(e, t, o) {
                    return C.get(e, t, o, "json");
                },
                getScript: function(e, t) {
                    return C.get(e, void 0, t, "script");
                }
            }), C.each([ "get", "post" ], function(e, n) {
                C[n] = function(e, t, o, i) {
                    return v(t) && (i = i || o, o = t, t = void 0), C.ajax(C.extend({
                        url: e,
                        type: n,
                        dataType: i,
                        data: t,
                ...
                wrapInner: function(o) {
                    return v(o) ? this.each(function(e) {
                        C(this).wrapInner(o.call(this, e));
                    }) : this.each(function() {
                ...
                wrap: function(t) {
                    ...
                    return this.each(function(e) {
                        C(this).wrapAll(o ? t.call(this, e) : t);
                    });
                },
                unwrap: function(e) {
            ...
            var ti = {
                0: 200,
                1223: 204
            }, oi = C.ajaxSettings.xhr(), ii = (f.cors = !!oi && "withCredentials" in oi, 
            f.ajax = oi = !!oi, C.ajaxTransport(function(n) {
                var r, s;
                if (f.cors || oi && !n.crossDomain) return {
                    send: function(e, t) {
                        var o, i = n.xhr();
                        if (i.open(n.type, n.url, n.async, n.username, n.password), 
                        n.xhrFields) for (o in n.xhrFields) i[o] = n.xhrFields[o];
                        for (o in n.mimeType && i.overrideMimeType && i.overrideMimeType(n.mimeType), 
                        ...
                        r = function(e) {
                            return function() {
                                ...
                                "abort" === e ? i.abort() : "error" === e ? "number" != typeof i.status ? t(0, "error") : t(i.status, i.statusText) : t(ti[i.status] || i.status, i.statusText, "text" !== (i.responseType || "text") || "string" != typeof i.responseText ? {
                                    binary: i.response
                                } : {
                                    text: i.responseText
                ...
                if (o.crossDomain || o.scriptAttrs) return {
                    send: function(e, t) {
                        i = C("<script>").attr(o.scriptAttrs || {}).prop({
                ...
                jsonpCallback: function() {
                    var e = ii.pop() || C.expando + "_" + Po.guid++;
                    return this[e] = !0, e;
                }
            }), C.ajaxPrefilter("json jsonp", function(e, t, o) {
                var i, n, r, s = !1 !== e.jsonp && (ni.test(e.url) ? "url" : "string" == typeof e.data && 0 === (e.contentType || "").indexOf("application/x-www-form-urlencoded") && ni.test(e.data) && "data");
                if (s || "jsonp" === e.dataTypes[0]) return i = e.jsonpCallback = v(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, 
                s ? e[s] = e[s].replace(ni, "$1" + i) : !1 !== e.jsonp && (e.url += (zo.test(e.url) ? "&" : "?") + e.jsonp + "=" + i), 
                e.converters["script json"] = function() {
                    return r || C.error(i + " was not called"), r[0];
                }, e.dataTypes[0] = "json", n = E[i], E[i] = function() {
                    r = arguments;
                }, o.always(function() {
                    void 0 === n ? C(E).removeProp(i) : E[i] = n, e[i] && (e.jsonpCallback = t.jsonpCallback, 
                    ii.push(i)), r && v(n) && n(r[0]), r = n = void 0;
                }), "script";
            }), f.createHTMLDocument = ((e = x.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 
            2 === e.childNodes.length), C.parseHTML = function(e, t, o) {
                var i;
                return "string" != typeof e ? [] : ("boolean" == typeof t && (o = t, 
                t = !1), t || (f.createHTMLDocument ? ((i = (t = x.implementation.createHTMLDocument("")).createElement("base")).href = x.location.href, 
                t.head.appendChild(i)) : t = x), i = !o && [], (o = Xe.exec(e)) ? [ t.createElement(o[1]) ] : (o = Lt([ e ], t, i), 
                i && i.length && C(i).remove(), C.merge([], o.childNodes)));
            }, C.fn.load = function(e, t, o) {
                var i, n, r, s = this, a = e.indexOf(" ");
                return -1 < a && (i = Lo(e.slice(a)), e = e.slice(0, a)), v(t) ? (o = t, 
                t = void 0) : t && "object" == typeof t && (n = "POST"), 0 < s.length && C.ajax({
                    url: e,
                    type: n || "GET",
                    dataType: "html",
                    data: t
                ...
                setOffset: function(e, t, o) {
                    var i, n, r, s, a = C.css(e, "position"), l = C(e), c = {};
                    "static" === a && (e.style.position = "relative"), r = l.offset(), 
                    i = C.css(e, "top"), s = C.css(e, "left"), a = ("absolute" === a || "fixed" === a) && -1 < (i + s).indexOf("auto") ? (n = (a = l.position()).top, 
                    a.left) : (n = parseFloat(i) || 0, parseFloat(s) || 0), null != (t = v(t) ? t.call(e, o, C.extend({}, r)) : t).top && (c.top = t.top - r.top + n), 
                ...
                offset: function(t) {
                    ...
                    }) : (o = this[0]) ? o.getClientRects().length ? (e = o.getBoundingClientRect(), 
                ...
                position: function() {
                    if (this[0]) {
                        ...
                        if ("fixed" === C.css(i, "position")) t = i.getBoundingClientRect(); else {
                            for (t = this.offset(), o = i.ownerDocument, e = i.offsetParent || o.documentElement; e && (e === o.body || e === o.documentElement) && "static" === C.css(e, "position"); ) e = e.parentNode;
                            e && e !== i && 1 === e.nodeType && ((n = C(e).offset()).top += C.css(e, "borderTopWidth", !0), 
                            n.left += C.css(e, "borderLeftWidth", !0));
                        }
                        return {
                ...
                C.fn[t] = function(e) {
                    return u(this, function(e, t, o) {
                        var i;
                        if (O(e) ? i = e : 9 === e.nodeType && (i = e.defaultView), 
                        void 0 === o) return i ? i[n] : e[t];
                        i ? i.scrollTo(r ? i.pageXOffset : o, r ? o : i.pageYOffset) : e[t] = o;
                    }, t, e, arguments.length);
                };
            }), C.each([ "top", "left" ], function(e, o) {
                C.cssHooks[o] = ro(f.pixelPosition, function(e, t) {
                    if (t) return t = no(e, o), Zt.test(t) ? C(e).position()[o] + "px" : t;
                });
            }), C.each({
                Height: "height",
                Width: "width"
                ...
                C.each({
                    ...
                    C.fn[r] = function(e, t) {
                        ...
                        return u(this, function(e, t, o) {
                            var i;
                            return O(e) ? 0 === r.indexOf("outer") ? e["inner" + s] : e.document.documentElement["client" + s] : 9 === e.nodeType ? (i = e.documentElement, 
                            Math.max(e.body["scroll" + s], i["scroll" + s], e.body["offset" + s], i["offset" + s], i["client" + s])) : void 0 === o ? C.css(e, t, n) : C.style(e, t, o, n);
                        }, a, o ? e : void 0, o);
                    };
                });
            ...
            }), C.each("blur focus focusin focusout resize scroll click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup contextmenu".split(" "), function(e, o) {
                C.fn[o] = function(e, t) {
                    return 0 < arguments.length ? this.on(o, null, e, t) : this.trigger(o);
                };
            }), /^[\s\uFEFF\xA0]+|([^\s\uFEFF\xA0])[\s\uFEFF\xA0]+$/g), si = (C.proxy = function(e, t) {
                var o, i;
                if ("string" == typeof t && (i = e[t], t = e, e = i), v(e)) return o = a.call(arguments, 2), 
                (i = function() {
                    return e.apply(t || this, o.concat(a.call(arguments)));
                }).guid = e.guid = e.guid || C.guid++, i;
            }, C.holdReady = function(e) {
                e ? C.readyWait++ : C.ready(!0);
            }, C.isArray = Array.isArray, C.parseJSON = JSON.parse, C.nodeName = w, 
            C.isFunction = v, C.isWindow = O, C.camelCase = A, C.type = X, C.now = Date.now, 
            ...
            return C.noConflict = function(e) {
                return E.$ === C && (E.$ = ai), e && E.jQuery === C && (E.jQuery = si), 
                C;
            }, void 0 === z && (E.jQuery = E.$ = C), C;
        }, "object" == typeof t && "object" == typeof t.exports ? t.exports = i.document ? n(i, !0) : function(e) {
    ...
    6: [ function(o, e, t) {
        ...
        i = function(t) {
            ...
            (e = t && t.fn && t.fn.select2 && t.fn.select2.amd ? t.fn.select2.amd : e) && e.requirejs || (e ? o = e : e = {}, 
            f = {}, g = {}, b = {}, v = {}, i = Object.prototype.hasOwnProperty, 
            n = [].slice, y = /\.js$/, p = function(e, t) {
                ...
                if ("undefined" == u || "function" == u) {
                    ...
                    a = 0; a < t.length; a += 1) if ("require" === (r = (s = p(t[a], d)).f)) c[a] = m.require(e); else if ("exports" === r) c[a] = m.exports(e), 
            ...
            }, a = o = s = function(e, t, o, i, n) {
                if ("string" == typeof e) return m[e] ? m[e](t) : x(p(e, C(t)).f);
                if (!e.splice) {
                    if ((b = e).deps && s(b.deps, b.callback), !t) return;
                    t.splice ? (e = t, t = o, o = null) : e = h;
                }
                return t = t || function() {}, "function" == typeof o && (o = i, 
                i = n), i ? r(h, e, t, o) : setTimeout(function() {
                    r(h, e, t, o);
                }, 4), s;
            }, s.config = function(e) {
                return s(e);
            }, a._defined = f, (u = function(e, t, o) {
                if ("string" != typeof e) throw new Error("See almond README: incorrect module build, no module name");
                t.splice || (o = t, t = []), w(f, e) || w(g, e) || (g[e] = [ e, t, o ]);
            }).amd = {
                jQuery: !0
            }, e.requirejs = a, e.require = o, e.define = u), e.define("almond", function() {}), 
            e.define("jquery", [], function() {
                ...
                i.Extend = function(e, t) {
                    ...
                    for (var a = 0; a < e.length; a++) {
                        ...
                        r.prototype[l] = function(e) {
                            var t = function() {}, o = (e in r.prototype && (t = r.prototype[e]), 
                            n.prototype[e]);
                            return function() {
                ...
                return d.Extend(i, d.Observable), i.prototype.render = function() {
                    ...
                    var t = this.options.get("escapeMarkup"), o = (this.clear(), 
                    this.hideLoading(), u('<li role="alert" aria-live="assertive" class="select2-results__option"></li>')), i = this.options.get("translations").get(e.message);
                    o.append(t(i(e.args))), o[0].className += " select2-results__message", 
                    ...
                    this.data.current(function(e) {
                        ...
                        t.$results.find(".select2-results__option[aria-selected]").each(function() {
                            var e = u(this), t = d.GetData(this, "data"), o = "" + t.id;
                            null != t.element && t.element.selected || null == t.element && -1 < u.inArray(o, i) ? e.attr("aria-selected", "true") : e.attr("aria-selected", "false");
                        });
                    });
                    ...
                    var t, o = document.createElement("li"), i = (o.className = "select2-results__option", 
                    {
                        role: "option",
                        "aria-selected": "false"
                    ...
                    for (t in (null != e.element && n.call(e.element, ":disabled") || null == e.element && e.disabled) && (delete i["aria-selected"], 
                    i["aria-disabled"] = "true"), null == e.id && delete i["aria-selected"], 
                    null != e._resultId && (o.id = e._resultId), e.title && (o.title = e.title), 
                    e.children && (i.role = "group", i["aria-label"] = e.text, delete i["aria-selected"]), 
                    i) o.setAttribute(t, i[t]);
                    if (e.children) {
                        for (var n = u(o), r = document.createElement("strong"), s = (r.className = "select2-results__group", 
                        u(r), this.template(e, r), []), a = 0; a < e.children.length; a++) {
                            var l = e.children[a], l = this.option(l);
                            s.push(l);
                        }
                        var c = u("<ul></ul>", {
                            class: "select2-results__options select2-results__options--nested"
                        });
                        c.append(s), n.append(r), n.append(c);
                    } else this.template(e, o);
                    return d.StoreData(o, "data", e), o;
                    ...
                    this.$results.attr("id", o), t.on("results:all", function(e) {
                        ...
                        0 !== t.length && (e = d.GetData(t[0], "data"), "true" == t.attr("aria-selected") ? n.trigger("close", {}) : n.trigger("select", {
                            data: e
                        }));
                    }), t.on("results:previous", function() {
                        var e, t = n.getHighlightedResults(), o = n.$results.find("[aria-selected]"), i = o.index(t);
                        i <= 0 || (i = i - 1, 0 === t.length && (i = 0), (t = o.eq(i)).trigger("mouseenter"), 
                        o = n.$results.offset().top, t = t.offset().top, e = n.$results.scrollTop() + (t - o), 
                        0 === i ? n.$results.scrollTop(0) : t - o < 0 && n.$results.scrollTop(e));
                    }), t.on("results:next", function() {
                        var e, t, o = n.getHighlightedResults(), i = n.$results.find("[aria-selected]"), o = i.index(o) + 1;
                        o >= i.length || ((i = i.eq(o)).trigger("mouseenter"), e = n.$results.offset().top + n.$results.outerHeight(!1), 
                        i = i.offset().top + i.outerHeight(!1), t = n.$results.scrollTop() + i - e, 
                        0 === o ? n.$results.scrollTop(0) : e < i && n.$results.scrollTop(t));
                        ...
                        var t = u(this), o = d.GetData(this, "data");
                        "true" === t.attr("aria-selected") ? n.options.get("multiple") ? n.trigger("unselect", {
                            originalEvent: e,
                            data: o
                    ...
                    0 !== n.length && (e = this.$results.find("[aria-selected]").index(n), 
                    t = this.$results.offset().top, i = n.offset().top, o = this.$results.scrollTop() + (i - t), 
                    i = i - t, o -= 2 * n.outerHeight(!1), e <= 2 ? this.$results.scrollTop(0) : (i > this.$results.outerHeight() || i < 0) && this.$results.scrollTop(o));
                }, i.prototype.template = function(e, t) {
                    var o = this.options.get("templateResult"), i = this.options.get("escapeMarkup"), o = o(e, t);
                    null == o ? t.style.display = "none" : "string" == typeof o ? t.innerHTML = i(o) : u(t).append(o);
                }, i;
            ...
            }), e.define("select2/selection/base", [ "jquery", "../utils", "../keys" ], function(o, i, n) {
                function r(e, t) {
                ...
                return i.Extend(r, i.Observable), r.prototype.render = function() {
                    ...
                    this.container = e, this.$selection.on("focus", function(e) {
                        ...
                        o.$selection.attr("aria-expanded", "true"), o.$selection.attr("aria-owns", i), 
                        o._attachCloseHandler(e);
                    }), e.on("close", function() {
                        o.$selection.attr("aria-expanded", "false"), o.$selection.removeAttr("aria-activedescendant"), 
                        o.$selection.removeAttr("aria-owns"), o.$selection.trigger("focus"), 
            ...
            }), e.define("select2/selection/single", [ "jquery", "./base", "../utils", "../keys" ], function(e, t, o, i) {
                function n() {
                ...
                return o.Extend(n, t), n.prototype.render = function() {
                    ...
                    var o = this, i = (n.__super__.bind.apply(this, arguments), 
                    t.id + "-container");
                    ...
                    var t, o;
                    0 === e.length ? this.clear() : (e = e[0], t = this.$selection.find(".select2-selection__rendered"), 
                    o = this.display(e, t), t.empty().append(o), (o = e.title || e.text) ? t.attr("title", o) : t.removeAttr("title"));
                }, n;
                ...
                return a.Extend(n, e), n.prototype.render = function() {
                    ...
                    n.__super__.bind.apply(this, arguments), this.$selection.on("click", function(e) {
                        ...
                        var t;
                        o.isDisabled() || (t = i(this).parent(), t = a.GetData(t[0], "data"), 
                        o.trigger("unselect", {
                            originalEvent: e,
                            data: t
                        }));
                    ...
                    if (this.clear(), 0 !== e.length) {
                        for (var t = [], o = 0; o < e.length; o++) {
                            var i = e[o], n = this.selectionContainer(), r = this.display(i, n), r = (n.append(r), 
                            i.title || i.text);
                            r && n.attr("title", r), a.StoreData(n[0], "data", i), 
                            t.push(n);
                        }
                ...
                function t(e, t, o) {
                    this.placeholder = this.normalizePlaceholder(o.get("placeholder")), 
                    e.call(this, t, o);
                }
                return t.prototype.normalizePlaceholder = function(e, t) {
                    ...
                    this.clear();
                    o = this.createPlaceholder(this.placeholder);
                ...
                return e.prototype.bind = function(e, t, o) {
                    ...
                    if (!this.isDisabled()) {
                        ...
                        if (0 !== o.length) {
                            t.stopPropagation();
                            var i = a.GetData(o[0], "data"), n = this.$element.val(), r = (this.$element.val(this.placeholder.id), 
                            {
                                data: i
                            });
            ...
            }), e.define("select2/selection/search", [ "jquery", "../utils", "../keys" ], function(o, s, a) {
                function e(e, t, o) {
                    e.call(this, t, o);
                }
                return e.prototype.render = function(e) {
                    var t = o('<li class="select2-search select2-search--inline"><input class="select2-search__field" type="search" tabindex="-1" autocomplete="off" autocorrect="off" autocapitalize="none" spellcheck="false" role="searchbox" aria-autocomplete="list" /></li>'), t = (this.$searchContainer = t, 
                    this.$search = t.find("input"), e.call(this));
                    return this._transferTabIndex(), t;
                }, e.prototype.bind = function(e, t, o) {
                    var i = this, n = t.id + "-results", e = (e.call(this, t, o), 
                    t.on("open", function() {
                        i.$search.attr("aria-controls", n), i.$search.trigger("focus");
                    }), t.on("close", function() {
                        i.$search.val(""), i.$search.removeAttr("aria-controls"), 
                        i.$search.removeAttr("aria-activedescendant"), i.$search.trigger("focus");
                    ...
                    }), document.documentMode), r = e && e <= 11;
                    ...
                    var e;
                    this.resizeSearch(), this._keyUpPrevented || (e = this.$search.val(), 
                    this.trigger("query", {
                        term: e
                ...
                return e.prototype.bind = function(e, t, o) {
                    ...
                    e.call(this, t, o), t.on("*", function(e, t) {
                        var o;
                        -1 !== s.inArray(e, n) && (o = s.Event("select2:" + e, {
                            params: t = t || {}
                        }), i.$element.trigger(o), -1 !== s.inArray(e, r)) && (t.prevented = o.isDefaultPrevented());
                    });
                }, e;
            }), e.define("select2/translation", [ "jquery", "require" ], function(t, o) {
                function i(e) {
                    this.dict = e || {};
                }
                ...
                }, i.prototype.bind = function(e, t) {}, i.prototype.destroy = function() {}, 
                i.prototype.generateResultId = function(e, t) {
                    e = e.id + "-result-";
                    return e += o.generateChars(4), null != t.id ? e += "-" + t.id.toString() : e += "-" + o.generateChars(4), 
                    e;
                }, i;
            }), e.define("select2/data/select", [ "./base", "../utils", "jquery" ], function(e, s, a) {
                function o(e, t) {
                ...
                return s.Extend(o, e), o.prototype.current = function(e) {
                    ...
                    var e, r = this;
                    n.selected = !0, a(n.element).is("option") ? (n.element.selected = !0, 
                    this.$element.trigger("input").trigger("change")) : this.$element.prop("multiple") ? this.current(function(e) {
                        var t = [];
                        (n = [ n ]).push.apply(n, e);
                    ...
                    var r = this;
                    this.$element.prop("multiple") && (n.selected = !1, a(n.element).is("option") ? (n.element.selected = !1, 
                    this.$element.trigger("input").trigger("change")) : this.current(function(e) {
                        for (var t = [], o = 0; o < e.length; o++) {
                            var i = e[o].id;
                    ...
                    void 0 !== e.id && (t.value = e.id), e.disabled && (t.disabled = !0), 
                    e.selected && (t.selected = !0), e.title && (t.title = e.title);
                    var t, o = a(t), e = this._normalizeItem(e);
                    ...
                    if (null == (t = s.GetData(e[0], "data"))) {
                        ...
                        (t = this._normalizeItem(t)).element = e[0], s.StoreData(e[0], "data", t);
                    }
                    return t;
                ...
                return c.Extend(i, e), i.prototype.bind = function(e, t) {
                    ...
                    }).length && (e = this.option(o), this.addOptions(e)), i.__super__.select.call(this, o);
                    ...
                    for (var r = 0; r < e.length; r++) {
                        ...
                        }(l)), a = this.item(s), a = u.extend(!0, {}, l, a), a = this.option(a), 
                        s.replaceWith(a)) : (s = this.option(l), l.children && (a = this.convertToOptions(l.children), 
                        c.appendMany(s, a)), n.push(s));
                    }
                    return n;
                }, i;
                ...
                return t.Extend(o, e), o.prototype._applyDefaults = function(e) {
                    ...
                    var i = this, n = (null != this._request && (r.isFunction(this._request.abort) && this._request.abort(), 
                    this._request = null), r.extend({
                        type: "GET"
                    }, this.ajaxOptions));
                    function e() {
                    ...
                    "function" == typeof n.url && (n.url = n.url.call(this.$element, t)), 
                    "function" == typeof n.data && (n.data = n.data.call(this.$element, t)), 
                ...
                function e(e, t, o) {
                    var i = o.get("tags"), n = o.get("createTag"), n = (void 0 !== n && (this.createTag = n), 
                    o.get("insertTag"));
                    if (void 0 !== n && (this.insertTag = n), e.call(this, t, o), 
                    a.isArray(i)) for (var r = 0; r < i.length; r++) {
                ...
                return e.prototype.query = function(e, c, u) {
                    var d = this;
                    this._removeOldTags(), null == c.term || null != c.page ? e.call(this, c, u) : e.call(this, c, function e(t, o) {
                        ...
                        d.addOptions([ a ]), d.insertTag(i, l)), t.results = i, 
                        u(t);
                    });
                ...
                return e.prototype.bind = function(e, t, o) {
                    ...
                    var n = this.tokenizer(t, this.options, function(e) {
                        ...
                        i._removeOldTags(), i.addOptions([ e ])), i.trigger("select", {
                            data: t
                        });
                    });
                    n.term !== t.term && (this.$search.length && (this.$search.val(n.term), 
                    this.$search.trigger("focus")), t.term = n.term), e.call(this, t, o);
                    ...
                    for (var n = o.get("tokenSeparators") || [], r = t.term, s = 0, a = this.createTag || function(e) {
                        ...
                        var l = r[s];
                        -1 === c.inArray(l, n) ? s++ : (l = r.substr(0, s), null == (l = a(c.extend({}, t, {
                            term: l
                        }))) ? s++ : (i(l), r = r.substr(s + 1) || "", s = 0));
                    }
                    return {
                        term: r
                    };
                ...
                function e(e, t, o) {
                    this.maximumSelectionLength = o.get("maximumSelectionLength"), 
                    e.call(this, t, o);
                }
                return e.prototype.bind = function(e, t, o) {
                    var i = this;
                ...
                }, o.prototype.bind = function() {}, o.prototype.position = function(e, t) {}, 
                o.prototype.destroy = function() {
                ...
                return t.prototype.render = function(e) {
                    var e = e.call(this), t = r('<span class="select2-search select2-search--dropdown"><input class="select2-search__field" type="search" tabindex="-1" autocomplete="off" autocorrect="off" autocapitalize="none" spellcheck="false" role="searchbox" aria-autocomplete="list" /></span>');
                    return this.$searchContainer = t, this.$search = t.find("input"), 
                    e.prepend(t), e;
                    ...
                    e.call(this, t, o), this.$search.on("keydown", function(e) {
                        ...
                        i.$search.attr("tabindex", 0), i.$search.attr("aria-controls", n), 
                        i.$search.trigger("focus"), window.setTimeout(function() {
                            i.$search.trigger("focus");
                        }, 0);
                    }), t.on("close", function() {
                        i.$search.attr("tabindex", -1), i.$search.removeAttr("aria-controls"), 
                        i.$search.removeAttr("aria-activedescendant"), i.$search.val(""), 
                ...
                return e.prototype.append = function(e, t) {
                    this.$loadingMore.remove(), this.loading = !1, e.call(this, t), 
                ...
                function e(e, t, o) {
                    this.$dropdownParent = u(o.get("dropdownParent") || document.body), 
                    e.call(this, t, o);
                }
                return e.prototype.bind = function(e, t, o) {
                    var i = this;
                    ...
                    t.attr("class", o.attr("class")), t.removeClass("select2"), 
                    ...
                    var o = this, i = "scroll.select2." + t.id, n = "resize.select2." + t.id, t = "orientationchange.select2." + t.id, r = this.$container.parents().filter(s.hasScroll);
                    r.each(function() {
                    ...
                    var e = u(window), t = this.$dropdown.hasClass("select2-dropdown--above"), o = this.$dropdown.hasClass("select2-dropdown--below"), i = null, n = this.$container.offset(), r = (n.bottom = n.top + this.$container.outerHeight(!1), 
                    {
                        height: this.$container.outerHeight(!1)
                    });
                    r.top = n.top, r.bottom = n.top + r.height;
                    var s = this.$dropdown.outerHeight(!1), a = e.scrollTop(), e = e.scrollTop() + e.height(), a = a < n.top - s, e = e > n.bottom + s, n = {
                        left: n.left,
                        top: r.bottom
                    }, l = this.$dropdownParent, c = ("static" === l.css("position") && (l = l.offsetParent()), 
                    {
                        top: 0,
                        left: 0
                    });
                    (u.contains(document.body, l[0]) || l[0].isConnected) && (c = l.offset()), 
                    n.top -= c.top, n.left -= c.left, t || o || (i = "below"), e || !a || t ? !a && e && t && (i = "below") : i = "above", 
                    ("above" == i || t && "below" !== i) && (n.top = r.top - c.top - s), 
                ...
                return e.prototype.bind = function(e, t, o) {
                    ...
                    t.length < 1 || null != (t = o.GetData(t[0], "data")).element && t.element.selected || null == t.element && t.selected || this.trigger("select", {
                        data: t
                    });
                }, e;
                ...
                return {
                    ...
                    inputTooLong: function(e) {
                        var e = e.input.length - e.maximum, t = "Please delete " + e + " character";
                        return 1 != e && (t += "s"), t;
                    },
            ...
            }), e.define("select2/defaults", [ "jquery", "require", "./results", "./selection/single", "./selection/multiple", "./selection/placeholder", "./selection/allowClear", "./selection/search", "./selection/eventRelay", "./utils", "./translation", "./diacritics", "./data/select", "./data/array", "./data/ajax", "./data/tags", "./data/tokenizer", "./data/minimumInputLength", "./data/maximumInputLength", "./data/maximumSelectionLength", "./dropdown", "./dropdown/search", "./dropdown/hidePlaceholder", "./dropdown/infiniteScroll", "./dropdown/attachBody", "./dropdown/minimumResultsForSearch", "./dropdown/selectOnClose", "./dropdown/closeOnSelect", "./i18n/en" ], function(l, r, s, a, c, u, d, h, p, m, f, t, g, b, v, y, w, E, x, C, R, D, M, T, S, L, k, _, e) {
                function o() {
                    this.reset();
                }
                return o.prototype.apply = function(e) {
                    null == (e = l.extend(!0, {}, this.defaults, e)).dataAdapter && (null != e.ajax ? e.dataAdapter = v : null != e.data ? e.dataAdapter = b : e.dataAdapter = g, 
                    ...
                    e.tags && (e.dataAdapter = m.Decorate(e.dataAdapter, y)), null == e.tokenSeparators && null == e.tokenizer || (e.dataAdapter = m.Decorate(e.dataAdapter, w)), 
                    null != e.query && (t = r(e.amdBase + "compat/query"), e.dataAdapter = m.Decorate(e.dataAdapter, t)), 
                    null != e.initSelection) && (t = r(e.amdBase + "compat/initSelection"), 
                    e.dataAdapter = m.Decorate(e.dataAdapter, t)), null == e.resultsAdapter && (e.resultsAdapter = s, 
                    null != e.ajax && (e.resultsAdapter = m.Decorate(e.resultsAdapter, T)), 
                    null != e.placeholder && (e.resultsAdapter = m.Decorate(e.resultsAdapter, M)), 
                    e.selectOnClose) && (e.resultsAdapter = m.Decorate(e.resultsAdapter, k)), 
                    null == e.dropdownAdapter && (e.multiple ? e.dropdownAdapter = R : (t = m.Decorate(R, D), 
                    e.dropdownAdapter = t), 0 !== e.minimumResultsForSearch && (e.dropdownAdapter = m.Decorate(e.dropdownAdapter, L)), 
                    e.closeOnSelect && (e.dropdownAdapter = m.Decorate(e.dropdownAdapter, _)), 
                    null == e.dropdownCssClass && null == e.dropdownCss && null == e.adaptDropdownCssClass || (t = r(e.amdBase + "compat/dropdownCss"), 
                    e.dropdownAdapter = m.Decorate(e.dropdownAdapter, t)), e.dropdownAdapter = m.Decorate(e.dropdownAdapter, S)), 
                    null == e.selectionAdapter && (e.multiple ? e.selectionAdapter = c : e.selectionAdapter = a, 
                    null != e.placeholder && (e.selectionAdapter = m.Decorate(e.selectionAdapter, u)), 
                    e.allowClear && (e.selectionAdapter = m.Decorate(e.selectionAdapter, d)), 
                    e.multiple && (e.selectionAdapter = m.Decorate(e.selectionAdapter, h)), 
                    null == e.containerCssClass && null == e.containerCss && null == e.adaptContainerCssClass || (t = r(e.amdBase + "compat/containerCss"), 
                    e.selectionAdapter = m.Decorate(e.selectionAdapter, t)), e.selectionAdapter = m.Decorate(e.selectionAdapter, p)), 
                    e.language = this._resolveLanguage(e.language), e.language.push("en");
                    for (var t, o = [], i = 0; i < e.language.length; i++) {
                        var n = e.language[i];
                        -1 === o.indexOf(n) && o.push(n);
                    }
                    return e.language = o, e.translations = this._processTranslations(e.language, e.debug), 
                    e;
                    ...
                    var o = e.language, i = this.defaults.language, n = t.prop("lang"), t = t.closest("[lang]").prop("lang"), n = Array.prototype.concat.call(this._resolveLanguage(n), this._resolveLanguage(o), this._resolveLanguage(i), this._resolveLanguage(t));
                    ...
                    "string" == typeof o[n] && 0 < o[n].indexOf("-") && (t = o[n].split("-")[0], 
                    i.push(t));
                    return i;
                }, o.prototype._processTranslations = function(e, t) {
                    for (var o = new f(), i = 0; i < e.length; i++) {
                        var n = new f(), r = e[i];
                        if ("string" == typeof r) try {
                            n = f.loadPath(r);
                        } catch (e) {
                            try {
                                r = this.defaults.amdLanguageBase + r, n = f.loadPath(r);
                            } catch (e) {
                                // because of how Select2 helps load all possible translation files
                                t && window.console && console.warn && console.warn('Select2: The language file for "' + r + '" could not be automatically loaded. A fallback will be used instead.');
                            }
                        } else n = l.isPlainObject(r) ? new f(r) : r;
                        o.extend(n);
                    }
                    return o;
                }, o.prototype.set = function(e, t) {
                    var o = {}, e = (o[l.camelCase(e)] = t, m._convertData(o));
                    l.extend(!0, this.defaults, e);
                }, new o();
            }), e.define("select2/options", [ "require", "jquery", "./defaults", "./utils" ], function(o, c, i, u) {
                function e(e, t) {
                    this.options = e, null != t && this.fromElement(t), null != t && (this.options = i.applyFromElement(this.options, t)), 
                    this.options = i.apply(this.options), t && t.is("input") && (e = o(this.get("amdBase") + "compat/inputData"), 
                    this.options.dataAdapter = u.Decorate(this.options.dataAdapter, e));
                }
                return e.prototype.fromElement = function(e) {
                    var t = [ "select2" ], o = (null == this.options.multiple && (this.options.multiple = e.prop("multiple")), 
                    ...
                    for (var n = 0; n < e[0].attributes.length; n++) {
                        ...
                        s = u.GetData(e[0], r), o[r.replace(/-([a-z])/g, i)] = s);
                    }
            ...
            }), e.define("select2/core", [ "jquery", "./options", "./utils", "./keys" ], function(r, n, s, i) {
                function a(e, t) {
                    null != s.GetData(e[0], "select2") && s.GetData(e[0], "select2").destroy(), 
                    this.$element = e, this.id = this._generateId(e), this.options = new n(t = t || {}, e), 
                    a.__super__.constructor.call(this);
                    var t = e.attr("tabindex") || 0, t = (s.StoreData(e[0], "old-tabindex", t), 
                    e.attr("tabindex", "-1"), this.options.get("dataAdapter")), t = (this.dataAdapter = new t(e, this.options), 
                    this.render()), o = (this._placeContainer(t), this.options.get("selectionAdapter")), o = (this.selection = new o(e, this.options), 
                    this.$selection = this.selection.render(), this.selection.position(this.$selection, t), 
                    this.options.get("dropdownAdapter")), o = (this.dropdown = new o(e, this.options), 
                    this.$dropdown = this.dropdown.render(), this.dropdown.position(this.$dropdown, t), 
                    this.options.get("resultsAdapter")), i = (this.results = new o(e, this.options, this.dataAdapter), 
                    ...
                    this._registerResultsEvents(), this._registerEvents(), this.dataAdapter.current(function(e) {
                        i.trigger("selection:update", {
                            data: e
                        });
                    }), e.addClass("select2-hidden-accessible"), e.attr("aria-hidden", "true"), 
                    this._syncAttributes(), s.StoreData(e[0], "select2", this), 
                ...
                return s.Extend(a, s.Observable), a.prototype._generateId = function(e) {
                    ...
                    var i = e.attr("style");
                    if ("string" == typeof i) for (var n = i.split(";"), r = 0, s = n.length; r < s; r += 1) {
                    ...
                    var t = this, e = (this.$element.on("change.select2", function() {
                    ...
                    this.on("open", function() {
                        ...
                        e.preventDefault()) : t === i.ENTER ? (o.trigger("results:select", {}), 
                        e.preventDefault()) : t === i.SPACE && e.ctrlKey ? (o.trigger("results:toggle", {}), 
                        e.preventDefault()) : t === i.UP ? (o.trigger("results:previous", {}), 
                        e.preventDefault()) : t === i.DOWN && (o.trigger("results:next", {}), 
                    ...
                    var e = this._isChangeMutation(e, t), o = this;
                    ...
                    if (void 0 === t && (t = {}), e in i) {
                        ...
                        if (o.call(this, i[e], n), n.prevented) return void (t.prevented = !0);
                    }
                    o.call(this, e, t);
                    ...
                    s.RemoveData(this.$element[0]), this.$element.removeData("select2"), 
                    this.dataAdapter.destroy(), this.selection.destroy(), this.dropdown.destroy(), 
                    this.results.destroy(), this.dataAdapter = null, this.selection = null, 
                    ...
                    return e.attr("dir", this.options.get("dir")), this.$container = e, 
                    this.$container.addClass("select2-container--" + this.options.get("theme")), 
                    s.StoreData(e[0], "element", this.$element), e;
                }, a;
            }), e.define("jquery-mousewheel", [ "jquery" ], function(e) {
                return e;
            }), e.define("jquery.select2", [ "jquery", "jquery-mousewheel", "./select2/core", "./select2/defaults", "./select2/utils" ], function(n, e, r, t, s) {
                var a;
                return null == n.fn.select2 && (a = [ "open", "close", "destroy" ], 
                n.fn.select2 = function(t) {
                    ...
                    var o, i;
                    if ("string" == typeof t) return i = Array.prototype.slice.call(arguments, 1), 
                    this.each(function() {
            ...
            var e, o, h, r, s, p, m, f, g, b, v, i, n, y, a = {
                define: e.define,
                require: e.require
            };
            function w(e, t) {
            ...
            function l(e, t) {
                ...
                if (e) {
                    ...
                    c = 0; c < e.length; c++) "." === (d = e[c]) ? (e.splice(c, 1), 
                ...
                if ((h || m) && p) {
                    for (c = (o = e.split("/")).length; 0 < c; --c) {
                        if (i = o.slice(0, c).join("/"), h) for (u = h.length; 0 < u; --u) if (n = (n = p[h.slice(0, u).join("/")]) && n[i]) {
                            r = n, s = c;
                            break;
                        }
                        if (r) break;
            ...
            function E(t, o) {
                return function() {
                    ...
                    s.apply(h, e.concat([ t, o ]));
                };
            }
            function x(e) {
                var t;
                if (w(g, e) && (t = g[e], delete g[e], v[e] = !0, r.apply(h, t)), 
                w(f, e) || w(v, e)) return f[e];
                throw new Error("No " + e);
            }
            function c(e) {
                var t, o = e ? e.indexOf("!") : -1;
                return -1 < o && (t = e.substring(0, o), e = e.substring(o + 1, e.length)), 
                [ t, e ];
            }
            function C(e) {
                return e ? c(e) : [];
    ...
    7: [ function(e, t, o) {
        var n, r = e("decouple"), e = e("emitter"), s = !1, a = window.document, l = a.documentElement, i = window.navigator.msPointerEnabled, c = {
        ...
        (d.prototype = function(e, t) {
            ...
            var i = this;
            return this._onScrollFn = r(a, "scroll", function() {
                i._moved || (clearTimeout(n), s = !0, n = setTimeout(function() {
                    s = !1;
                }, 250));
            ...
            this._onTouchEndFn = function() {
                ...
                var t, o;
                s || i._preventOpen || void 0 === e.touches || function(e) {
                    for (;e.parentNode; ) {
    ...
    8: [ function(t, o, n) {
        var r, s, Q = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e) {
            return typeof e;
        } : function(e) {
        ...
        r = this, s = function() {
            Array.prototype.findIndex || Object.defineProperty(Array.prototype, "findIndex", {
                ...
                value: function(e, t) {
                    ...
                    if (0 != i) for (var n, r, t = 0 | t, s = Math.max(0 <= t ? t : i - Math.abs(t), 0); s < i; ) {
            ...
            t.prototype.createHeadersElement = function() {
                ...
                var e = new A(e, this), i = e.getElement(), n = o && this.findColumnIndex(o);
                ...
                return "object" != (void 0 === t ? "undefined" : Q(t)) ? this.columnsByField[t] || !1 : t instanceof A ? t : t instanceof _ ? t._getSelf() || !1 : "undefined" != typeof HTMLElement && t instanceof HTMLElement && this.columns.find(function(e) {
                    return e.element === t;
                }) || !1;
                ...
                -1 < a && (e.splice(a, 1), -1 < (r = e.indexOf(o)) ? i && (r += 1) : r = a, 
                e.splice(r, 0, t), n) && (this.table.options.dataTree && this.table.modExists("dataTree", !0) && this.table.rowManager.rows.forEach(function(e) {
                ...
                var r, s = this, a = 0, l = o.getElement();
                return new Promise(function(e, t) {
                    if (void 0 === i && (i = s.table.options.scrollToColumnPosition), 
                    void 0 === n && (n = s.table.options.scrollToColumnIfVisible), 
                    o.visible) {
                        switch (i) {
                          case "middle":
                          case "center":
                            a = -s.element.clientWidth / 2;
                            break;

                          case "right":
                            a = l.clientWidth - s.headersElement.clientWidth;
                        }
                        if (!n && 0 < (r = l.offsetLeft) && r + l.offsetWidth < s.element.clientWidth) return !1;
                        r = l.offsetLeft + a, r = Math.max(Math.min(r, s.table.rowManager.element.scrollWidth - s.table.rowManager.element.clientWidth), 0), 
                        s.table.rowManager.scrollHorizontal(r), s.scrollHorizontal(r), 
                        e();
                ...
                return new Promise(function(e, t) {
                    ...
                    s._verticalAlignHeaders(), s.table.rowManager.reinitialize(), 
                    s.table.options.virtualDomHoz && s.table.vdomHoz.reinitialize(), 
                    e(o);
                });
                ...
                e && (z.prototype.helpers.elVisible(this.element) && this._verticalAlignHeaders(), 
            ...
            var _ = function(e) {
            ...
            }, A = (_.prototype.getElement = function() {
                return this._column.getElement();
            }, _.prototype.getDefinition = function() {
                return this._column.getDefinition();
            }, _.prototype.getField = function() {
                return this._column.getField();
            }, _.prototype.getCells = function() {
                var t = [];
                return this._column.cells.forEach(function(e) {
                    t.push(e.getComponent());
                }), t;
            }, _.prototype.getVisibility = function() {
            ...
            }), N = (A.prototype.createElement = function() {
                var e = document.createElement("div");
                ...
                "function" == typeof r.cellTap && (n.cellEvents.cellTap = r.cellTap), 
                "function" == typeof r.cellDblTap && (n.cellEvents.cellDblTap = r.cellDblTap), 
                "function" == typeof r.cellTapHold && (n.cellEvents.cellTapHold = r.cellTapHold), 
                "function" == typeof r.cellEdited && (n.cellEvents.cellEdited = r.cellEdited), 
                "function" == typeof r.cellEditing && (n.cellEvents.cellEditing = r.cellEditing), 
                ...
                void 0 === (i = o.call(this.table.modules.format, r, n, s)) ? "undefined" : Q(i)) {
                  case "object":
            ...
            A.prototype.getComponent = function() {
                return this.component || (this.component = new _(this)), this.component;
                ...
                }) || !1 : t instanceof H ? t : t instanceof N ? t._getSelf() || !1 : "undefined" != typeof HTMLElement && t instanceof HTMLElement && o.rows.find(function(e) {
                ...
                return new Promise(function(e, t) {
                    if (-1 < a) {
                        if (void 0 === o && (o = s.table.options.scrollToRowPosition), 
                        void 0 === i && (i = s.table.options.scrollToRowIfVisible), 
                        "nearest" === o) switch (s.renderMode) {
                          case "classic":
                            n = z.prototype.helpers.elOffset(l).top, o = Math.abs(s.element.scrollTop - n) > Math.abs(s.element.scrollTop + s.element.clientHeight - n) ? "bottom" : "top";
                            break;

                          case "virtual":
                            o = Math.abs(s.vDomTop - a) > Math.abs(s.vDomBottom - a) ? "bottom" : "top";
                        }
                        if (!i && z.prototype.helpers.elVisible(l) && 0 < (r = z.prototype.helpers.elOffset(l).top - z.prototype.helpers.elOffset(s.element).top) && r < s.element.clientHeight - l.offsetHeight) return !1;
                        switch (s.renderMode) {
                          case "classic":
                            s.element.scrollTop = z.prototype.helpers.elOffset(l).top - z.prototype.helpers.elOffset(s.element).top + s.element.scrollTop;
                            break;
                ...
                e.forEach(function(e, t) {
                    var o;
                    e && "object" === (void 0 === e ? "undefined" : Q(e)) ? (o = new H(e, i), 
                ...
                var r = this, s = this, a = [];
                return new Promise(function(e, t) {
                    i = r.findAddRowPos(i), Array.isArray(o) || (o = [ o ]), o.length, 
                ...
                var n = e instanceof H ? e : new H(e || {}, this), r = this.findAddRowPos(t), e = -1;
                return !o && this.table.options.pagination && "page" == this.table.options.paginationAddRow && (t = this.getDisplayRows(), 
                r ? t.length ? o = t[0] : this.activeRows.length && (o = this.activeRows[this.activeRows.length - 1], 
                r = !1) : t.length && (o = t[t.length - 1], r = !(t.length < this.table.modules.page.getPageSize()))), 
                ...
                1 < (t = n.getGroup().rows).length) && (o && -1 != t.indexOf(o) ? this._moveRowInArray(n.getGroup().rows, n, o, !r) : r ? t[0] !== n && (o = t[0], 
                this._moveRowInArray(n.getGroup().rows, n, o, !r)) : t[t.length - 1] !== n && (o = t[t.length - 1], 
                this._moveRowInArray(n.getGroup().rows, n, o, !r))), o && (e = this.rows.indexOf(o)), 
                o && -1 < e ? (t = this.activeRows.indexOf(o), this.displayRowIterator(function(e) {
                    var t = e.indexOf(o);
                    -1 < t && e.splice(r ? t : t + 1, 0, n);
                }), -1 < t && this.activeRows.splice(r ? t : t + 1, 0, n), this.rows.splice(r ? e : e + 1, 0, n)) : r ? (this.displayRowIterator(function(e) {
                    e.unshift(n);
                ...
                }), this.table.options.groupBy && this.table.modExists("groupRows") && ((e = (o = !i && o instanceof O ? this.table.rowManager.prevDisplayRow(t) || o : o).getGroup()) === (n = t.getGroup()) ? this._moveRowInArray(e.rows, t, o, i) : (n && n.removeRow(t), 
                e.insertRow(t, o, i)));
                ...
                return !(o = !1 !== e && e < this.displayRowsCount - 1 ? this.getDisplayRows()[e + 1] : o) || o instanceof H && "row" == o.type ? o : this.nextDisplayRow(o, t);
            }, o.prototype.prevDisplayRow = function(e, t) {
                var e = this.getDisplayRowIndex(e), o = !1;
                return e && (o = this.getDisplayRows()[e - 1]), !t || !o || o instanceof H && "row" == o.type ? o : this.prevDisplayRow(o, t);
                ...
                if (this.redrawBlock) (!this.redrawBlockRestoreConfig || s.indexOf(e) < s.indexOf(this.redrawBlockRestoreConfig.stage)) && (this.redrawBlockRestoreConfig = {
                    ...
                    e = e || "all", r.options.selectable && !r.options.selectablePersistence && r.modExists("selectRow") && r.modules.selectRow.deselectRows(), 
                    e) {
                      case "all":
                      case "filter":
                      ...
                      case "sort":
                        t ? t = !1 : r.modExists("sort") && r.modules.sort.sort(this.activeRows), 
                    ...
                    z.prototype.helpers.elVisible(n.element) && (o ? n.reRenderInPosition() : ("all" === e && this.table.options.virtualDomHoz && this.table.vdomHoz.dataChange(), 
                ...
                if (i.displayRowsCount && z.prototype.helpers.elVisible(i.element)) {
                    for (i.vDomTop = e, i.vDomBottom = e - 1; (a <= i.height + i.vDomWindowBuffer || c < i.vDomWindowMinTotalRows) && i.vDomBottom < i.displayRowsCount - 1; ) {
                        ...
                        c < s ? l += p : a += p, p > this.vDomWindowBuffer && (this.vDomWindowBuffer = 2 * p), 
                ...
                t || (this.vDomTopPad = 0), r.style.paddingTop = this.vDomTopPad + "px", 
            ...
            o.prototype.adjustTableSize = function() {
                ...
                if ("fitData" === this.table.options.layout) {
                    ...
                    e = (this.table.options.groupBy ? this.table.modules.groupRows.getGroups(!1)[0].getRows(!1) : this.table.rowManager.getDisplayRows())[0])) {
                        ...
                        for (n = 0; n < e.cells.length; n++) {
                            var r = e.cells[n];
                            if (t.appendChild(r.getElement()), r.column.reinitializeWidth(), 
                            (i += r.column.getWidth()) > this.vDomScrollPosRight) break;
                        }
                ...
                this._row = e;
            }), H = (N.prototype.getData = function(e) {
            ...
            }, H.prototype.updateData = function(i) {
                var n, r = this, s = this.element && z.prototype.helpers.elVisible(this.element), a = {};
                return new Promise(function(e, t) {
                    ...
                    n = r.table.modExists("mutator") ? (a = Object.assign(a, r.data), 
                    a = Object.assign(a, i), r.table.modules.mutator.transformRow(a, "data", i)) : i) r.data[o] = n[o];
                    ...
                    r.table.options.rowUpdated.call(r.table, r.getComponent()), 
                    r.table.options.dataChanged && r.table.options.dataChanged.call(r.table, r.table.rowManager.getData()), 
                    e();
                });
            ...
            }, H.prototype.getCellIndex = function(t) {
                ...
                if (e < this.cells.length - 1) for (var o = e + 1; o < this.cells.length; o++) {
                    var i = this.cells[o];
                    if (i.column.modules.edit && z.prototype.helpers.elVisible(i.getElement())) {
                        var n = !0;
                ...
                if (0 < e) for (var o = e - 1; 0 <= o; o--) {
                    ...
                    if (i.column.modules.edit && z.prototype.helpers.elVisible(i.getElement()) && (n = "function" == typeof i.column.modules.edit.check ? i.column.modules.edit.check(i.getComponent()) : n)) {
                        t = i;
                        break;
                    }
                }
                ...
                return this.component || (this.component = new N(this)), this.component;
                ...
                (o.cellTap || this.table.options.cellTap) && (r = !1, e.addEventListener("touchstart", function(e) {
                    ...
                    var t;
                    r && (t = s.getComponent(), o.cellTap && o.cellTap.call(s.table, e, t), 
                    s.table.options.cellTap) && s.table.options.cellTap.call(s.table, e, t), 
                    r = !1;
            ...
            }, r.prototype.deactivate = function(e) {
            ...
            }), O = (z.prototype.defaultOptions = {
                height: !(r.prototype.redraw = function() {
            ...
            }, z.prototype.initializeOptions = function(e) {
            ...
            }, z.prototype.initializeElement = function(e) {
            ...
            }, z.prototype._mapDepricatedFunctionality = function() {
            ...
            }, z.prototype._clearSelection = function() {
                ...
                this.footerManager = new r(this), this.columnManager.setRowManager(this.rowManager), 
            ...
            }, z.prototype._clearObjectPointers = function() {
            ...
            z.prototype._buildElement = function() {
                var e, t, o, i = this, n = this.element, r = this.modules, s = this.options;
                for (s.tableBuilding.call(this), n.classList.add("tabulator"), n.setAttribute("role", "grid"); n.firstChild; ) n.removeChild(n.firstChild);
                for (e in s.height && (s.height = isNaN(s.height) ? s.height : s.height + "px", 
                n.style.height = s.height), !1 !== s.minHeight && (s.minHeight = isNaN(s.minHeight) ? s.minHeight : s.minHeight + "px", 
                n.style.minHeight = s.minHeight), !1 !== s.maxHeight && (s.maxHeight = isNaN(s.maxHeight) ? s.maxHeight : s.maxHeight + "px", 
                n.style.maxHeight = s.maxHeight), this.columnManager.initialize(), 
                this.rowManager.initialize(), this._detectBrowser(), this.modExists("layout", !0) && r.layout.initialize(s.layout), 
                r.localize.initialize(), !1 !== s.headerFilterPlaceholder && r.localize.setHeaderFilterPlaceholder(s.headerFilterPlaceholder), 
                s.langs) r.localize.installLang(e, s.langs[e]);
                r.localize.setLocale(s.locale), "string" == typeof s.placeholder && ((o = document.createElement("div")).classList.add("tabulator-placeholder"), 
                (t = document.createElement("span")).innerHTML = s.placeholder, 
                o.appendChild(t), s.placeholder = o), n.appendChild(this.columnManager.getElement()), 
                n.appendChild(this.rowManager.getElement()), s.footerElement && this.footerManager.activate(), 
                s.persistence && this.modExists("persistence", !0) && r.persistence.initialize(), 
                s.movableRows && this.modExists("moveRow") && r.moveRow.initialize(), 
                s.autoColumns && this.options.data && this.columnManager.generateColumnsFromRowData(this.options.data), 
                this.modExists("columnCalcs") && r.columnCalcs.initialize(), this.columnManager.setColumns(s.columns), 
                s.dataTree && this.modExists("dataTree", !0) && r.dataTree.initialize(), 
                this.modExists("frozenRows") && this.modules.frozenRows.initialize(), 
                (s.persistence && this.modExists("persistence", !0) && r.persistence.config.sort || s.initialSort) && this.modExists("sort", !0) && (t = [], 
                s.persistence && this.modExists("persistence", !0) && r.persistence.config.sort ? !1 === (t = r.persistence.load("sort")) && s.initialSort && (t = s.initialSort) : s.initialSort && (t = s.initialSort), 
                r.sort.setSort(t)), (s.persistence && this.modExists("persistence", !0) && r.persistence.config.filter || s.initialFilter) && this.modExists("filter", !0) && (o = [], 
                s.persistence && this.modExists("persistence", !0) && r.persistence.config.filter ? !1 === (o = r.persistence.load("filter")) && s.initialFilter && (o = s.initialFilter) : s.initialFilter && (o = s.initialFilter), 
                r.filter.setFilter(o)), s.initialHeaderFilter && this.modExists("filter", !0) && s.initialHeaderFilter.forEach(function(e) {
                    var t = i.columnManager.findColumn(e.field);
                    if (!t) return console.warn("Column Filter Error - No matching column found:", e.field), 
                    !1;
                    r.filter.setHeaderFilterValue(t, e.value);
                }), this.modExists("ajax") && r.ajax.initialize(), s.pagination && this.modExists("page", !0) && r.page.initialize(), 
                s.groupBy && this.modExists("groupRows", !0) && r.groupRows.initialize(), 
                this.modExists("keybindings") && r.keybindings.initialize(), this.modExists("selectRow") && r.selectRow.clearSelectionData(!0), 
                s.autoResize && this.modExists("resizeTable") && r.resizeTable.initialize(), 
                this.modExists("clipboard") && r.clipboard.initialize(), s.printAsHtml && this.modExists("print") && r.print.initialize(), 
                s.tableBuilt.call(this);
            }, z.prototype._loadInitialData = function() {
                var e = this;
                ...
                var e = this.element;
                for (z.prototype.comms.deregister(this), this.options.reactiveData && this.modExists("reactiveData", !0) && this.modules.reactiveData.unwatchData(), 
            ...
            }, z.prototype._detectBrowser = function() {
            ...
            }, z.prototype.blockRedraw = function() {
                return this.rowManager.blockRedraw();
            }, z.prototype.restoreRedraw = function() {
                return this.rowManager.restoreRedraw();
            }, z.prototype.setDataFromLocalFile = function(e) {
                var a = this;
            ...
            }, z.prototype.getData = function(e) {
            ...
            }, z.prototype.getDataCount = function(e) {
            ...
            }, z.prototype.addData = function(t, i, n) {
                var r = this;
                return new Promise(function(o, e) {
                    r.modExists("ajax") && r.modules.ajax.blockActiveRequest(), 
                    (t = "string" == typeof t ? JSON.parse(t) : t) ? r.rowManager.addRows(t, i, n).then(function(e) {
                        var t = [];
                        e.forEach(function(e) {
                            t.push(e.getComponent());
                        }), o(t);
            ...
            }, z.prototype.updateOrAddData = function(t) {
                ...
                return new Promise(function(e, o) {
                    ...
                    (a = Array.isArray(a) ? a : [ a ]).forEach(function(e) {
                        ...
                        t ? r.push(t) : (console.warn("Delete Error - No matching row found:", e), 
                        o("Delete Error - No matching row found"), s());
                    }), r.sort(function(e, t) {
            ...
            }, z.prototype.addRow = function(o, i, n) {
                var r = this;
            ...
            }, z.prototype.updateOrAddRow = function(i, n) {
                var r = this;
                return new Promise(function(t, o) {
            ...
            }, z.prototype.updateRow = function(i, n) {
                var r = this;
                return new Promise(function(e, t) {
            ...
            }, z.prototype.scrollToRow = function(i, n, r) {
                var s = this;
                return new Promise(function(e, t) {
            ...
            }, z.prototype.moveRow = function(e, t, o) {
            ...
            }, z.prototype.getRowPosition = function(e, t) {
            ...
            }, z.prototype.deleteColumn = function(i) {
                var n = this;
                return new Promise(function(e, t) {
            ...
            }, z.prototype.updateColumnDefinition = function(i, n) {
                var r = this;
                return new Promise(function(t, o) {
            ...
            }, z.prototype.moveColumn = function(e, t, o) {
            ...
            }, z.prototype.scrollToColumn = function(i, n, r) {
                var s = this;
                return new Promise(function(e, t) {
            ...
            }, z.prototype.deselectRow = function(e) {
                this.modExists("selectRow", !0) && this.modules.selectRow.deselectRows(e);
            }, z.prototype.toggleSelectRow = function(e) {
            ...
            }, z.prototype.setPageToRow = function(o) {
                var i = this;
                return new Promise(function(e, t) {
            ...
            }, z.prototype.setGroupValues = function(e) {
                if (!this.modExists("groupRows", !0)) return !1;
            ...
            }, z.prototype.setGroupStartOpen = function(e) {
                if (!this.modExists("groupRows", !0)) return !1;
            ...
            }, z.prototype.setGroupHeader = function(e) {
                if (!this.modExists("groupRows", !0)) return !1;
            ...
            }, z.prototype.clearHistory = function() {
                return !(!this.options.history || !this.modExists("history", !0)) && this.modules.history.clear();
            }, z.prototype.download = function(e, t, o, i) {
                this.modExists("download", !0) && this.modules.download.download(e, t, o, i);
            }, z.prototype.downloadToTab = function(e, t, o, i) {
                this.modExists("download", !0) && this.modules.download.download(e, t, o, i, !0);
            }, z.prototype.tableComms = function(e, t, o, i) {
                this.modules.comms.receive(e, t, o, i);
            }, z.prototype.moduleBindings = {}, z.prototype.extendModule = function(e, t, o) {
                if (z.prototype.moduleBindings[e]) {
                    var i = z.prototype.moduleBindings[e].prototype[t];
            ...
            z.prototype.registerModule = function(e, t) {
                z.prototype.moduleBindings[e] = t;
            }, z.prototype.bindModules = function() {
                for (var e in this.modules = {}, z.prototype.moduleBindings) this.modules[e] = new z.prototype.moduleBindings[e](this);
            }, z.prototype.modExists = function(e, t) {
                ...
                tables: [],
                register: function(e) {
                    z.prototype.comms.tables.push(e);
                },
                deregister: function(e) {
                    e = z.prototype.comms.tables.indexOf(e);
                    -1 < e && z.prototype.comms.tables.splice(e, 1);
                },
                lookupTable: function(e, t) {
                    var o, i, n = [];
                    if ("string" == typeof e) {
                        if ((o = document.querySelectorAll(e)).length) for (var r = 0; r < o.length; r++) (i = z.prototype.comms.matchElement(o[r])) && n.push(i);
                    } else "undefined" != typeof HTMLElement && e instanceof HTMLElement || e instanceof z ? (i = z.prototype.comms.matchElement(e)) && n.push(i) : Array.isArray(e) ? e.forEach(function(e) {
                        n = n.concat(z.prototype.comms.lookupTable(e));
                    }) : t || console.warn("Table Connection Error - Invalid Selector", e);
                    return n;
                },
                matchElement: function(t) {
                    return z.prototype.comms.tables.find(function(e) {
                        return t instanceof z ? e === t : e.element === t;
                    });
                }
            }, z.prototype.findTable = function(e) {
                e = z.prototype.comms.lookupTable(e, !0);
                ...
                fitColumns: function(e) {
                    var t = this.table.element.clientWidth, i = 0, o = 0, p = 0, n = [], r = [], s = 0, a = 0;
                    function m(e) {
                        e = "string" == typeof e ? -1 < e.indexOf("%") ? t / 100 * parseInt(e) : parseInt(e) : e;
                        return e;
                    }
                    function f(e, i, n, r) {
                        var t, s = [], o = 0, a = p, l = 0, c = 0, u = [];
                        function d(e) {
                        ...
                        return e.forEach(function(e, t) {
                            ...
                            i -= e.column.maxWidth, (a -= r ? e.column.definition.widthShrink || 1 : e.column.definition.widthGrow || 1) && (n = Math.floor(i / a))) : (u.push(e), 
                            c += r ? e.column.definition.widthShrink || 1 : e.column.definition.widthGrow || 1);
                        }), s.length ? (s.forEach(function(e) {
                            o += r ? e.width - e.column.minWidth : e.column.minWidth, 
                            e.width = e.column.minWidth;
                        }), l = (e = i - o) - (t = c ? Math.floor(e / c) : e) * c, 
                        l += f(u, e, t, r)) : (l = c ? i - Math.floor(i / c) * c : i, 
                    ...
                    e.forEach(function(e) {
                        ...
                        o ? (o = m(o), i += t < o ? o : t, e.definition.widthShrink && (r.push({
                            column: e,
                            width: t < o ? o : t
                        }), s += e.definition.widthShrink)) : (n.push({
                            column: e,
                            width: 0
                    ...
                    n.length && 0 < a && (n[n.length - 1].width += +a), n.forEach(function(e) {
                        o -= e.width;
                    }), 0 < (e = Math.abs(a) + o) && s && (a = f(r, e, Math.floor(e / s), !0)), 
                    r.length && (r[r.length - 1].width -= a), n.forEach(function(e) {
                        e.column.setWidth(e.width);
                    }), r.forEach(function(e) {
                        e.column.setWidth(e.width);
                    });
                }
            }, z.prototype.registerModule("layout", F), s.prototype.initialize = function() {
                this.langList = z.prototype.helpers.deepClone(this.langs);
            }, s.prototype.setHeaderFilterPlaceholder = function(e) {
                this.langList.default.headerFilters.default = e;
            }, s.prototype.setHeaderFilterColumnPlaceholder = function(e, t) {
            ...
            }, s.prototype.installLang = function(e, t) {
                this.langList[e] ? this._setLangProp(this.langList[e], t) : this.langList[e] = t;
            }, s.prototype._setLangProp = function(e, t) {
                ...
                "default")), o.locale = e, o.lang = z.prototype.helpers.deepClone(o.langList.default || {}), 
                ...
                o._executeBindings();
            }, s.prototype.getLocale = function(e) {
                return self.locale;
            }, s.prototype.getLang = function(e) {
                return e ? this.langList[e] : this.lang;
            }, s.prototype.getText = function(e, t) {
                t = (e = t ? e + "|" + t : e).split("|");
                return this._getLangElement(t, this.locale) || "";
            }, s.prototype._getLangElement = function(e, t) {
                var o = this.lang;
            ...
            }, s.prototype._executeBindings = function() {
                var e, o = this;
            ...
            }, z.prototype.registerModule("localize", s), I.prototype.getConnections = function(e) {
                var t = this, o = [];
                return z.prototype.comms.lookupTable(e).forEach(function(e) {
                    t.table !== e && o.push(e);
                }), o;
            }, I.prototype.send = function(e, t, o, i) {
            ...
            }, I.prototype.receive = function(e, t, o, i) {
            ...
            }, z.prototype.registerModule("comms", I), j.prototype.initializeColumn = function(o) {
                var i = this, n = !1, r = {};
                ...
                return t;
            }, j.prototype.transformRow = function(e, r) {
                var s = "accessor" + (r.charAt(0).toUpperCase() + r.slice(1)), a = e.getComponent(), l = z.prototype.helpers.deepClone(e.data || {});
                return this.table.columnManager.traverse(function(e) {
                    ...
                    i = "function" == typeof o.params ? o.params(t, l, r, n, a) : o.params, 
                    e.setFieldValue(l, o.accessor(t, l, r, i, n, a)));
                }), l;
            }, j.prototype.accessors = {}, z.prototype.registerModule("accessor", j), 
            a.prototype.initialize = function() {
                ...
                return r.requestOrder++, i = r.requestOrder, r._loadDefaultConfig(), 
                ...
                e;
            }, a.prototype.defaultLoaderPromise = function(i, n, r) {
                var s, a = this;
                return new Promise(function(t, o) {
                    if (i = a.urlGenerator.call(a.table, i, n, r), "GET" != n.method.toUpperCase()) if (s = "object" === Q(a.table.options.ajaxContentType) ? a.table.options.ajaxContentType : a.contentTypeFormatters[a.table.options.ajaxContentType]) {
                        for (var e in s.headers) n.headers || (n.headers = {}), 
                        void 0 === n.headers[e] && (n.headers[e] = s.headers[e]);
            ...
            }, z.prototype.registerModule("ajax", a), B.prototype.getData = function(e) {
                return this._row.getData(e);
                ...
                return r.table.modExists("mutator") && r.table.modules.mutator.disable(), 
                n = new H(e, this, "calc"), r.table.modExists("mutator") && r.table.modules.mutator.enable(), 
                ...
                n.component = !1, n.getComponent = function() {
                    ...
                    r.table.columnManager.columnsByIndex.forEach(function(e) {
                        r.genColumn.setField(e.getField()), r.genColumn.hozAlign = e.hozAlign, 
                        e.definition[i + "CalcFormatter"] && r.table.modExists("format") ? r.genColumn.modules.format = {
            ...
            }, z.prototype.registerModule("columnCalcs", l), c.prototype.initialize = function() {
                var n = this;
            ...
            }, z.prototype.registerModule("clipboard", c), u.prototype.initialize = function() {
                ...
                return e.forEach(function(e, t) {
                    var o;
                    n.push(e), e instanceof H && (e.create(), (o = e.modules.dataTree.children).index || !1 === o.children || i.getChildren(e).forEach(function(e) {
                        e.create(), n.push(e);
                    }));
                }), n;
                ...
                var o = this, i = !1;
                return "object" == (void 0 === t ? "undefined" : Q(t)) ? t instanceof H ? i = t.data : t instanceof N ? i = t._getSelf().data : "undefined" != typeof HTMLElement && t instanceof HTMLElement && e.modules.dataTree && (i = (i = e.modules.dataTree.children.find(function(e) {
                    return e instanceof H && e.element === t;
                ...
                n.children.forEach(function(e) {
                    e instanceof H && (r.push(t ? e.getComponent() : e), o) && (r = r.concat(i.getTreeChildren(e, t, o)));
                })), r;
            ...
            }, z.prototype.registerModule("dataTree", u), V.prototype.download = function(o, i, e, t, n) {
                var r = this, s = !1;
            ...
            }, z.prototype.registerModule("download", V), d.prototype.initializeColumn = function(e) {
                var t = {
                    editor: !1,
                    blocked: !1,
                    ...
                    if (!o.column.modules.edit.blocked) {
                        ...
                        if (n || t) {
                            ...
                            !1 === (t = o.column.modules.edit.editor.call(i, t, function(e) {
                                ...
                                !0 === t || (s.classList.add("tabulator-validation-fail"), 
                                i.table.options.validationFailed.call(i.table, o.getComponent(), e, t), 
                                !1)) : (i.invalidEdit = !0, s.classList.add("tabulator-validation-fail"), 
                                i.focusCellNoEvent(o, !0), r(), i.table.options.validationFailed.call(i.table, o.getComponent(), e, t), 
                                !1);
                            }, function() {
                ...
                function o(e) {
                    var t = n[e];
                    void 0 !== t && t !== a && t !== r && t !== s && (i.value = i.value + "" + t, 
                    o(e + 1));
                }
                ...
                textarea: function(t, e, o, i, n) {
                    ...
                    function d(e) {
                        null == r && "" !== l.value || l.value !== r ? (o(l.value) && (r = l.value), 
                        setTimeout(function() {
                ...
                number: function(e, t, o, i, n) {
                    ...
                    function u() {
                        var e = a.value;
                        (e = isNaN(e) || "" === e ? e : Number(e)) !== r ? o(e) && (r = e) : i();
                    }
                    return t(function() {
                ...
                select: function(s, e, o, t, a) {
                    ...
                    function C(e, o) {
                        ...
                        function r(e) {
                            ...
                            -1 < o.indexOf(e.value) && D(e), i.push(e), n.push(e);
                        }
                    ...
                    function T(e) {
                        e = e || f;
                        var t = b.indexOf(e);
                        -1 < t ? M(t) : (!0 !== p && b.length >= p && M(0), D(e)), 
                        k();
                    }
                    function S(e) {
                    ...
                    d.readOnly = 0 != this.currentCell, a.elementAttributes && "object" == Q(a.elementAttributes)) for (var N in a.elementAttributes) "+" == N.charAt(0) ? (N = N.slice(1), 
                    ...
                    return d.value = void 0 !== l || null === l ? l : "", d.addEventListener("search", function(e) {
                        if (!d.value) {
                            for (var t = b.length, o = 0; o < t; o++) M(0);
                            L();
                        }
                        ...
                        t = z.prototype.helpers.elOffset(r), h.style.minWidth = r.offsetWidth + "px", 
                        h.style.top = t.top + r.offsetHeight + "px", h.style.left = t.left + "px", 
                ...
                autocomplete: function(n, e, t, o, r) {
                    ...
                    d.style.width = "100%", d.style.boxSizing = "border-box", r.elementAttributes && "object" == Q(r.elementAttributes)) for (var b in r.elementAttributes) "+" == b.charAt(0) ? (b = b.slice(1), 
                    ...
                    function E(e) {
                        ...
                        C(), !1 !== e && (t.classList.add("tabulator-edit-select-list-notice"), 
                    ...
                    function x(e) {
                        ...
                        if (Array.isArray(e)) e.forEach(function(e) {
                            var t = {};
                            "object" === (void 0 === e ? "undefined" : Q(e)) ? (t.title = r.listItemFormatter ? r.listItemFormatter(e.value, e.label) : e.label, 
                    ...
                    function R(e, t) {
                        ...
                        e.length ? (e = e, o = t, i = !1, C(), (p = e).forEach(function(t) {
                            ...
                            i = !0)), h.appendChild(e);
                        }), i || M(!1)) : r.emptyPlaceholder && E(r.emptyPlaceholder);
                    }
                    function D() {
                        T(), m ? l !== m.value ? (l = m.value, d.value = m.title, 
                        t(m.value)) : o() : r.freetext || r.allowEmpty && "" === d.value ? (l = d.value, 
                        t(d.value)) : o();
                    }
                    function M(e) {
                    ...
                    return h.classList.add("tabulator-edit-select-list"), h.addEventListener("mousedown", function(e) {
                        ...
                        switch (e.keyCode) {
                          case 38:
                            ...
                            e.stopPropagation(), e.preventDefault(), M(0 < t && p[t - 1]));
                            break;

                          case 40:
                            t = p.indexOf(m), ("editor" == c || "hybrid" == c && t < p.length - 1) && (e.stopImmediatePropagation(), 
                            e.stopPropagation(), e.preventDefault(), t < p.length - 1) && M(-1 == t ? p[0] : p[t + 1]);
                            break;
                        ...
                        if (v(), !h.parentNode) {
                            ...
                            var o = z.prototype.helpers.elOffset(a);
                ...
                star: function(e, t, i, o, n) {
                    ...
                    if (s.style.whiteSpace = "nowrap", s.style.overflow = "hidden", 
                    s.style.textOverflow = "ellipsis", u.style.verticalAlign = "middle", 
                ...
                progress: function(e, t, o, i, n) {
                    ...
                    a.setAttribute("aria-valuemax", l), p.appendChild(h), h.addEventListener("mousedown", function(e) {
                        ...
                        r && (e.stopPropagation(), e.stopImmediatePropagation(), 
                        s = r = !1, m());
                    }), a.addEventListener("keydown", function(e) {
                        switch (e.keyCode) {
                          case 39:
                ...
                tickCross: function(e, t, o, i, n) {
                    ...
                    r.style.boxSizing = "border-box", n.elementAttributes && "object" == Q(n.elementAttributes)) for (var c in n.elementAttributes) "+" == c.charAt(0) ? (c = c.slice(1), 
                    r.setAttribute(c, r.getAttribute(c) + n.elementAttributes["+" + c])) : r.setAttribute(c, n.elementAttributes[c]);
                    function u(e) {
                        return s ? e ? l ? a : r.checked : r.checked && !l ? (r.checked = !1, 
                        r.indeterminate = !0, l = !0, a) : (l = !1, r.checked) : r.checked;
                    }
                    return r.value = e, !s || void 0 !== e && e !== a && "" !== e || (l = !0, 
                    r.indeterminate = !0), "firefox" != this.table.browser && t(function() {
                        r.focus({
                            preventScroll: !0
                        });
                    }), r.checked = !0 === e || "true" === e || "True" === e || 1 === e, 
                    t(function() {
                        r.focus();
            ...
            }, z.prototype.registerModule("edit", d), h.prototype.generateExportList = function(e, t, o, i) {
                ...
                return e.forEach(function(e) {
                    ...
                    var t = [];
                    e.forEach(function(e) {
                        t.push(e ? new $(e.title, e.column.getComponent(), e.width, e.height, e.depth) : null);
                ...
                (e = e.filter(function(e) {
                    ...
                    switch (e.type) {
                      case "group":
                        n = e.level, i.push(new $(e.key, e.getComponent(), s.length, 1));
                        break;

                      case "calc":
                      case "row":
                        s.forEach(function(e) {
                            i.push(new $(e._column.getFieldValue(o), e, 1, 1));
                ...
                e;
            }, h.prototype.genereateRowElement = function(s, a, l) {
                ...
                return u.classList.add("tabulator-print-table-row"), s.columns.forEach(function(e) {
                    if (e) {
                        ...
                        if ((o.definition.cssClass ? o.definition.cssClass.split(" ") : []).forEach(function(e) {
                            t.classList.add(e);
                        }), c.table.modExists("format") && !1 !== c.config.formatCells) n = c.table.modules.format.formatExportValue(r, c.colVisProp); else switch (void 0 === n ? "undefined" : Q(n)) {
                          case "object":
                            n = JSON.stringify(n);
                            break;
                        ...
                        c.table.options.dataTree && !1 !== c.config.dataTree && (a.treeElementField && a.treeElementField == o.field || !a.treeElementField && 0 == i) && (s.component._row.modules.dataTree.controlEl && t.insertBefore(s.component._row.modules.dataTree.controlEl.cloneNode(!0), t.firstChild), 
            ...
            }, z.prototype.registerModule("export", h), p.prototype.initializeColumn = function(n, e) {
                        ...
                        if (void 0 === n.modules.filter.prevSuccess || n.modules.filter.prevSuccess !== i) {
                            if (n.modules.filter.prevSuccess = i, n.modules.filter.emptyFunc(i)) delete s.headerFilters[a]; else {
                                switch (n.modules.filter.value = i, Q(n.definition.headerFilterFunc)) {
                                  case "string":
                                    s.filters[n.definition.headerFilterFunc] ? (o = n.definition.headerFilterFunc, 
                                    e = function(e) {
                ...
                h) {
                    ...
                    (r = n.call(this.table.modules.edit, a, function() {}, d, function() {}, l)) ? r instanceof Node ? (h ? u.table.modules.localize.bind("headerFilters|columns|" + e.definition.field, function(e) {
                    ...
                    e.modules.filter.tagType = r.tagName.toLowerCase(), !1 !== e.definition.headerFilterLiveFilter && ("autocomplete" !== e.definition.headerFilter && "tickCross" !== e.definition.headerFilter && ("autocomplete" !== e.definition.editor && "tickCross" !== e.definition.editor || !0 !== e.definition.headerFilter) && (r.addEventListener("keyup", a), 
                    r.addEventListener("search", a), "number" == e.modules.filter.attrType && r.addEventListener("change", function(e) {
                        d(r.value);
                ...
                keywords: function(e, t, o, i) {
                    var e = e.toLowerCase().split(void 0 === i.separator ? " " : i.separator), n = String(null == t ? "" : t).toLowerCase(), r = [];
                    return e.forEach(function(e) {
                        n.includes(e) && r.push(!0);
                    }), i.matchAll ? r.length === e.length : !!r.length;
                },
            ...
            }, z.prototype.registerModule("filter", p), m.prototype.initializeColumn = function(e) {
                ...
                money: function(e, t, o) {
                    ...
                    for (e = !1 !== t ? r.toFixed(t) : r, i = (e = String(e).split("."))[0], 
                    t = 1 < e.length ? s + e[1] : "", n = /(\d+)(\d{3})/; n.test(i); ) i = i.replace(n, "$1" + a + "$2");
                    return c ? i + t + l : l + i + t;
                },
                link: function(e, t, o) {
                    var i = e.getValue(), n = t.urlPrefix || "", r = t.download, s = i, a = document.createElement("a");
                    if (t.labelField && (s = e.getData()[t.labelField]), t.label) switch (Q(t.label)) {
                      case "string":
                        s = t.label;
                        break;
                    ...
                    if (s) {
                        ...
                        a.setAttribute("download", r)), a.innerHTML = this.emptyToSpace(this.sanitizeHTML(s)), 
                        a;
                    }
                    return "&nbsp;";
                },
                ...
                star: function(e, t, o) {
                    ...
                    r.style.verticalAlign = "middle", s.setAttribute("width", "14"), 
                    s.setAttribute("height", "14"), s.setAttribute("viewBox", "0 0 512 512"), 
                    s.setAttribute("xml:space", "preserve"), s.style.padding = "0 1px", 
                ...
                traffic: function(e, t, o) {
                    var i, n, r = this.sanitizeHTML(e.getValue()) || 0, s = document.createElement("span"), a = t && t.max ? t.max : 100, l = t && t.min ? t.min : 0, c = t && void 0 !== t.color ? t.color : [ "red", "orange", "green" ], u = "#666666";
                    if (!isNaN(r) && void 0 !== e.getValue()) {
                        switch (s.classList.add("tabulator-traffic-light"), i = parseFloat(r) <= a ? parseFloat(r) : a, 
                        ...
                        return s.style.backgroundColor = u, s;
                    }
                },
                progress: function(t, e, o) {
                    var i, n, r, s = this.sanitizeHTML(t.getValue()) || 0, a = t.getElement(), l = e && e.max ? e.max : 100, c = e && e.min ? e.min : 0, u = e && e.legendAlign ? e.legendAlign : "center", d = parseFloat(s) <= l ? parseFloat(s) : l;
                    ...
                    switch (Q(e.legendColor)) {
                      ...
                      case "object":
                        ...
                        p = Math.max(p, 0), r = e.legendColor[p]);
                        break;
                    ...
                    m.style.width = "100%", m.style.color = r, m.innerHTML = n), 
                    o(function() {
                        var e;
                ...
                rowSelection: function(e, t, o) {
                    ...
                    return r.type = "checkbox", this.table.modExists("selectRow", !0) && (r.addEventListener("click", function(e) {
                        e.stopPropagation();
                    }), "function" == typeof e.getRow ? (i = e.getRow()) instanceof N ? (r.addEventListener("change", function(e) {
                        i.toggleSelect();
            ...
            }, z.prototype.registerModule("format", m), f.prototype.reset = function() {
                ...
                return o;
            }, z.prototype.registerModule("frozenColumns", f), b.prototype.initialize = function() {
            ...
            }, z.prototype.registerModule("frozenRows", b), v.prototype.getKey = function() {
                ...
                this.type = "group", this.old = s, this.rows = [], this.groups = [], 
                this.groupList = [], this.generator = r, this.elementContents = !1, 
                this.height = 0, this.outerHeight = 0, this.initialized = !1, this.calcs = {}, 
                this.initialized = !1, this.modules = {}, this.arrowElement = !1, 
                this.visible = s ? s.visible : void 0 !== e.startOpen[o] ? e.startOpen[o] : e.startOpen[0], 
            ...
            O.prototype.wipe = function() {
            ...
            }, O.prototype.createValueGroups = function() {
            ...
            }, O.prototype.addBindings = function() {
                var t, o, i, n = this;
            ...
            }, O.prototype._createGroup = function(e, t) {
                var o = t + "_" + e, e = new O(this.groupManager, this, t, e, this.groupManager.groupIDLookups[t].field, this.groupManager.headerGenerator[t] || this.groupManager.headerGenerator[0], !!this.old && this.old.groups[o]);
                this.groups[o] = e, this.groupList.push(e);
            }, O.prototype._addRowToGroup = function(e) {
            ...
            }, O.prototype._addRow = function(e) {
                this.rows.push(e), e.modules.group = this;
            }, O.prototype.insertRow = function(e, t, o) {
            ...
            }, O.prototype.scrollHeader = function(t) {
                this.arrowElement.style.marginLeft = t, this.groupList.forEach(function(e) {
                    e.scrollHeader(t);
                });
            }, O.prototype.getRowIndex = function(e) {}, O.prototype.conformRowData = function(e) {
            ...
            }, O.prototype.removeRow = function(e) {
            ...
            }, O.prototype.getHeadersAndRows = function(t) {
                var o = [];
            ...
            }, O.prototype.getRowGroup = function(t) {
                var o = !1;
                return this.groupList.length ? this.groupList.forEach(function(e) {
                    e = e.getRowGroup(t);
                    e && (o = e);
            ...
            }, O.prototype.getSubGroups = function(t) {
                var o = [];
            ...
            }, O.prototype.generateGroupHeaderContents = function() {
                var t = [];
            ...
            }, O.prototype.detachElement = function() {
                this.element && this.element.parentNode && this.element.parentNode.removeChild(this.element);
            }, O.prototype.normalizeHeight = function() {
                ...
                this.initialized = !1, this.height = 0, z.prototype.helpers.elVisible(this.element) && this.initialize(!0);
                ...
                return this;
            }, O.prototype.reinitializeHeight = function() {}, O.prototype.calcHeight = function() {}, 
            O.prototype.setCellHeight = function() {}, O.prototype.clearCellHeight = function() {}, 
            O.prototype.getComponent = function() {
                ...
                r.headerGenerator = [ function() {
                    ...
                    e.definition.topCalc && r.table.modules.columnCalcs.initializeTopRow(), 
                    e.definition.bottomCalc && r.table.modules.columnCalcs.initializeBottomRow();
                ...
                r.startOpen = t), o && (r.headerGenerator = Array.isArray(o) ? o : [ o ]), 
                this.initialized = !0;
                ...
                var i = t + "_" + e, t = new O(this, !1, t, e, this.groupIDLookups[0].field, this.headerGenerator[0], (o = o || [])[i]);
                ...
                var t = e.level + "_" + e.key;
                this.groups[t] && (delete this.groups[t], -1 < (t = this.groupList.indexOf(e))) && this.groupList.splice(t, 1);
            }, z.prototype.registerModule("groupRows", y), w.prototype.clear = function() {
                this.history = [], this.index = -1;
                ...
                this.history.forEach(function(e) {
                    var t;
                    e.component instanceof H ? e.component === o && (e.component = i) : e.component instanceof P && e.component.row === o && (t = e.component.column.getField()) && (e.component = i.getCell(t));
                });
            }, z.prototype.registerModule("history", w), G.prototype.parseTable = function() {
            ...
            G.prototype._extractOptions = function(e, t, o) {
                var i, n = e.attributes, e = o ? Object.assign([], o) : Object.keys(t), r = {};
                for (i in e.forEach(function(e) {
                    r[e.toLowerCase()] = e;
                }), n) {
                    var s, a = n[i];
                    a && "object" == (void 0 === a ? "undefined" : Q(a)) && a.name && 0 === a.name.indexOf("tabulator-") && (s = a.name.replace("tabulator-", ""), 
                    void 0 !== r[s]) && (t[r[s]] = this._attribValue(a.value));
                }
            }, G.prototype._attribValue = function(e) {
                return "true" === e || "false" !== e && e;
            }, G.prototype._findCol = function(t) {
                return this.table.options.columns.find(function(e) {
                    return e.title === t;
                }) || !1;
            }, G.prototype._extractHeaders = function(e, t) {
                for (var o = 0; o < e.length; o++) {
                    ...
                    n.attributes, this._extractOptions(n, s, A.prototype.defaultOptionList), 
                    this.fieldIndex[o] = s.field, s.field == this.table.options.index && (this.hasIndex = !0), 
                    r || this.table.options.columns.push(s);
                }
            }, G.prototype._generateBlankHeaders = function(e, t) {
                for (var o = 0; o < e.length; o++) {
                    var i = e[o], n = {
                        title: "",
                        field: "col" + o
            ...
            }, z.prototype.registerModule("htmlTableImport", G), E.prototype.initialize = function() {
            ...
            }, z.prototype.registerModule("keybindings", E), x.prototype.initializeColumnHeader = function(t) {
                var e, o = this;
            ...
            }, x.prototype.LoadMenuEvent = function(e, t, o) {
                t = "function" == typeof t ? t.call(this.table, e.getComponent(), o) : t, 
                this.loadMenu(o, e, t);
            }, x.prototype.tapHold = function(t, o) {
            ...
            }, x.prototype.initializeCell = function(e) {
            ...
            }, x.prototype.initializeGroup = function(e) {
            ...
            }, x.prototype.loadMenu = function(e, n, t, o) {
                var r = this, i = !(e instanceof MouseEvent), s = document.createElement("div");
                if (s.classList.add("tabulator-menu"), i || e.preventDefault(), 
                t && t.length) {
                    if (!o) {
            ...
            }, x.prototype.hideOldSubMenus = function(e) {
            ...
            }, x.prototype.positionMenu = function(e, t, o, i) {
                var n, r, s, a = this, l = Math.max(document.body.offsetHeight, window.innerHeight);
                t ? (n = (s = z.prototype.helpers.elOffset(t)).left + t.offsetWidth, 
                r = s.top - 1) : (n = (o ? i.touches[0] : i).pageX, r = (o ? i.touches[0] : i).pageY, 
                this.positionReversedX = !1), e.style.top = r + "px", e.style.left = n + "px", 
                setTimeout(function() {
                ...
                e.style.bottom = t ? l - s.top - t.offsetHeight - 1 + "px" : l - r + "px"), 
            ...
            }, x.prototype.escMenu = function(e) {
                27 == e.keyCode && this.hideMenu();
            }, x.prototype.hideMenu = function() {
            ...
            }, x.prototype.menus = {}, z.prototype.registerModule("menu", x), C.prototype.createPlaceholderElement = function() {
                var e = document.createElement("div");
                ...
                t.modules.frozen || (o = t.getElement(), e.mousemove = function(e) {
                    t.parent === i.moving.parent && ((i.touchMove ? e.touches[0] : e).pageX - z.prototype.helpers.elOffset(o).left + i.table.columnManager.element.scrollLeft > t.getWidth() / 2 ? i.toCol === t && i.toColAfter || (o.parentNode.insertBefore(i.placeholderElement, o.nextSibling), 
            ...
            }, C.prototype.bindTouchEvents = function(i) {
                var n, r, s, a, l, c, u = this, e = i.getElement(), d = !1;
                e.addEventListener("touchstart", function(e) {
                    u.checkTimeout = setTimeout(function() {
                        u.touchMove = !0, n = i.nextColumn(), s = n ? n.getWidth() / 2 : 0, 
                        r = i.prevColumn(), a = r ? r.getWidth() / 2 : 0, c = l = 0, 
                        d = !1, u.startMove(e, i);
                    }, u.checkPeriod);
                }, {
                    passive: !0
                    ...
                    u.moveColumn(o, !1)), o) && (n = o.nextColumn(), l = s, s = n ? n.getWidth() / 2 : 0, 
                    r = o.prevColumn(), c = a, a = r ? r.getWidth() / 2 : 0);
                }, {
                    passive: !0
                }), e.addEventListener("touchend", function(e) {
                    u.checkTimeout && clearTimeout(u.checkTimeout), u.moving && u.endMove(e);
                });
            }, C.prototype.startMove = function(e, t) {
                var o = t.getElement();
                this.moving = t, this.startX = (this.touchMove ? e.touches[0] : e).pageX - z.prototype.helpers.elOffset(o).left, 
            ...
            }, C.prototype._bindMouseMove = function() {
            ...
            }, C.prototype.endMove = function(e) {
            ...
            }, C.prototype.moveHover = function(e) {
                var t, o = this, i = o.table.columnManager.getElement(), n = i.scrollLeft, e = (o.touchMove ? e.touches[0] : e).pageX - z.prototype.helpers.elOffset(i).left + n;
            ...
            }, z.prototype.registerModule("moveColumn", C), R.prototype.createPlaceholderElement = function() {
                var e = document.createElement("div");
            ...
            }, R.prototype.setHandle = function(e) {
                this.hasHandle = e;
            }, R.prototype.initializeGroupHeader = function(o) {
                var i = this, e = {};
                e.mouseup = function(e) {
                    i.tableRowDrop(e, row);
                }.bind(i), e.mousemove = function(e) {
                    var t;
                    e.pageY - z.prototype.helpers.elOffset(o.element).top + i.table.rowManager.element.scrollTop > o.getHeight() / 2 ? i.toRow === o && i.toRowAfter || ((t = o.getElement()).parentNode.insertBefore(i.placeholderElement, t.nextSibling), 
            ...
            }, R.prototype.initializeRow = function(o) {
                var e, i = this, t = {};
                t.mouseup = function(e) {
                    i.tableRowDrop(e, o);
                }.bind(i), t.mousemove = function(e) {
                    var t = o.getElement();
                    e.pageY - z.prototype.helpers.elOffset(t).top + i.table.rowManager.element.scrollTop > o.getHeight() / 2 ? i.toRow === o && i.toRowAfter || (t.parentNode.insertBefore(i.placeholderElement, t.nextSibling), 
            ...
            }, R.prototype.initializeCell = function(t) {
            ...
            }, R.prototype.bindTouchEvents = function(i, e) {
                var n, r, s, a, l, c, u = this, d = !1;
                e.addEventListener("touchstart", function(e) {
                    u.checkTimeout = setTimeout(function() {
                        u.touchMove = !0, n = i.nextRow(), s = n ? n.getHeight() / 2 : 0, 
                        r = i.prevRow(), a = r ? r.getHeight() / 2 : 0, c = l = 0, 
                        d = !1, u.startMove(e, i);
                    }, u.checkPeriod);
                }, {
                    passive: !0
                    ...
                    0 < (t = e.touches[0].pageY - d) ? n && s < t - l && (o = n) !== i && (d = e.touches[0].pageY, 
                    o.getElement().parentNode.insertBefore(u.placeholderElement, o.getElement().nextSibling), 
                    u.moveRow(o, !0)) : r && a < -t - c && (o = r) !== i && (d = e.touches[0].pageY, 
                    o.getElement().parentNode.insertBefore(u.placeholderElement, o.getElement()), 
                    u.moveRow(o, !1)), o) && (n = o.nextRow(), l = s, s = n ? n.getHeight() / 2 : 0, 
                    r = o.prevRow(), c = a, a = r ? r.getHeight() / 2 : 0);
                }), e.addEventListener("touchend", function(e) {
                    u.checkTimeout && clearTimeout(u.checkTimeout), u.moving && (u.endMove(e), 
                    u.touchMove = !1);
                });
            }, R.prototype._bindMouseMove = function() {
            ...
            }, R.prototype._unbindMouseMove = function() {
                this.table.rowManager.getDisplayRows().forEach(function(e) {
            ...
            }, R.prototype.startMove = function(e, t) {
                var o = t.getElement();
                ...
                document.body.addEventListener("mouseup", this.endMove), this.moveHover(e);
            }, R.prototype.setStartPosition = function(e, t) {
            ...
            }, R.prototype.endMove = function(e) {
            ...
            }, R.prototype.moveHoverConnections = function(e) {
            ...
            }, R.prototype.disconnectFromTables = function() {
                var e;
            ...
            }, R.prototype.dropComplete = function(e, t, o) {
                var i = !1;
                if (o) {
                ...
                this.endMove();
            }, R.prototype.tableRowDrop = function(e, t) {
                var o = !1, i = !1;
            ...
            }, R.prototype.commsReceived = function(e, t, o) {
                switch (t) {
                  case "connect":
            ...
            }, z.prototype.registerModule("moveRow", R), q.prototype.initializeColumn = function(o) {
                var i = this, n = !1, r = {};
                this.allowedTypes.forEach(function(e) {
            ...
            }, q.prototype.lookupMutator = function(e) {
                var t = !1;
                switch (void 0 === e ? "undefined" : Q(e)) {
                  case "string":
                ...
                return t;
            }, q.prototype.transformRow = function(n, r, s) {
            ...
            }, q.prototype.transformCell = function(e, t) {
                ...
                this.enabled = !1;
            }, q.prototype.mutators = {}, z.prototype.registerModule("mutator", q), 
            D.prototype.createElements = function() {
                ...
                return new Promise(function(t, o) {
                    var e;
                    s.table.modExists("ajax", !0) || o(), i = z.prototype.helpers.deepClone(s.table.modules.ajax.getParams() || {}), 
                    (n = s.table.modules.ajax.getParams())[r.dataSentNames.page] = s.page, 
                    r.size && (n[r.dataSentNames.size] = r.size), r.table.options.ajaxSorting && r.table.modExists("sort") && ((e = s.table.modules.sort.getSort()).forEach(function(e) {
                        delete e.column;
                    ...
                    n[r.dataSentNames.filters] = e), s.table.modules.ajax.setParams(n), 
                    s.table.modules.ajax.sendRequest(r.progressiveLoad).then(function(e) {
                ...
                last_page: "last_page",
                data: "data"
            }, z.prototype.registerModule("page", D), M.prototype.localStorageTest = function() {
            ...
            }, M.prototype.retreiveData = function(e) {
                return !!this.readFunc && this.readFunc(this.id, e);
            }, M.prototype.mergeDefinition = function(n, o) {
                var r = this, s = [];
                return (o = o || []).forEach(function(t, e) {
                    ...
                    }), i.columns && (i.columns = r.mergeDefinition(i.columns, t.columns)), 
                    s.push(i));
                }), n.forEach(function(e, t) {
                    r._findColumn(o, e) || (t < s.length ? s.splice(t, 0, e) : s.push(e));
                }), s;
            }, M.prototype._findColumn = function(e, t) {
            ...
            }, M.prototype.validateSorters = function(e) {
                return e.forEach(function(e) {
                    e.column = e.field, delete e.field;
                }), e;
            }, M.prototype.getGroupConfig = function() {
                var e = {};
                ...
                e;
            }, M.prototype.getPageConfig = function() {
                var e = {};
                ...
                e;
            }, M.prototype.parseColumns = function(e) {
            ...
            }, z.prototype.registerModule("persistence", M), U.prototype.initialize = function() {
                window.addEventListener("beforeprint", this.replaceTable.bind(this)), 
                window.addEventListener("afterprint", this.cleanup.bind(this));
            }, U.prototype.replaceTable = function() {
            ...
            }, U.prototype.printFullscreen = function(e, t, o) {
                var i = window.scrollX, n = window.scrollY, r = document.createElement("div"), s = document.createElement("div"), o = this.table.modules.export.genereateTable(void 0 !== o ? o : this.table.options.printConfig, void 0 !== t ? t : this.table.options.printStyled, e, "print");
                this.manualBlock = !0, this.element = document.createElement("div"), 
                this.element.classList.add("tabulator-print-fullscreen"), this.table.options.printHeader && (r.classList.add("tabulator-print-header"), 
                "string" == typeof (t = "function" == typeof this.table.options.printHeader ? this.table.options.printHeader.call(this.table) : this.table.options.printHeader) ? r.innerHTML = t : r.appendChild(t), 
                this.element.appendChild(r)), this.element.appendChild(o), this.table.options.printFooter && (s.classList.add("tabulator-print-footer"), 
                "string" == typeof (e = "function" == typeof this.table.options.printFooter ? this.table.options.printFooter.call(this.table) : this.table.options.printFooter) ? s.innerHTML = e : s.appendChild(e), 
            ...
            }, z.prototype.registerModule("print", U), T.prototype.watchData = function(s) {
                var a, l = this;
                this.currentVersion++, a = this.currentVersion, l.unwatchData(), 
                l.data = s, l.origFuncs.push = s.push, Object.defineProperty(l.data, "push", {
                    enumerable: !1,
                    configurable: !0,
                    value: function() {
                    ...
                    value: function() {
                        ...
                        }), r || 0 !== n) && l.table.rowManager.reRenderInPosition(), 
                        l.origFuncs.splice.apply(s, arguments);
                    }
                });
            }, T.prototype.unwatchData = function() {
            ...
            }, T.prototype.watchKey = function(o, e, i) {
                var n = this, r = Object.getOwnPropertyDescriptor(e, i), s = e[i], a = this.currentVersion;
                Object.defineProperty(e, i, {
                    set: function(e) {
                        var t;
                        s = e, n.blocked || a !== n.currentVersion || ((t = {})[i] = e, 
                        o.updateData(t)), r.set && r.set(e);
                    },
                    get: function() {
                        return r.get && r.get(), s;
                    }
                });
            }, T.prototype.unwatchRow = function(e) {
                var t, o = e.getData();
                ...
                this.blocked = !1;
            }, z.prototype.registerModule("reactiveData", T), X.prototype.initializeColumn = function(e, o, t) {
                var i, n, r, s = this, a = this.table.options.resizableColumns;
                "header" === e && (r = "textarea" == o.definition.formatter || o.definition.variableHeight, 
                o.modules.resize = {
                    variableHeight: r
                ...
                i.addEventListener("click", function(e) {
                    e.stopPropagation();
                }), i.addEventListener("mousedown", r = function(e) {
                    var t = o.getLastColumn();
                    t && s._checkResizability(t) && (s.startColumn = o, s._mouseDown(e, t, i));
                    ...
                    t && (t = 0 < (t = s.table.columnManager.findColumnIndex(t)) && s.table.columnManager.getColumnByIndex(t - 1)) && s._checkResizability(t) && (s.startColumn = o, 
                    s._mouseDown(e, t, n));
                }), n.addEventListener("touchstart", a, {
                    passive: !0
                }), n.addEventListener("dblclick", function(e) {
                    var t = o.getFirstColumn();
                    t && (t = 0 < (t = s.table.columnManager.findColumnIndex(t)) && s.table.columnManager.getColumnByIndex(t - 1)) && s._checkResizability(t) && (e.stopPropagation(), 
                    t.reinitializeWidth(!0));
                }), t.appendChild(i), t.appendChild(n));
            }, X.prototype._checkResizability = function(e) {
                ...
                function r(e) {
                    ...
                    o.removeEventListener("touchmove", n), o.removeEventListener("touchend", r), 
            ...
            }, z.prototype.registerModule("resizeColumns", X), Y.prototype.initializeRow = function(o) {
                function e(e) {
                    i.startRow = o, i._mouseDown(e, o, r);
                }
                function t(e) {
                    var t = i.table.rowManager.prevDisplayRow(o);
                    t && (i.startRow = t, i._mouseDown(e, t, s));
                }
                var i = this, n = o.getElement(), r = document.createElement("div"), s = (r.className = "tabulator-row-resize-handle", 
                document.createElement("div"));
                s.className = "tabulator-row-resize-handle prev", r.addEventListener("click", function(e) {
                    e.stopPropagation();
                ...
                s.addEventListener("mousedown", t), s.addEventListener("touchstart", t, {
                    passive: !0
                }), n.appendChild(r), n.appendChild(s);
            }, Y.prototype._mouseDown = function(e, t, o) {
                var i = this;
                function n(e) {
            ...
            }, z.prototype.registerModule("resizeRows", Y), K.prototype.initialize = function(e) {
            ...
            }, K.prototype.clearBindings = function(e) {
            ...
            }, z.prototype.registerModule("resizeTable", K), S.prototype.initialize = function() {
                var o = this, i = [];
            ...
            }, S.prototype.initializeRow = function(e) {
                var t;
            ...
            }, S.prototype.showColumn = function(e) {
            ...
            }, S.prototype.generateCollapsedContent = function() {
                var t = this;
                this.table.rowManager.getDisplayRows().forEach(function(e) {
                    t.generateCollapsedRowContent(e);
                });
            }, S.prototype.generateCollapsedRowContent = function(e) {
                var t;
            ...
            }, S.prototype.generateCollapsedRowData = function(o) {
            ...
            }, S.prototype.formatCollapsedData = function(e) {
                ...
                return e.forEach(function(t) {
                    ...
                    o.appendChild(n), s.appendChild(o);
                }, this), Object.keys(e).length ? s : "";
            }, z.prototype.registerModule("responsiveLayout", S), L.prototype.clearSelectionData = function(e) {
                this.selecting = !1, this.lastClickedRow = !1, this.selectPrev = [], 
                this.selectedRows = [], e || this._rowSelectionChanged();
            }, L.prototype.initializeRow = function(n) {
                function t() {
                    setTimeout(function() {
                        r.selecting = !1;
                ...
                e.classList.remove("tabulator-unselectable"), r.table.options.selectable && "highlight" != r.table.options.selectable && ("click" === r.table.options.selectableRangeMode ? e.addEventListener("click", function(e) {
                    ...
                    t = (o = r.table.rowManager.getDisplayRowIndex(r.lastClickedRow)) <= (i = r.table.rowManager.getDisplayRowIndex(n)) ? o : i, 
                    o = i <= o ? o : i, i = r.table.rowManager.getDisplayRows().slice(0).splice(t, o - t + 1), 
                    ...
                    if (e.shiftKey) return r.table._clearSelection(), r.selecting = !0, 
                    r.selectPrev = [], document.body.addEventListener("mouseup", t), 
                    document.body.addEventListener("keyup", t), r.toggleRow(n), 
                    !1;
            ...
            }, L.prototype.toggleRow = function(e) {
            ...
            }, L.prototype.selectRows = function(e) {
                var t, o = this;
                switch (void 0 === e ? "undefined" : Q(e)) {
                  case "undefined":
            ...
            }, L.prototype._selectRow = function(e, t, o) {
            ...
            }, L.prototype.isRowSelected = function(e) {
                return -1 !== this.selectedRows.indexOf(e);
            }, L.prototype.deselectRows = function(e, t) {
                var o = this;
                if (void 0 === e) {
            ...
            }, L.prototype._deselectRow = function(e, t) {
            ...
            }, L.prototype.getSelectedData = function() {
                var t = [];
                return this.selectedRows.forEach(function(e) {
                    t.push(e.getData());
                }), t;
            }, L.prototype.getSelectedRows = function() {
                var t = [];
                return this.selectedRows.forEach(function(e) {
                    t.push(e.getComponent());
                }), t;
            }, L.prototype._rowSelectionChanged = function(e) {
            ...
            }, L.prototype.registerRowSelectCheckbox = function(e, t) {
                e._row.modules.select || (e._row.modules.select = {}), e._row.modules.select.checkboxEl = t;
            }, L.prototype.registerHeaderSelectCheckbox = function(e) {
                this.headerCheckboxElement = e;
            }, L.prototype.childRowSelection = function(e, t) {
            ...
            }, z.prototype.registerModule("selectRow", L), k.prototype.initializeColumn = function(i, e) {
                var t, o, n = this, r = !1;
                switch (Q(i.definition.sorter)) {
                  case "string":
                    n.sorters[i.definition.sorter] ? r = n.sorters[i.definition.sorter] : console.warn("Sort Error - No such sorter found: ", i.definition.sorter);
                    break;

                  case "function":
                    r = i.definition.sorter;
                }
                i.modules.sort = {
                    sorter: r,
                    dir: "none",
            ...
            }, k.prototype.hasChanged = function() {
                var e = this.changed;
                return this.changed = !1, e;
            }, k.prototype.getSort = function() {
                var t = [];
            ...
            }, k.prototype.setSort = function(e, t) {
                var o = this, i = [];
                (e = Array.isArray(e) ? e : [ {
                    column: e,
                    dir: t
                ...
                this.setSort([]);
            }, k.prototype.findSorter = function(e) {
            ...
            }, k.prototype.clearColumnHeaders = function() {
            ...
            }, k.prototype.setColumnHeader = function(e, t) {
                e.modules.sort.dir = t, e.getElement().setAttribute("aria-sort", t);
            }, k.prototype._sortItems = function(e, r) {
            ...
            }, k.prototype._sortRow = function(e, t, o, i, n) {
                var r = "asc" == i ? e : t, s = "asc" == i ? t : e;
                return e = void 0 !== (e = o.getFieldValue(r.getData())) ? e : "", 
                t = void 0 !== (t = o.getFieldValue(s.getData())) ? t : "", r = r.getComponent(), 
                s = s.getComponent(), o.modules.sort.sorter.call(this, e, t, r, s, o.getComponent(), i, n);
            }, k.prototype.sorters = {
                number: function(e, t, o, i, n, r, s) {
                    var a = s.alignEmptyValues, l = s.decimalSeparator, s = s.thousandSeparator, c = 0;
                    if (e = String(e), t = String(t), s && (e = e.split(s).join(""), 
                    t = t.split(s).join("")), l && (e = e.split(l).join("."), t = t.split(l).join(".")), 
                    e = parseFloat(e), t = parseFloat(t), isNaN(e)) c = isNaN(t) ? 0 : -1; else {
                        if (!isNaN(t)) return e - t;
                        c = 1;
                    }
                    return ("top" === a && "desc" === r || "bottom" === a && "asc" === r) && (c *= -1), 
                    c;
                },
                ...
                datetime: function(e, t, o, i, n, r, s) {
                    var a = s.format || "DD/MM/YYYY HH:mm:ss", s = s.alignEmptyValues, l = 0;
                    if ("undefined" != typeof moment) {
                        if (e = moment(e, a), t = moment(t, a), e.isValid()) {
                            if (t.isValid()) return e - t;
                            l = 1;
                        } else l = t.isValid() ? -1 : 0;
                        return ("top" === s && "desc" === r || "bottom" === s && "asc" === r) && (l *= -1), 
                        l;
                    }
                ...
                array: function(e, t, o, i, n, r, s) {
                    var a = s.type || "length", s = s.alignEmptyValues, l = 0;
                    function c(e) {
                        switch (a) {
                          case "length":
                            return e.length;
                ...
                alphanum: function(e, t, o, i, n, r, s) {
                    var a, l, c, u, d, h = 0, p = /(\d+)|(\D+)/g, m = /\d/, s = s.alignEmptyValues, f = 0;
                    if (e || 0 === e) {
                        if (t || 0 === t) {
                    ...
                    return ("top" === s && "desc" === r || "bottom" === s && "asc" === r) && (f *= -1), 
                    f;
                }
            }, z.prototype.registerModule("sort", k);
            return J.prototype.initializeColumn = function(e) {
                ...
                -1 < r && this.invalidCells.splice(r, 1)) : (t.modules.validate.invalid = !0, 
                ...
                unique: function(e, t, o) {
                    var i, n, r;
                    return "" === t || null == t || (i = !0, n = e.getData(), r = e.getColumn()._getSelf(), 
                    this.table.rowManager.rows.forEach(function(e) {
                        e = e.getData();
            ...
            }, z.prototype.registerModule("validate", J), z;
        }, "object" === (void 0 === n ? "undefined" : Q(n)) && void 0 !== o ? o.exports = s() : "function" == typeof define && define.amd ? define(s) : r.Tabulator = s();
    }, {} ]
}, {}, [ 1 ]);