...
!function i(n, s, r) {
    ...
    3: [ function(e, r, a) {
        var p = e("tabulator-tables"), n = e("choices.js"), j = e("slideout"), c = e("./lmt_tool.js"), B = e("./tabOptions.js"), e = e("./globalVars.js"), m = B.tabOption;
        m.dataTreeStartExpanded = function(e, t) {
            var o = E.timesExpl;
            if (t < o) return !0;
            ...
            Q(e).then(function(e) {
                ...
                for (let n of [ "xdim", "ydim" ]) _[n + "Choices"].passedElement.element.addEventListener("addItem", function(t) {
                    if (!E.stopFire) {
                        "xdim" == n && (T = {});
                        let e = _["xdim" == n ? "ydimChoices" : "xdimChoices"].getValue(!0);
                        if (t.detail.value == e) console.log(n, e, t.detail.value), 
                        alert(" x and y must be different ", n, e, t.detail.value); else if (M["xdim" == n ? "x_dim" : "y_dim"] = t.detail.value, 
                        M["xdim" == n ? "y_dim" : "x_dim"] = e, M.fxdim = {}, console.log("selevent", S), 
                ...
                for (let r of [ "norm", "cmap", "exam", "logo" ]) _[r + "Choices"].passedElement.element.addEventListener("addItem", function(t) {
                    ...
                    Y(e = jsonFileURL + e)), "logo" == r && (w = t.detail.value, 
                    o = y.getData(), (y = new p("#dashboard-table", m)).clearData(), 
                    y.setData(o), y.redraw(!0)), "norm" == r) if (console.log("UDEB: fire event for normalization", E.stopFireNorm, !E.stopFireNorm), 
                    ...
                    K(), m.data = y.getData(), y = new p("#dashboard-table", m));
                }, !1);
                _.hideChoices.passedElement.element.addEventListener("addItem", function(e) {
                    ...
                    }) : (E.setTooltip = !1, m.tooltips = !1, console.log("tooltip is false")), 
                    y = new p("#dashboard-table", m);
                    ...
                    m.headerVisible = !0) : (E.setTopTitle = !1, m.headerVisible = !1);
                    var e = y.getData();
                    y.clearData(), y.setData(e), y = new p("#dashboard-table", m);
                    ...
                    if (console.log("fire event for bottomtitle"), document.getElementById("cb-bottomtitle").checked) {
                        E.setBottomTitle = !0;
                        for (var e of m.columns) "row_name" != e.field && (e.bottomCalc = Z);
                    } else {
                        E.setBottomTitle = !1;
                        for (var t of m.columns) "row_name" != t.field && delete t.bottomCalc;
                    }
                    var o = y.getData();
                    y.clearData(), y.setData(o), y = new p("#dashboard-table", m);
                    ...
                    if (console.log("fire event for cellvalue"), document.getElementById("cb-cellvalue").checked) {
                        E.setCellValue = !0;
                        for (x of m.columns) "row_name" != x.field && (x.formatterParams = {
                            showCellValue: !0
                        });
                    } else {
                        E.setCellValue = !1;
        ...
        function U() {
            ...
            for (var e of [ "xdim", "ydim" ]) _[e + "Choices"] = new n(document.querySelector(".js-choice-" + e), {
                searchEnabled: !1,
                shouldSort: !1,
                allowHTML: !1,
                removeItemButton: !1
            ...
            for (var o of [ "norm", "cmap", "exam", "logo" ]) _[o + "Choices"] = new n(document.querySelector(".js-choice-" + o), {
                searchEnabled: !1,
                shouldSort: !1,
                allowHTML: !1,
                removeItemButton: !1
            ...
            y = new p("#dashboard-table", option = {});
            var i = new j({
        ...
        function K() {
            ...
            for (x of m.columns) "row_name" != x.field && (x.formatter = A, x.formatterParams.scaopt = _.normChoices.getValue(!0));
        }
            ...
            resetSwitch(), resetSelect(), $.getJSON(i, {
                ...
                switch (e.SCHEMA.name) {
                  case "CMEC":
                    ...
                    var t, [ o, i = {} ] = [ v, l ], n = {};
                    [ i, t, n ] = I(o, i), Object.keys(u[0]).includes("_children") ? (m.dataTreeCollapseElement = "", 
                    m.dataTreeExpandElement = "", 1) : (m.dataTreeCollapseElement = "<span></span>", 
                    m.dataTreeExpandElement = "<span></span>", 0), c.add_options(o.DIMENSIONS.json_structure, "select-choice-mini-x"), 
                    ...
                    m.data = u, bgcol = "#0063B2FF", ftwgt = 500, ftsty = "normal", 
                    txdec = "", txcol = "white", o = {
                        bgcol: bgcol,
                        ftsty: ftsty,
                        ftwgt: ftwgt,
                        txdec: txdec,
                        color: txcol
                    }, h.length = 0, m.columns = P(u, addBottomTitle = !1, N, o, i, t, d), 
                  ...
                  case "TABJSON":
                    ...
                    h.length = 0, m.columns = P(u, addBottomTitle = !1, N, o, "model", "metric", d);
                }
        ...
        function J(e, t, o) {
            Object.keys(u[0]).includes("_children") ? (m.dataTreeCollapseElement = "", 
            m.dataTreeExpandElement = "") : (m.dataTreeCollapseElement = "<span></span>", 
            m.dataTreeExpandElement = "<span></span>"), console.log(m), console.log("starting read the local CMEC json file 3"), 
            d = "row_name", m.data = u, bgcol = "#0063B2FF", ftwgt = 500, ftsty = "normal", 
            txdec = "", txcol = "black";
            var i = {
                bgcol: bgcol,
                ftsty: ftsty,
            ...
            m.columns = P(u, addBottomTitle = E.setBottomTitle, N, i, e, t, d), 
        ...
        _ = e.dictChoices, M = e.dimSetEvent, "loading" !== document.readyState ? U() : document.addEventListener("DOMContentLoaded", function() {
            ...
            s = !0, document.getElementById("mytab").style.width = (400 + 30 * (m.columns.length - 1)).toString() + "px";
            try {
                y = new p("#dashboard-table", m), O();
            } catch (e) {
        ...
        var ie = function(t, o, e) {
            ...
            for (x of Object.keys(e[0])) if ("row_name" != x && "_children" != x && "metric" != x) {
                ...
                "model" == n) {
                    var u = L[x] % g.length;
                    bgcol = c.title.includes("Mean") || c.title.includes("mean") ? "white" : g[u], 
                    ftwgt = 100, ftsty = "normal", txdec = "", txcol = b[u];
                } else if ("metric" == n) for (var [ d, h ] of G.entries()) x.includes(h) && (u = d % f.length, 
                bgcol = f[u]); else bgcol = "#0063B2FF", ftwgt = 100, ftsty = "normal", 
                txdec = "", txcol = "white";
        ...
        function re(o, t, e) {
            ...
            return e(function() {
                ...
                h.includes(i) || h.push(i), e.forEach(function(e) {
                    var t = h.indexOf(i) % f.length;
                    ae(e, o, 0, f[t], fgFontColor);
                })) : "model" == t.yDim && (fgFontColor = "white", e = L[i] % g.length, 
                ae(o.getRow(), o, 0, g[e], b[e])));
            }), i;
        }
    ...
    5: [ function(e, t, o) {
        var i = {
            ...
            cellClick: function(e, t) {
                ...
                let r = t.getColumn().getField().replace(/\s+/g, ""), a = function e(t) {
                    ...
                    return o;
                }(t.getRow()), l = g.xdimChoices.getValue(!0), c = g.ydimChoices.getValue(!0);
                if ("row_name" != r) {
                    console.log(o), console.log(i, l, c, r, a);
                    var u = {}, d = (u[l] = r, u[c] = a, console.log(b), Object.keys(b.fxdim).filter((e, t) => u[e] = b.fxdim[e]), 
                    {});
                    for (let [ o, e ] of Object.entries(u)) e.includes("::") || e.includes("!!") ? e.replace(/!!/g, "::").replace(/\s+/g, "").split("::").filter((e, t) => d[o + "." + t.toString()] = e) : d[o] = e.replace(/\s+/g, "");
                    Object.keys(i).forEach(function(e) {
                        d.hasOwnProperty(e) && (i[e] = d[e]);
                    }), console.log("xxx", d, i);
                    var h = f;
                    if (Object.values(i).includes("null")) alert("clickable not avaiable"); else for (var p of Object.keys(i)) {
                        var m = "\\{" + p + "\\}", m = new RegExp(m, "g");
                        h = h.replace(m, i[p]), console.log(p, i[p], h);
                    }
                    console.log(u, "clickinput"), alert("stop for debug");
                }
            },
        ...
        o.tabOption = i;
        let f = "{metric.0}/{metric.1}/{metric.2}/{metric.2}.html?model={model}&region={region}", n = e("./globalVars.js");
        var g = n.dictChoices, b = n.dimSetEvent;
    }, {
 ...
 */
                    ...
                    function s(e) {
                        ...
                        if (u(e) || c(e)) i = e, t = g(e), o = b(e); else {
                            if (!f.call(e, "name")) throw new Error("Missing name property in key");
                            var r = e.name;
                            if (i = r, f.call(e, "weight") && (n = e.weight) <= 0) throw new Error(`Property 'weight' in key '${r}' must be a positive integer`);
                        ...
                        ...{
                            ...
                            getFn: function(e, t) {
                                let s = [], r = !1, a = (e, o, i) => {
                                    if (m(e)) if (o[i]) {
                                        var n = e[o[i]];
                                        if (m(n)) if (i === o.length - 1 && (u(n) || d(n) || h(n))) s.push(l(n)); else if (c(n)) {
                                            r = !0;
                                            for (let e = 0, t = n.length; e < t; e += 1) a(n[e], o, i + 1);
                                        } else o.length && a(n, o, i + 1);
                                    } else s.push(e);
                                };
                                return a(e, u(t) ? t.split(".") : t, 0), r ? s : s[0];
                            },
                            ignoreLocation: !1,
                            ignoreFieldNorm: !1,
                            fieldNormWeight: 1
                    ...
                    class r {
                        ...
                        create() {
                            ...
                            u(this.docs[0]) ? this.docs.forEach((e, t) => {
                                this._addString(e, t);
                        ...
                        _addObject(o, e) {
                            ...
                            this.keys.forEach((e, t) => {
                                let i = e.getFn ? e.getFn(o) : this.getFn(o, e.path);
                                if (m(i)) if (c(i)) {
                                    var n, s = [];
                                    let o = [ {
                                        nestedArrIndex: -1,
                    ...
                    class P {
                        ...
                        search(e, {
                            ...
                            let l = u(e) ? u(this._docs[0]) ? this._searchStringList(e) : this._searchObjectList(e) : this._searchLogical(e);
                            [ e, {
                            ...
                            }), r && l.sort(i), d(t) && -1 < t && (l = l.slice(0, t));
                            {
                                var [ a, c, {
                                ...
                                let i = [];
                                return e && i.push(V), r && i.push(W), a.map(t => {
                                    var e = t["idx"];
                                    let o = {
                                        item: c[e],
                                        refIndex: e
                        ...
                        _searchLogical(e) {
                            let i = A(e, this.options), a = (o, i, n) => {
                                var e, t;
            ...
            }, e = {}, t = i(373), t = i.n(t), i(187), i(883), i(789), i(686), e.default = t(), 
            e = e.default;
            function i(e) {
                var t = n[e];
                return void 0 !== t || (t = n[e] = {
                    exports: {}
                }, o[e].call(t.exports, t, t.exports, i)), t.exports;
            }
            var o, n, e, t;
